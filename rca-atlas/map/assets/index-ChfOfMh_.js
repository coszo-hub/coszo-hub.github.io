...
void main() {
  ...
  }`,lu=new ec(new Uint8Array([0]),1,1,me);lu.needsUpdate=!0;function uu(e,t,n,r={}){return new bi({vertexShader:su,fragmentShader:cu,uniforms:{uExag:e.exag,uFlat:e.flat,uLines:e.lines,uMode:e.mode,uMute:e.mute,uInterval:{value:t},uHoles:{value:+!!n},uHoleA:{value:e.holeA},uHoleB:{value:e.holeB},uHoleC:{value:r.holeC??new J},uHoleCOn:{value:+!!r.holeC},uClip:{value:r.clip??new J},uClipOn:{value:+!!r.clip},uSee:e.see??{value:0},uGlass:e.glass??{value:new Y(0,0,0)},uMask:{value:r.mask??lu},uMaskOn:{value:+!!r.mask},uMaskRect:{value:r.maskRect??new J}}})}function du(e,t,n,r){let i=new Float32Array(t*t);for(let a=0;a<t;a++){let o=0;for(let s=0;s<t;s++)o+=e[a*t+s],i[a*t+s]=o/n+r}return i}function fu(e,t,n,r){let i=[new Set(e[0].have),new Set,new Set],a=(e,n,i)=>{let[a,o]=r(e,n);return Math.hypot(a-t.x,o-t.z)<i};if(n<4){let t=Math.min(1.2,Math.max(.35,n*.35));for(let n of e[2].have)if(a(2,n,t)){i[2].add(n);let[e,t]=n.split(`_`).map(Number);i[1].add(`${Math.floor(e/4)}_${Math.floor(t/4)}`)}}if(n<25){let t=Math.min(4,Math.max(1.5,n*.5));for(let n of e[1].have)a(1,n,t)&&i[1].add(n)}return i}function pu(e,t,n,r,i){let a=i*Zl,o=i*Ql,s=t*t,c=4*(t-1),l=(n,r)=>e[Math.min(t-1,Math.max(0,n))*t+Math.min(t-1,Math.max(0,r))],u=new Float32Array((s+c)*3),d=new Float32Array(s+c),f=new Float32Array((s+c)*2),p=new Float32Array(s+c);for(let s=0,c=0;s<t;s++)for(let p=0;p<t;p++,c++){u[c*3]=$l(n+(p+.5)*i),u[c*3+2]=eu(r-(s+.5)*i),d[c]=e[c];let m=Math.min(p+1,t-1)-Math.max(p-1,0),h=Math.min(s+1,t-1)-Math.max(s-1,0);f[c*2]=(l(s,p+1)-l(s,p-1))/(m*a),f[c*2+1]=(l(s+1,p)-l(s-1,p))/(h*o)}let m=[];for(let e=0;e<t-1;e++)for(let n=0;n<t-1;n++){let r=e*t+n,i=r+1,a=r+t,o=a+1;m.push(r,a,i,i,a,o)}let h=[];for(let e=0;e<t-1;e++)h.push(e);for(let e=0;e<t-1;e++)h.push(e*t+t-1);for(let e=t-1;e>0;e--)h.push((t-1)*t+e);for(let e=t-1;e>0;e--)h.push(e*t);h.forEach((e,t)=>{let n=s+t;u[n*3]=u[e*3],u[n*3+2]=u[e*3+2],d[n]=d[e],f[n*2]=f[e*2],f[n*2+1]=f[e*2+1],p[n]=25});for(let e=0;e<h.length;e++){let t=h[e],n=h[(e+1)%h.length],r=s+e,i=s+(e+1)%h.length;m.push(t,r,n,n,r,i)}return{positions:u,elev:d,grad:f,drop:p,index:new Uint32Array(m)}}function mu(e,t,n,r,i,a,o,s){let{west:c,east:l,north:u,south:d}=a;for(let a=0,f=0;a<t;a++)for(let p=0;p<t;p++,f++){let t=n+(p+.5)*i,m=r-(a+.5)*i,h=Math.min((t-c)*Zl,(l-t)*Zl,(u-m)*Ql,(m-d)*Ql);if(h>=s)continue;let g=o(t,m);if(g==null)continue;let _=Math.max(0,h/s),v=_*_*(3-2*_);e[f]=g+(e[f]-g)*v}return e}function hu(e,t,n,r,i,a){let o=e+n/2,s=t-n/2;return[o,s,o+i*r,s-a*r]}var gu=[50,20,10],_u=3e4,vu=.5;async function yu(e,t,n,r){let i=await fetch(e);if(!i.ok)throw Error(`${e}: HTTP ${i.status}`);if(i.headers?.get(`content-type`)?.includes(`html`))throw Error(`${e} is missing`);let a=new Uint8Array(await i.arrayBuffer()),o=a[0]===31&&a[1]===139?new Uint8Array(await new Response(new Blob([a]).stream().pipeThrough(new DecompressionStream(`gzip`))).arrayBuffer()):a;if(o.byteLength!==t*t*2)throw Error(`${e} has ${o.byteLength} bytes; expected ${t*t*2}`);return du(new Int16Array(o.buffer,o.byteOffset,t*t),t,n,r)}var bu=class e{static async create(t,n,r,i=v(`auv/`),a=null){let o;try{let e=await fetch(i+`index.json`);if(!e.ok)return null;o=await e.json()}catch{return null}let s=new e(t,n,r,i,o,a);try{await s._loadBase()}catch(e){return s.dispose(),console.warn(`Axial summit detail is unavailable: ${e.message}`),null}return s}constructor(e,t,n,r,i,a=null){Object.assign(this,{scene3d:e,base:r,index:i,ground:a,S:i.tileCells+1,credit:i.credit,last:0,pending:new Set,cache:new Map,cacheMax:160,failed:new Map});let{west:o,north:s}=i;this.levels=i.levels.map(e=>({...e,tileDeg:e.cellDeg*i.tileCells,have:new Set(e.tiles.map(([e,t])=>`${e}_${t}`))})),this.masks=this.levels.map(e=>{let t=new ec(new Uint8Array(e.tilesX*e.tilesY),e.tilesX,e.tilesY,me);t.magFilter=t.minFilter=k,t.needsUpdate=!0;let[n,r,i,a]=hu(o,s,e.cellDeg,e.tileDeg,e.tilesX,e.tilesY);return{t,rect:new J($l(n),eu(r),$l(i),eu(a))}});let c=this.east=o+i.nx*i.cellDeg,l=this.south=s-i.ny*i.cellDeg,u=.04;this.clip=new J($l(o),$l(c),eu(s),eu(l)),this.box=new J(this.clip.x+u,this.clip.y-u,this.clip.z+u,this.clip.w-u),this.mats=this.levels.map((e,r)=>n(t,gu[r],!1,{clip:this.clip,...this.masks[r+1]?{mask:this.masks[r+1].t,maskRect:this.masks[r+1].rect}:{}})),this.shown=this.levels.map(()=>new Map),this.heights=new Map}origin(e,t,n){return{lon0:this.index.west+n*e.tileDeg,lat0:this.index.north-t*e.tileDeg}}center=(e,t)=>{let n=this.levels[e],[r,i]=t.split(`_`).map(Number),a=this.origin(n,r,i);return[$l(a.lon0+n.tileDeg/2),eu(a.lat0-n.tileDeg/2)]};async _geometry(e,t){let n=`${e}:${t}`;if(this.cache.has(n)){let e=this.cache.get(n);return this.cache.delete(n),this.cache.set(n,e),e}if(this.pending.has(n)||this.failed.get(n)>performance.now())return null;this.pending.add(n);try{let r=this.levels[e],[i,a]=t.split(`_`).map(Number),o=this.origin(r,i,a),s=await yu(`${this.base}L${e}/${t}.bin.gz`,this.S,this.index.zScale,this.index.zOffset);this.ground&&mu(s,this.S,o.lon0,o.lat0,r.cellDeg,{west:this.index.west,east:this.east,north:this.index.north,south:this.south},this.ground,vu),e===0&&this.heights.set(t,s);let c=pu(s,this.S,o.lon0,o.lat0,r.cellDeg),l=new Zr;return l.setAttribute(`position`,new Br(c.positions,3)),l.setAttribute(`elev`,new Br(c.elev,1)),l.setAttribute(`grad`,new Br(c.grad,2)),l.setAttribute(`drop`,new Br(c.drop,1)),l.setIndex(new Br(c.index,1)),e>0&&(this.cache.set(n,l),this._evict()),l}catch(e){throw this.failed.set(n,performance.now()+_u),e}finally{this.pending.delete(n)}}_evict(){for(let[e,t]of this.cache){if(this.cache.size<=this.cacheMax)return;let[n,r]=e.split(`:`);this.shown[+n].has(r)||(this.cache.delete(e),t.dispose())}}_setMask(e,t,n){let r=this.levels[e],[i,a]=t.split(`_`).map(Number);this.masks[e].t.image.data[i*r.tilesX+a]=n?255:0,this.masks[e].t.needsUpdate=!0}_show(e,t,n){if(this.disposed){n.dispose();return}if(this.shown[e].has(t))return;let r=new li(n,this.mats[e]);r.frustumCulled=!1,this.scene3d.add(r),this.shown[e].set(t,r),this._setMask(e,t,!0)}_hide(e,t){let n=this.shown[e].get(t);n&&(this.scene3d.remove(n),this.shown[e].delete(t),this._setMask(e,t,!1))}async _loadBase(){let e=(await Promise.allSettled([...this.levels[0].have].map(async e=>this._show(0,e,await this._geometry(0,e))))).find(e=>e.status===`rejected`);if(e)throw e.reason}dispose(){this.disposed=!0;for(let e=0;e<this.shown.length;e++)for(let[t,n]of[...this.shown[e]])this._hide(e,t),e===0&&n.geometry.dispose();for(let e of this.cache.values())e.dispose();this.cache.clear();for(let e of this.mats)e.dispose?.();for(let{t:e}of this.masks)e.dispose()}sample(e,t){let n=this.levels[0],r=this.index.tileCells,i=this.S,a=(e-this.index.west)/n.cellDeg-.5,o=(this.index.north-t)/n.cellDeg-.5;if(a<0||o<0||e>this.east||t<this.south)return null;let s=Math.floor(a/r),c=Math.floor(o/r),l=this.heights.get(`${c}_${s}`);if(!l)return null;let u=a-s*r,d=o-c*r,f=Math.floor(u),p=Math.floor(d),m=u-f,h=d-p,g=(e,t)=>l[Math.min(i-1,e)*i+Math.min(i-1,t)];return(g(p,f)*(1-m)+g(p,f+1)*m)*(1-h)+(g(p+1,f)*(1-m)+g(p+1,f+1)*m)*h}update(e,t,n){if(n-this.last<200)return;this.last=n;let r=fu(this.levels,e,t,this.center);for(let n of[2,1]){for(let e of[...this.shown[n].keys()])r[n].has(e)||this._hide(n,e);let i=performance.now(),a=e=>!this.pending.has(`${n}:${e}`)&&!(this.failed.get(`${n}:${e}`)>i),o=[...r[n]].filter(e=>!this.shown[n].has(e)&&this.levels[n].have.has(e)&&a(e)).map(t=>{let[r,i]=this.center(n,t);return[Math.hypot(r-e.x,i-e.z),t]}).sort((e,t)=>e[0]-t[0]).slice(0,Math.max(0,6-this.pending.size));for(let[,r]of o)this._geometry(n,r).then(i=>{i&&this._parentShown(n,r)&&fu(this.levels,this._lastTarget??e,this._lastDist??t,this.center)[n].has(r)&&this._show(n,r,i)},e=>console.warn(`Axial summit tile L${n}/${r} failed: ${e.message}`))}this._lastTarget={x:e.x,z:e.z},this._lastDist=t}_parentShown(e,t){if(e<2)return!0;let[n,r]=t.split(`_`).map(Number);return this.shown[1].has(`${Math.floor(n/4)}_${Math.floor(r/4)}`)}finest(){return this.shown[2].size?`1 m`:this.shown[1].size?`4 m`:`16 m`}stats(){return{L0:this.shown[0].size,L1:this.shown[1].size,L2:this.shown[2].size}}};function xu(e){let t=e.rows.length,n=new Float32Array(t*3),r=new Float32Array(t),i=new Float32Array(t);return e.rows.forEach(([t,a,o,s],c)=>{n[c*3]=$l(e.lon0+t*e.scale),n[c*3+2]=eu(e.lat0+a*e.scale),r[c]=-o,i[c]=s}),{positions:n,elev:r,day:i}}function Su({rows:e,cols:t,points:n}){let r=new Float32Array(e*t*3),i=new Float32Array(e*t),a=[];n.forEach((e,t)=>{e&&(r[t*3]=$l(e[0]),r[t*3+2]=eu(e[1]),i[t]=e[2])});for(let r=0;r<e-1;r++)for(let e=0;e<t-1;e++){let i=r*t+e,o=i+1,s=i+t,c=s+1;n[i]&&n[o]&&n[s]&&n[c]&&a.push(i,s,o,o,s,c)}return{positions:r,elev:i,index:new Uint32Array(a)}}function Cu(e,t){let n=Date.parse(`${e}T00:00:00Z`),r=new Date(n),i=[];for(let e=r.getUTCFullYear(),a=r.getUTCMonth();;a++){let r=(Date.UTC(e,a+1,1)-n)/864e5;if(i.push({label:new Date(Date.UTC(e,a,1)).toISOString().slice(0,7),end:r}),r>t)return i}}function wu(e,t){let n=0,r=e.length;for(;n<r;){let i=n+r>>1;e[i]<t?n=i+1:r=i}return n}function Tu(e,t=1.2){let n=1/0,r=-1/0,i=1/0,a=-1/0,o=[];for(let t of e.surfaces)for(let e of t.points)e&&o.push([$l(e[0]),eu(e[1]),!0]);let s=e.earthquakes;for(let[e,t]of s.rows)o.push([$l(s.lon0+e*s.scale),eu(s.lat0+t*s.scale),!1]);for(let[e,t]of o)n=Math.min(n,e),r=Math.max(r,e),i=Math.min(i,t),a=Math.max(a,t);let c=(n+r)/2,l=(i+a)/2,u=o.filter(e=>!e[2]).map(([e,t])=>Math.hypot(e-c,t-l)).sort((e,t)=>e-t),d=u.length?u[Math.floor(.98*(u.length-1))]:0;for(let[e,t,n]of o)n&&(d=Math.max(d,Math.hypot(e-c,t-l)));return{x:c,z:l,r:d+t}}var Eu={quakes:-3,surface:-2,ghost:4},Du=.3,Ou={amc:{color:[.8,.39,.25],fill:.4,line:.8},wall:{color:[.93,.92,.88],fill:.07,line:.3}},ku=`
  ...
  }`;async function Nu(e=fetch){try{let t=await e(v(`subsurface.json`));return!t.ok||t.headers?.get(`content-type`)?.includes(`html`)?null:await t.json()}catch{return null}}var Pu=class{constructor(e,t,n){this.data=n,this.credit=n.credit;let r=n.earthquakes,i=xu(r);this.days=i.day,this.months=Cu(r.day0,i.day[i.day.length-1]),this.window=Tu(n),this.show=t.see,this.through={value:this.months[this.months.length-1].end},this.objects=[];let a=(t,n)=>{t.renderOrder=n,t.frustumCulled=!1,t.visible=!1,e.add(t),this.objects.push(t)},o=[[1,!1],[Du,!0]],s=new Zr;s.setAttribute(`position`,new Br(i.positions,3)),s.setAttribute(`elev`,new Br(i.elev,1)),s.setAttribute(`day`,new Br(i.day,1));for(let[e,n]of o)a(new hc(s,new bi({vertexShader:ku,fragmentShader:Au,transparent:!0,depthWrite:!n,depthFunc:n?6:3,uniforms:{uExag:t.exag,uFlat:t.flat,uThrough:this.through,uShow:t.see,uGhost:{value:e},uPx:{value:Math.min(devicePixelRatio,2)}}})),n?Eu.ghost:Eu.quakes);for(let e of n.surfaces){let n=Su(e),r=new Zr,i=Ou[e.key]??Ou.wall;r.setAttribute(`position`,new Br(n.positions,3)),r.setAttribute(`elev`,new Br(n.elev,1)),r.setIndex(new Br(n.index,1));for(let[e,n]of o)a(new li(r,new bi({vertexShader:ju,fragmentShader:Mu,transparent:!0,depthWrite:!1,side:2,depthFunc:n?6:3,uniforms:{uExag:t.exag,uFlat:t.flat,uShow:t.see,uGhost:{value:e},uColor:{value:new Y(...i.color)},uFill:{value:i.fill},uLine:{value:i.line}}})),n?Eu.ghost:Eu.surface)}this.rimMat=new Dl({color:15526886,linewidth:1.2,dashed:!0,dashSize:.12,gapSize:.09,transparent:!0,opacity:0}),this.rim=new Jl(new ql,this.rimMat),a(this.rim,6)}countThrough(e){return wu(this.days,this.months[e].end)}setThrough(e){this.through.value=this.months[e].end}update(e,t){let n=this.show.value;for(let e of this.objects)e.visible=n>.001;if(this.rimMat.opacity=.7*n,n>.001&&this._rimE!==e){let n=[];for(let[r,i]of[...this.data.rim,this.data.rim[0]])n.push($l(r),t(r,i)*e+.02,eu(i));this.rim.geometry.dispose(),this.rim.geometry=new ql,this.rim.geometry.setPositions(n),this.rim.computeLineDistances(),this._rimE=e}}},Fu=e=>e<.5?4*e*e*e:1-(-2*e+2)**3/2;function Iu(e,t){let[n,r]=e.ll,i=[$l(n),t(n,r)*.001*e.exag,eu(r)],a=Math.sin(e.polar),o=Math.cos(e.polar),s=[e.dist*a*Math.sin(e.az),e.dist*o,e.dist*a*Math.cos(e.az)];return{pos:[i[0]+s[0],i[1]+s[1],i[2]+s[2]],target:i}}function Lu(e,t,n,r){let i=n[0]-t[0],a=n[2]-t[2],o=Math.hypot(i,a)||1;i/=o,a/=o;let s=-a,c=i,l=0,u=0;e.has(`ArrowUp`)&&(l+=i,u+=a),e.has(`ArrowDown`)&&(l-=i,u-=a),e.has(`ArrowRight`)&&(l+=s,u+=c),e.has(`ArrowLeft`)&&(l-=s,u-=c);let d=Math.hypot(l,u);if(!d)return[0,0,0];let f=.3*Math.hypot(t[0]-n[0],t[1]-n[1],t[2]-n[2])*r/d;return[l*f,0,u*f]}var Ru=e=>!!e&&(e.isContentEditable||e.contentEditable===`true`||/^(INPUT|TEXTAREA|SELECT)$/.test(e.tagName)),zu=e=>Math.min(1,Math.max(.2,Math.sqrt(e/30))),Bu=(e,t)=>t?0:e,Vu=(e,t,n,r,i)=>i?t:e+(t-e)*Math.min(1,n*r),Hu=e=>!!e?.closest?.(`.panel, aside`),Uu=e=>!!e.key?.startsWith(`Arrow`)&&!(e.metaKey||e.ctrlKey||e.altKey)&&!Ru(e.target)&&!Hu(e.target),Wu=(e,t)=>(e-t)/2,Gu=(e,t,n,r)=>e*Math.max(1,(t-32)/Math.max(320,t-n-r)),Ku=class{constructor(e,t,n,{onFrame:r}={}){this.bundle=t,this.onFrame=r,this.flight=null,this.held=new Set,this.targets={flat:0,lines:0,mode:0,mute:0,see:0},this._view=`3d`,this.insets=[16,16],this.framed=!1,this._shift=[0,0],this._shiftTo=[0,0],this._motion=typeof matchMedia==`function`?matchMedia(`(prefers-reduced-motion: reduce)`):null,this.elevAt=iu([n.axial,n.hydrate,n.overview]);let i=this.renderer=new Ys({canvas:e,antialias:!0});i.setPixelRatio(Math.min(devicePixelRatio,2)),i.setSize(innerWidth,innerHeight),this.scene=new Xs,this.scene.background=new Nr(`#121211`),this.camera=new Ti(30,innerWidth/innerHeight,.05,6e3);let a=(e,t)=>new J(e[0]+t,e[1]-t,e[2]+t,e[3]-t);this.U={exag:{value:6},flat:{value:0},lines:{value:0},mode:{value:0},mute:{value:0},see:{value:0},glass:{value:new Y},holeA:a(n.axial.box,.35),holeB:a(n.hydrate.box,.35)},this.terrainMats=[],this.ready=(async()=>{let e=Nu(),t=iu([n.axial,n.hydrate,n.overview]);this.auv=await bu.create(this.scene,this.U,uu,void 0,t),this.auv&&this.terrainMats.push(...this.auv.mats),this._addTerrain(n.overview,100,!0,1),this._addTerrain(n.axial,50,!1,3,this.auv?{holeC:this.auv.box}:{}),this._addTerrain(n.hydrate,50,!1,3);let r=await e;if(r){this.subsurface=new Pu(this.scene,this.U,r);let e=this.subsurface.window;this.U.glass.value.set(e.x,e.z,e.r)}this.elevAt=(e,n)=>this.auv?.sample(e,n)??t(e,n)})();let o=this.controls=new dl(this.camera,e);o.enableDamping=!this.reducedMotion,o.dampingFactor=.08,o.screenSpacePanning=!1,o.zoomToCursor=!0,o.maxPolarAngle=Math.PI*.46,o.minDistance=2,o.maxDistance=1400,o.mouseButtons={LEFT:w.PAN,MIDDLE:w.DOLLY,RIGHT:w.ROTATE},o.touches={ONE:T.PAN,TWO:T.DOLLY_ROTATE},o.addEventListener(`start`,()=>{this.flight=null}),this._onContext=e=>e.preventDefault(),e.addEventListener(`contextmenu`,this._onContext),this._onKeyDown=e=>{Uu(e)&&(e.preventDefault(),this.held.add(e.key),this.flight=null)},this._onKeyUp=e=>e.key===`Meta`?this.held.clear():this.held.delete(e.key),this._onBlur=()=>this.held.clear(),this._onResize=()=>{i.setSize(innerWidth,innerHeight),this.camera.aspect=innerWidth/innerHeight,this._applyShift(),this._resolution(),this.onResize?.()},addEventListener(`keydown`,this._onKeyDown),addEventListener(`keyup`,this._onKeyUp),addEventListener(`blur`,this._onBlur),addEventListener(`resize`,this._onResize),this.jumpTo(t.overview),this.clock=new Fc,this._v=new Y,this.frame={},this._raf=requestAnimationFrame(this._tick)}_addTerrain(e,t,n,r,i={}){let a=au(e,r),o=new Zr;o.setAttribute(`position`,new Br(a.positions,3)),o.setAttribute(`elev`,new Br(a.elev,1)),o.setAttribute(`grad`,new Br(a.grad,2)),o.setIndex(new Br(a.index,1));let s=uu(this.U,t,n,i);this.terrainMats.push(s),n||(s.polygonOffset=!0,s.polygonOffsetFactor=-2,s.polygonOffsetUnits=-2),this.scene.add(new li(o,s))}addCable(e){let t={transparent:!0,depthTest:!0,depthWrite:!1,polygonOffset:!0,polygonOffsetFactor:-2,polygonOffsetUnits:-60};this.mats={cable:new Dl({color:15526886,linewidth:1.5,opacity:.95,...t}),casing:new Dl({color:723722,linewidth:3.8,opacity:.55,...t}),approx:new Dl({color:15526886,linewidth:1.5,opacity:.8,dashed:!0,dashSize:1.2,gapSize:.9,...t}),range:new Dl({color:15526886,linewidth:3,transparent:!0,opacity:.95})},this.cableLines=[];for(let t of e.lines){let e=qu(t.coords);for(let n of[this.mats.casing,t.accuracy===`approximate`?this.mats.approx:this.mats.cable]){let r=new Jl(new ql,n);r.userData={pts:e,info:n===this.mats.casing?null:t},r.renderOrder=n===this.mats.casing?5:6,this.scene.add(r),this.cableLines.push(r)}}this._resolution(),this.updateLines()}addMoorings(e){this.moorings=[];let t=this.mats.mast=new yc({color:15526886,transparent:!0,opacity:.35,dashSize:.12,gapSize:.1});for(let n of e.filter(e=>e.column.length)){let e=new lc(new Zr,t),r=n.column.map(e=>{let t=new Jl(new ql,this.mats.range);return t.userData=e,this.scene.add(t),t});this.scene.add(e),this.moorings.push({site:n,mast:e,ranges:r})}this.updateLines()}updateLines(){let e=this.e;for(let t of this.cableLines??[]){let n=[];for(let[r,i]of t.userData.pts)n.push($l(r),Math.min(this.elevAt(r,i),0)*e+.03+.012*this.U.exag.value,eu(i));t.geometry.dispose(),t.geometry=new ql,t.geometry.setPositions(n),t.material.dashed&&t.computeLineDistances()}for(let t of this.moorings??[]){let n=$l(t.site.lon),r=eu(t.site.lat),i=-t.site.seafloor*e;t.mast.geometry.setFromPoints([new Y(n,i,r),new Y(n,0,r)]),t.mast.computeLineDistances();for(let i of t.ranges){let t=i.userData,a=-t.a*e,o=t.a===t.b?a-1e-4-.02*this.U.exag.value:-t.b*e;i.geometry.dispose(),i.geometry=new ql,i.geometry.setPositions([n,a,r,n,o,r])}}this._lastLayout=[this.U.exag.value,this.U.flat.value]}_resolution(){for(let e of[...Object.values(this.mats??{}),this.subsurface?.rimMat])e?.resolution?.set(innerWidth,innerHeight)}get reducedMotion(){return!!this._motion?.matches}get e(){return this.U.exag.value*.001*(1-this.U.flat.value)}yFor(e,t,n){return(n??this.elevAt(e,t))*this.e}project(e,t,n){let r=this._v.set(e,t,n).project(this.camera);return[(r.x+1)/2*innerWidth,(1-r.y)/2*innerHeight,r.z]}jumpTo(e){this.setExag(e.exag);let t=Iu(e,this.elevAt);this.camera.position.set(...t.pos),this.controls.target.set(...t.target)}flyTo(e){let t=Iu(e,this.elevAt);this._fly(new Y(...t.pos),new Y(...t.target),e.exag,1800)}flyToPoint(e,t,n=6){let r=new Y($l(e),this.yFor(e,t),eu(t)),i=this.camera.position.clone().sub(this.controls.target).normalize();this._fly(r.clone().add(i.multiplyScalar(n)),r,this.U.exag.value,1300)}_fly(e,t,n,r){this.flight={t0:performance.now(),dur:Bu(r,this.reducedMotion),fromPos:this.camera.position.clone(),fromTarget:this.controls.target.clone(),fromExag:this.U.exag.value,toExag:n,pos:e,target:t}}setInsets(e,t,n=!1){this.framed=!0,this.insets=[e,t],this._shiftTo[0]=Wu(e,t),(n||this.reducedMotion)&&(this._shift[0]=this._shiftTo[0]),this._applyShift()}setInsetsY(e,t){this._shift[1]=this._shiftTo[1]=Wu(e,t),this._applyShift()}fit(e){return{...e,dist:Gu(e.dist,innerWidth,...this.insets)}}_applyShift(){this.camera.setViewOffset(innerWidth,innerHeight,-this._shift[0],-this._shift[1],innerWidth,innerHeight)}setExag(e){this.U.exag.value=e,this.onExag?.(e)}setStyle(e){this.targets.lines=+(e===`contours`)}setColor(e){this.targets.mode=+(e===`mono`)}setMute(e){this.targets.mute=e}setSubsurface(e){this.targets.see=+!!e;let t=this.subsurface?.window;if(!e||!t)return;this._resolution();let n=this.controls.target,r=this.camera.position.clone().sub(n);if(Math.hypot(n.x-t.x,n.z-t.z)<t.r&&r.length()<t.r*5)return;let i=this.U.exag.value,a=t.r*3.2,o=Math.atan2(r.x,r.z),s=new Y(t.x,-2600*i*.001,t.z),c=s.clone().add(new Y().setFromSphericalCoords(a,.85,o));this._fly(c,s,i,1800)}setQuakesThrough(e){this.subsurface?.setThrough(e)}setView(e){if(e===this._view)return;this._view=e;let t=e===`2d`;this.targets.flat=+!!t;let n=new Xc().setFromVector3(this.camera.position.clone().sub(this.controls.target));t&&(this._savedPolar=n.phi),n.phi=t?.001:this._savedPolar??.9,this.controls.minPolarAngle=0,this.controls.maxPolarAngle=t?.001:Math.PI*.46,this._fly(this.controls.target.clone().add(new Y().setFromSpherical(n)),this.controls.target.clone(),this.U.exag.value,900)}_tick=()=>{let e=performance.now(),t=Math.min(this.clock.getDelta(),.05),n=this.flight;if(n){let t=n.dur>0?Math.min(1,(e-n.t0)/n.dur):1,r=Fu(t);this.camera.position.lerpVectors(n.fromPos,n.pos,r),this.controls.target.lerpVectors(n.fromTarget,n.target,r),n.target.equals(n.fromTarget)||(this.camera.position.y+=Math.sin(Math.PI*r)*n.fromPos.distanceTo(n.pos)*.15),n.toExag!==n.fromExag&&this.setExag(n.fromExag+(n.toExag-n.fromExag)*r),t>=1&&(this.flight=null)}if(this.held.size){let e=Lu(this.held,this.camera.position.toArray(),this.controls.target.toArray(),t);this.camera.position.x+=e[0],this.camera.position.z+=e[2],this.controls.target.x+=e[0],this.controls.target.z+=e[2]}let r=this.reducedMotion;this.controls.enableDamping=!r,this.controls.rotateSpeed=zu(this.camera.position.distanceTo(this.controls.target)),this.controls.update(),this.auv?.update(this.controls.target,this.camera.position.distanceTo(this.controls.target),e);for(let[e,n]of[[`flat`,5],[`lines`,6],[`mode`,8],[`mute`,8]])this.U[e].value=Vu(this.U[e].value,this.targets[e],t,n,r);this._see=Vu(this._see??0,this.targets.see,t,5,r),this.U.see.value=this._see<.001?0:this._see*Math.max(0,1-this.U.flat.value*3);let i=this.U.see.value>0;if(i!==this._glassy){this._glassy=i;for(let e of this.terrainMats)e.transparent=i}this.subsurface?.update(this.e,this.elevAt),(this._shift[0]!==this._shiftTo[0]||this._shift[1]!==this._shiftTo[1])&&(this._shift=this._shift.map((e,n)=>{let i=this._shiftTo[n];return Math.abs(i-e)<.5?i:Vu(e,i,t,10,r)}),this._applyShift());let[a,o]=this._lastLayout??[];if((a!==this.U.exag.value||Math.abs((o??0)-this.U.flat.value)>1e-4)&&this.updateLines(),this.mats){let e=Math.max(0,1-this.U.flat.value*3);this.mats.range.opacity=.95*e,this.mats.mast.opacity=.35*e}this.camera.updateMatrixWorld();let s=this.camera.position.distanceTo(this.controls.target);this.frame={dist:s,regionMode:s>160,flat:this.U.flat.value,exag:this.U.exag.value,e:this.e},this.onFrame?.(this),this.renderer.render(this.scene,this.camera),this._raf=requestAnimationFrame(this._tick)};dispose(){cancelAnimationFrame(this._raf),removeEventListener(`keydown`,this._onKeyDown),removeEventListener(`keyup`,this._onKeyUp),removeEventListener(`blur`,this._onBlur),removeEventListener(`resize`,this._onResize),this.renderer.domElement.removeEventListener(`contextmenu`,this._onContext),this.controls.dispose(),this.renderer.dispose()}};function qu(e,t=.3){let n=[];for(let r=0;r<e.length-1;r++){let[i,a]=[e[r],e[r+1]],o=Math.max(1,Math.ceil(Math.hypot((a[0]-i[0])*Zl,(a[1]-i[1])*Ql)/t));for(let e=0;e<o;e++)n.push([i[0]+(a[0]-i[0])*e/o,i[1]+(a[1]-i[1])*e/o])}return n.push(e[e.length-1]),n}function Ju(e,t,n,r=48){for(let i=1;i<r;i++){let a=i/r;if(a>.97)break;let o=e[0]+(t[0]-e[0])*a;if(e[1]+(t[1]-e[1])*a<n(o,e[2]+(t[2]-e[2])*a)-.02)return!0}return!1}var Yu={OPERATIONAL:`Operating`,PARTIALLY_FUNCTIONAL:`Partially functional`,NOT_DEPLOYED:`Not deployed`,RETIRED:`Retired`,SUPERSEDED:`Superseded`,RECOVERED:`Recovered`,UNCABLED:`Uncabled`,PLANNED:`Planned (COSZO)`,UNKNOWN:`Status unknown`},Xu={OPERATIONAL:`operating`,PARTIALLY_FUNCTIONAL:`operating`,NOT_DEPLOYED:`offline`,RETIRED:`offline`,SUPERSEDED:`offline`,RECOVERED:`offline`,UNCABLED:`offline`,PLANNED:`planned`,UNKNOWN:`unknown`},Zu=e=>Math.round(e).toLocaleString(`en-US`),Qu=e=>e==null?`—`:`${Zu(e)} m`,$u=(e,t)=>e==null||t==null?`—`:e===t?`${Zu(e)} m`:`${Zu(e)}–${Zu(t)} m`,ed=e=>Yu[e]??e,td=e=>Xu[e]??`unknown`,nd=e=>{let t=e?new Date(e):null;return t&&!Number.isNaN(t.getTime())?t.toLocaleDateString(`en-US`,{month:`short`,day:`numeric`,year:`numeric`,timeZone:`UTC`}):`unknown date`};function rd(e,t,n,r=7){let i=null,a=r;for(let{info:r,pts:o}of n)for(let n=0;n<o.length-1;n++){let[s,c]=o[n],[l,u]=o[n+1],d=l-s,f=u-c,p=d*d+f*f||1,m=Math.max(0,Math.min(1,((e-s)*d+(t-c)*f)/p)),h=Math.hypot(e-s-m*d,t-c-m*f);h<a&&(a=h,i=r)}return i}function id(e){let t=[],n=[];for(let r of e)r[2]<1?n.push(r):(n.length>1&&t.push(n),n=[]);return n.length>1&&t.push(n),t}function ad(e){let t=[],n=new Set;for(let r of[...e].sort((e,t)=>t.priority-e.priority)){let e=[r.x,r.y-r.h/2,r.x+r.w,r.y+r.h/2];t.some(t=>!(e[2]<t[0]||e[0]>t[2]||e[3]<t[1]||e[1]>t[3]))||(n.add(r.id),t.push(e))}return n}function od(e,t,n,r=6){let i=[],a=new Map;for(let o of[...e].sort((e,t)=>t.priority-e.priority)){let e=t,s;for(let t=0;t<=r&&(s=[o.x-o.w/2,o.y-e-o.h,o.x+o.w/2,o.y-e],i.some(e=>!(s[2]<e[0]||s[0]>e[2]||s[3]<e[1]||s[1]>e[3])));t++,e+=o.h+n);i.push(s),a.set(o.id,Math.min(e,t+r*(o.h+n)))}return a}var sd={operating:0,offline:1,planned:2,unknown:3},cd=e=>e>6?30:e>2?24:18;function ld(e,t,n,r){let i=Object.fromEntries(Object.keys(n).map((e,t)=>[e,t])),a=e.sensorIds.map(e=>t[e]).sort((e,t)=>i[e.family]-i[t.family]||sd[td(e.status)]-sd[td(t.status)]),o=a.length,s=r/2-2.5,c=r/2,l=o>1?Math.min(.22,1.4/o):0,u=e=>`${(c+s*Math.cos(e)).toFixed(2)} ${(c+s*Math.sin(e)).toFixed(2)}`,d=a.map((e,t)=>{let r=td(e.status),i=n[e.family].color,a=t/o*Math.PI*2-Math.PI/2+l/2,d=(t+1)/o*Math.PI*2-Math.PI/2-l/2,f=o===1?`M ${c-s} ${c} a ${s} ${s} 0 1 0 ${2*s} 0 a ${s} ${s} 0 1 0 ${-2*s} 0`:`M ${u(a)} A ${s} ${s} 0 ${+(d-a>Math.PI)} 1 ${u(d)}`,p=r===`operating`||r===`offline`?3.2:1.3,m=(r===`offline`?` opacity="0.3"`:``)+(r===`unknown`?` stroke-dasharray="1.6 1.4"`:``);return`<path class="seg" data-fam="${e.family}" d="${f}" fill="none" stroke="${i}" stroke-width="${p}"${m}/>`}).join(``);return`<svg width="${r}" height="${r}" viewBox="0 0 ${r} ${r}" aria-hidden="true">${a.some(e=>td(e.status)===`operating`)?`<circle class="halo" cx="${c}" cy="${c}" r="${s+4}" fill="none" stroke="#ecebe6" stroke-width="1"/>`:``}<circle cx="${c}" cy="${c}" r="${s+2.2}" fill="rgba(12,12,11,0.72)"/>${d}<circle cx="${c}" cy="${c}" r="1.8" fill="#ecebe6"/></svg>`}var ud=[{t:`Newport`,lon:-124.05,lat:44.63},{t:`Pacific City`,lon:-123.96,lat:45.2}],dd=class{constructor(e,t,n,r){this.c=e,this.b=t,this.scene=n,this.h=r,this.focus=new Set,this.selected=null;let i=(t,n)=>{let r=document.createElement(`div`);return r.className=t,r.innerHTML=n,e.appendChild(r),r},a=t.sensors.filter(e=>e.lat!=null);this.regions=t.regions.filter(e=>a.some(t=>t.region===e.key)).map(e=>{let t=a.filter(t=>t.region===e.key),n=t.reduce((e,t)=>e+t.lon,0)/t.length,o=t.reduce((e,t)=>e+t.lat,0)/t.length,s=i(`rlabel`,`<div class="card"><b>${e.label}</b><span class="mono">${t.length}</span></div><div class="stem"></div><div class="foot"></div>`);return s.onclick=()=>r.onRegionClick?.(e.key),{d:s,lon:n,lat:o,n:t.length,card:s.querySelector(`.card`),stem:s.querySelector(`.stem`)}}),this.sites=t.sites.map(e=>{let n=cd(e.sensorIds.length),a=i(`site`,ld(e,t.sensorById,t.familyByKey,n)+`<div class="name">${e.label}<span class="mono">${e.sensorIds.length}</span></div>`),o=e.sensorIds.length;a.setAttribute(`role`,`button`),a.setAttribute(`aria-label`,`${e.label}, ${o} sensor${o===1?``:`s`}`),a.tabIndex=-1;let s=t=>{this._hovered=e.id,r.onSiteHover?.(e,t)};return a.onmouseenter=s,a.onmousemove=s,a.onmouseleave=()=>{this._hovered=null,r.onSiteHover?.(e,null)},a.onclick=()=>r.onSiteClick?.(e),a.onkeydown=t=>{(t.key===`Enter`||t.key===` `)&&(t.preventDefault(),r.onSiteClick?.(e))},{site:e,d:a,name:a.querySelector(`.name`),size:n,inFocus:!0}}),this.columns=t.sites.filter(e=>e.column.length).map(e=>({site:e,d:i(`clabel`,`<div class="surface">Sea surface <span class="mono">0 m</span></div>`+e.column.map(e=>`<div>${e.kind} <span class="mono">${$u(e.a,e.b)}</span></div>`).join(``)+`<div class="floor">Seafloor <span class="mono">${Qu(e.seafloor)}</span></div>`)})),this.nodes=t.cable.nodes.map(e=>{let t=i(`pnode`,`<i></i><span class="mono">${e.code}</span>`);return t.onmouseenter=t=>r.onNodeHover?.(e,t),t.onmousemove=t=>r.onNodeHover?.(e,t),t.onmouseleave=()=>r.onNodeHover?.(e,null),t.onclick=()=>r.onNodeClick?.(e),{node:e,d:t,code:t.querySelector(`span`)}}),this.places=ud.map(e=>({...e,d:i(`place`,e.t)})),this._clearCable=()=>{n.renderer.domElement.style.cursor=``,r.onCableHover?.(null,null)},this._onMove=e=>{if(e.buttons)return;let t=(n.cableLines??[]).filter(e=>e.userData.info&&e.userData.proj).flatMap(e=>id(e.userData.proj).map(t=>({info:e.userData.info,pts:t}))),i=rd(e.clientX,e.clientY,t);n.renderer.domElement.style.cursor=i?`help`:``,r.onCableHover?.(i,i?e:null)},n.renderer.domElement.addEventListener(`pointermove`,this._onMove),n.renderer.domElement.addEventListener(`pointerleave`,this._clearCable),n.renderer.domElement.addEventListener(`pointerdown`,this._clearCable)}setFocus(e){this.focus=e;for(let t of this.sites){for(let n of t.d.querySelectorAll(`path.seg`))n.style.opacity=e.size&&!e.has(n.dataset.fam)?.07:``;t.inFocus=!e.size||t.site.sensorIds.some(t=>e.has(this.b.sensorById[t].family))}}setSelected(e){this.selected=e;for(let t of this.sites)t.d.classList.toggle(`selected`,t.site.id===e)}update(){let e=this.scene,{dist:t,regionMode:n,e:r,flat:i}=e.frame,a=e.camera.position.toArray(),o=(t,n)=>Math.min(0,e.elevAt(tu(t),nu(n)))*r,s=[];for(let t of this.regions){let[r,i,a]=e.project($l(t.lon),e.yFor(t.lon,t.lat)+.3,eu(t.lat));Object.assign(t.d.style,{left:`${r}px`,top:`${i+3}px`,opacity:n&&a<1?1:0,pointerEvents:n?`auto`:`none`}),!t.w&&t.card.offsetWidth&&(t.w=t.card.offsetWidth,t.h=t.card.offsetHeight),n&&a<1&&s.push({id:t,x:r,y:i+3,w:t.w??0,h:t.h??0,priority:t.n})}let c=od(s,26,6);for(let e of this.regions){let t=`${c.get(e)??26}px`;e.stem.style.height!==t&&(e.stem.style.height=t)}let l=[];for(let t of this.sites){let i=$l(t.site.lon),s=-t.site.seafloor*r,c=eu(t.site.lat),[u,d,f]=e.project(i,s,c),p=!n&&f<1&&u>-40&&u<innerWidth+40&&d>-40&&d<innerHeight+40;t.hidden=p&&Ju(a,[i,s+.01,c],o);let m=p&&!t.hidden;!m&&this._hovered===t.site.id&&(this._hovered=null,this.h.onSiteHover?.(t.site,null)),Object.assign(t.d.style,{left:`${u}px`,top:`${d}px`,opacity:p?t.hidden?.12:t.inFocus?1:.25:0,pointerEvents:m?`auto`:`none`});let h=m?0:-1;t.d.tabIndex!==h&&(t.d.tabIndex=h),m&&t.inFocus&&l.push({id:t.site.id,x:u-t.size/2,y:d,w:t.size+12+t.site.label.length*6.4,h:18,priority:t.site.sensorIds.length}),t._x=u,t._y=d}let u=ad(l);for(let e of this.sites)e.name.style.opacity=+!!u.has(e.site.id);let d=Math.max(0,1-i*3);for(let r of this.columns){let i=$l(r.site.lon),s=eu(r.site.lat),[c,l,u]=e.project(i,0,s),f=d>.5&&!n&&u<1&&t<90&&!Ju(a,[i,0,s],o);Object.assign(r.d.style,{left:`${c}px`,top:`${l}px`,opacity:+!!f})}for(let t of this.nodes){let[i,a,o]=e.project($l(t.node.lon),Math.min(e.elevAt(t.node.lon,t.node.lat),0)*r+.05,eu(t.node.lat));Object.assign(t.d.style,{left:`${i}px`,top:`${a}px`,opacity:o<1?n?.75:.9:0}),t.code.style.opacity=+!!n}for(let t of this.places){let[n,r,i]=e.project($l(t.lon),.3,eu(t.lat));Object.assign(t.d.style,{left:`${n}px`,top:`${r}px`,opacity:+(i<1)})}for(let t of e.cableLines??[])t.userData.info&&(t.userData.proj=t.userData.pts.filter((e,t)=>t%3==0).map(([t,n])=>e.project($l(t),Math.min(e.elevAt(t,n),0)*r,eu(n))))}dispose(){let e=this.scene.renderer.domElement;e.removeEventListener(`pointermove`,this._onMove),e.removeEventListener(`pointerleave`,this._clearCable),e.removeEventListener(`pointerdown`,this._clearCable),this.c.innerHTML=``}},fd=o((e=>{var t=u(),n=Symbol.for(`react.element`),r=Symbol.for(`react.fragment`),i=Object.prototype.hasOwnProperty,a=t.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,o={key:!0,ref:!0,__self:!0,__source:!0};function s(e,t,r){var s,c={},l=null,u=null;for(s in r!==void 0&&(l=``+r),t.key!==void 0&&(l=``+t.key),t.ref!==void 0&&(u=t.ref),t)i.call(t,s)&&!o.hasOwnProperty(s)&&(c[s]=t[s]);if(e&&e.defaultProps)for(s in t=e.defaultProps,t)c[s]===void 0&&(c[s]=t[s]);return{$$typeof:n,type:e,key:l,ref:u,props:c,_owner:a.current}}e.Fragment=r,e.jsx=s,e.jsxs=s})),$=o(((e,t)=>{t.exports=fd()}))();function pd(e,t=!1){let n=`atlas.min.${e}`,[r,i]=(0,g.useState)(()=>{let e=localStorage.getItem(n);return e==null?t:e===`true`});return(0,g.useEffect)(()=>{localStorage.setItem(n,String(r))},[n,r]),[r,i]}function md({label:e,onClick:t}){return(0,$.jsx)(`button`,{className:`min-btn`,"aria-label":`Minimize ${e}`,"aria-expanded":`true`,onClick:t,children:`–`})}function hd({children:e,className:t=``,onClick:n,title:r}){return(0,$.jsx)(`button`,{className:`panel hud-toggle ${t}`,"aria-expanded":`false`,title:r,onClick:n,children:e})}function gd({label:e,options:t,value:n,onChange:r}){return(0,$.jsxs)(`div`,{className:`ctl-row`,children:[(0,$.jsx)(`span`,{className:`eyebrow`,children:e}),(0,$.jsx)(`div`,{className:`seg`,role:`group`,"aria-label":e,children:t.map(([e,t])=>(0,$.jsx)(`button`,{"aria-pressed":n===e,onClick:()=>{e!==n&&r(e)},children:t},e))})]})}function _d({scene:e,sub:t}){let n=t.months.length-1,[r,i]=(0,g.useState)(n),[a,o]=(0,g.useState)(!1);(0,g.useEffect)(()=>{e.setQuakesThrough(r)},[e,r]),(0,g.useEffect)(()=>{if(!a)return;let e=setInterval(()=>i(e=>Math.min(n,e+1)),140);return()=>clearInterval(e)},[a,n]),(0,g.useEffect)(()=>{r===n&&o(!1)},[r,n]);let s=t.months[r].label,c=t.countThrough(r).toLocaleString(`en-US`);return(0,$.jsxs)(`div`,{className:`timeline`,children:[(0,$.jsxs)(`div`,{className:`ctl-row`,children:[(0,$.jsx)(`span`,{className:`eyebrow`,children:`Earthquakes`}),(0,$.jsxs)(`span`,{className:`mono readout`,children:[`to `,s,` · `,c]})]}),(0,$.jsxs)(`div`,{className:`ctl-row`,children:[(0,$.jsx)(`button`,{className:`play`,"aria-label":a?`Pause`:`Play month by month`,onClick:()=>{!a&&r===n&&i(0),o(!a)},children:(0,$.jsx)(`svg`,{width:`10`,height:`10`,viewBox:`0 0 10 10`,"aria-hidden":`true`,children:a?(0,$.jsx)(`path`,{d:`M2 1h2v8H2zM6 1h2v8H6z`,fill:`currentColor`}):(0,$.jsx)(`path`,{d:`M2 1l7 4-7 4z`,fill:`currentColor`})})}),(0,$.jsx)(`input`,{type:`range`,min:`0`,max:n,step:`1`,value:r,"aria-label":`Earthquakes through month`,"aria-valuetext":`Through ${s}: ${c} earthquakes`,onChange:e=>{o(!1),i(+e.target.value)}})]})]})}function vd({scene:e,compact:t=!1,deep:n=!1,onDeep:r}){let i=e?.subsurface,[a,o]=(0,g.useState)(null);(0,g.useEffect)(()=>o(null),[t]);let s=a??!t,[c,l]=(0,g.useState)(`3d`),[u,d]=(0,g.useState)(`relief`),[f,p]=(0,g.useState)(`depth`),[m,h]=(0,g.useState)(e?.U?.exag?.value??6);(0,g.useEffect)(()=>(e&&(e.onExag=e=>h(e)),()=>{e&&(e.onExag=null)}),[e]);let[_,v]=(0,g.useState)(`16 m`);return(0,g.useEffect)(()=>{let t=setInterval(()=>e?.auv&&v(e.auv.finest()),250);return()=>clearInterval(t)},[e]),s?(0,$.jsxs)(`div`,{className:`panel controls`,children:[(0,$.jsxs)(`div`,{className:`panel-head`,children:[(0,$.jsx)(`span`,{className:`eyebrow`,children:`Terrain`}),(0,$.jsx)(md,{label:`terrain controls`,onClick:()=>o(!1)})]}),(0,$.jsx)(gd,{label:`View`,options:[[`3d`,`3D`],[`2d`,`2D`]],value:c,onChange:t=>{l(t),e.setView(t)}}),(0,$.jsx)(gd,{label:`Style`,options:[[`relief`,`Relief`],[`contours`,`Contours`]],value:u,onChange:t=>{d(t),e.setStyle(t)}}),(0,$.jsx)(gd,{label:`Color`,options:[[`depth`,`Depth`],[`mono`,`Mono`]],value:f,onChange:t=>{p(t),e.setColor(t)}}),(0,$.jsxs)(`div`,{className:`ctl-row`,children:[(0,$.jsxs)(`label`,{className:`eyebrow`,htmlFor:`exag`,children:[`Vertical `,(0,$.jsxs)(`span`,{className:`mono`,children:[`×`,Number(m).toFixed(1)]})]}),(0,$.jsx)(`input`,{id:`exag`,type:`range`,min:`1`,max:`12`,step:`0.1`,value:m,disabled:c===`2d`,"aria-label":`Vertical exaggeration`,onChange:t=>{let n=+t.target.value;h(n),e.flight=null,e.setExag(n)}})]}),e?.auv&&(0,$.jsxs)(`div`,{className:`ctl-row`,children:[(0,$.jsx)(`span`,{className:`eyebrow`,children:`Axial detail`}),(0,$.jsx)(`span`,{className:`mono`,"aria-live":`polite`,children:_})]}),i&&(0,$.jsx)(gd,{label:`Subsurface`,options:[[`off`,`Off`],[`on`,`On`]],value:n?`on`:`off`,onChange:t=>{r?.(t===`on`),e.setSubsurface(t===`on`)}}),i&&n&&(0,$.jsx)(_d,{scene:e,sub:i}),(0,$.jsxs)(`div`,{className:`hint`,children:[`Drag to move · `,(0,$.jsx)(`kbd`,{children:`Ctrl`}),`-drag to rotate · Scroll to zoom · `,(0,$.jsx)(`kbd`,{children:`←`}),(0,$.jsx)(`kbd`,{children:`↑`}),(0,$.jsx)(`kbd`,{children:`↓`}),(0,$.jsx)(`kbd`,{children:`→`}),` to move · Hover the cable or a node for details`]})]}):(0,$.jsx)(hd,{className:`controls-toggle`,onClick:()=>o(!0),children:`Terrain controls`})}var yd={circle:e=>(0,$.jsx)(`circle`,{cx:`6`,cy:`6`,r:`4.6`,fill:e}),triangle:e=>(0,$.jsx)(`polygon`,{points:`6,1.2 10.8,10 1.2,10`,fill:e}),square:e=>(0,$.jsx)(`rect`,{x:`1.8`,y:`1.8`,width:`8.4`,height:`8.4`,fill:e}),diamond:e=>(0,$.jsx)(`polygon`,{points:`6,0.8 11.2,6 6,11.2 0.8,6`,fill:e}),hexagon:e=>(0,$.jsx)(`polygon`,{points:`6,0.9 10.6,3.5 10.6,8.5 6,11.1 1.4,8.5 1.4,3.5`,fill:e}),bar:e=>(0,$.jsx)(`rect`,{x:`0.8`,y:`4.3`,width:`10.4`,height:`3.4`,fill:e})};function bd({glyph:e,color:t,size:n=11}){return(0,$.jsx)(`svg`,{width:n,height:n,viewBox:`0 0 12 12`,"aria-hidden":`true`,style:{flex:`none`},children:yd[e](t)})}function xd({families:e,sensors:t,focus:n,onChange:r}){let i=t.filter(e=>e.lat!=null),a=e=>i.filter(t=>t.family===e).length,o=(e,t)=>{if(t){let t=new Set(n);t.has(e)?t.delete(e):t.add(e),r(t)}else r(n.size===1&&n.has(e)?new Set:new Set([e]))},[s,c]=pd(`families`);return(0,$.jsx)(`div`,{className:`panel families${s?` minimized`:``}`,role:`group`,"aria-label":`Sensor families`,children:s?(0,$.jsxs)(`button`,{className:`families-tab`,"aria-expanded":`false`,onClick:()=>c(!1),children:[`Sensor families`,n.size?(0,$.jsxs)(`span`,{className:`n mono`,children:[n.size,` selected`]}):null]}):(0,$.jsxs)($.Fragment,{children:[e.filter(e=>a(e.key)>0).map(e=>(0,$.jsxs)(`button`,{className:n.size&&!n.has(e.key)?`muted`:``,"aria-pressed":n.has(e.key),onClick:t=>o(e.key,t.shiftKey),children:[(0,$.jsx)(bd,{glyph:e.glyph,color:e.color}),(0,$.jsx)(`span`,{children:e.label}),(0,$.jsx)(`span`,{className:`n mono`,children:a(e.key)})]},e.key)),(0,$.jsx)(md,{label:`sensor families`,onClick:()=>c(!0)})]})})}function Sd(e,t,n=8){let r=t.trim().toLowerCase();if(!r)return[];let i=e=>{let t=e.filter(Boolean).map(e=>String(e).toLowerCase());return t.some(e=>e.startsWith(r))?2:+!!t.some(e=>e.includes(r))},a=[];for(let t of e.sites){let e=i([t.name,t.label]);e&&a.push({kind:`site`,id:t.id,title:t.name,sub:t.label,located:!0,sc:e+.5})}for(let t of e.sensors){let n=i([t.name,t.type.replaceAll(`_`,` `),t.refdes,t.id]);if(!n)continue;let r=e.siteById[t.site]?.label,o=t.lat!=null;a.push({kind:`sensor`,id:t.id,title:t.name,located:o,sub:o?r??``:[r,`no recorded position`].filter(Boolean).join(` · `),sc:o?n:n-.25})}return a.sort((e,t)=>t.sc-e.sc||e.title.localeCompare(t.title)).slice(0,n).map(({sc:e,...t})=>t)}function Cd({bundle:e,onPick:t}){let[n,r]=(0,g.useState)(``),[i,a]=(0,g.useState)(0),o=(0,g.useMemo)(()=>Sd(e,n),[e,n]),s=(0,g.useRef)(null),c=e=>{t(e),r(``),s.current?.blur()};return(0,$.jsxs)(`div`,{className:`search`,children:[(0,$.jsx)(`input`,{ref:s,type:`search`,placeholder:`Search sensors and sites`,value:n,"aria-label":`Search sensors and sites`,onChange:e=>{r(e.target.value),a(0)},onKeyDown:e=>{e.key===`ArrowDown`&&(e.preventDefault(),a(e=>Math.min(e+1,o.length-1))),e.key===`ArrowUp`&&(e.preventDefault(),a(e=>Math.max(e-1,0))),e.key===`Enter`&&o[i]&&c(o[i]),e.key===`Escape`&&r(``)}}),o.length>0&&(0,$.jsx)(`ul`,{role:`listbox`,children:o.map((e,t)=>(0,$.jsxs)(`li`,{role:`option`,"aria-selected":t===i,className:e.located===!1?`unlocated`:void 0,onMouseDown:t=>{t.preventDefault(),c(e)},children:[(0,$.jsx)(`span`,{children:e.title}),(0,$.jsx)(`span`,{className:`sub`,children:e.sub})]},`${e.kind}-${e.id}`))})]})}function wd({bundle:e,onPick:t}){let n=e.sensors.filter(e=>e.lat!=null),r=n.filter(e=>e.statusGroup===`operating`).length,[i,a]=pd(`header`);return i?(0,$.jsx)(hd,{className:`header-toggle`,title:`Show the title, counts, and search`,onClick:()=>a(!1),children:`Cascadia Offshore Sensor Atlas`}):(0,$.jsxs)(`header`,{className:`panel header`,children:[(0,$.jsxs)(`div`,{className:`panel-head`,children:[(0,$.jsx)(`h1`,{children:`Cascadia Offshore Sensor Atlas`}),(0,$.jsx)(md,{label:`title and search`,onClick:()=>a(!0)})]}),(0,$.jsx)(`p`,{children:`OOI Regional Cabled Array and COSZO sensors, offshore Oregon.`}),(0,$.jsxs)(`div`,{className:`stats`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`b`,{className:`mono`,children:n.length}),(0,$.jsx)(`span`,{children:`Sensors`})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`b`,{className:`mono`,children:r}),(0,$.jsx)(`span`,{children:`Operating`})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`b`,{className:`mono`,children:e.sites.length}),(0,$.jsx)(`span`,{children:`Sites`})]})]}),(0,$.jsx)(Cd,{bundle:e,onPick:t})]})}function Td({credit:e,compact:t=!1,auv:n=!1,subsurface:r=null}){let[i,a]=(0,g.useState)(null);(0,g.useEffect)(()=>a(null),[t]);let o=i??!t,s=(0,g.useRef)(null);return(0,g.useLayoutEffect)(()=>{let e=s.current;if(!e)return;let t=()=>{let t=e.getBoundingClientRect(),n=document.querySelector(`.families`)?.getBoundingClientRect(),r=n&&n.width&&n.right>t.left&&n.left<t.right;e.style.maxHeight=`${Math.max(120,(r?n.top-8:innerHeight-16)-t.top)}px`};t(),addEventListener(`resize`,t);let n=typeof ResizeObserver==`function`?new ResizeObserver(t):null,r=e.closest(`.hud-top`)??e.parentElement,i=document.querySelector(`.families`);if(n)for(let e of[r,...r?.children??[],i].filter(Boolean))n.observe(e);return()=>{removeEventListener(`resize`,t),n?.disconnect()}},[o]),o?(0,$.jsxs)(`div`,{className:`panel legend`,ref:s,children:[(0,$.jsxs)(`div`,{className:`panel-head`,children:[(0,$.jsx)(`span`,{className:`eyebrow`,children:`Legend`}),(0,$.jsx)(md,{label:`legend`,onClick:()=>a(!1)})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`div`,{className:`eyebrow`,children:`Site marker`}),(0,$.jsx)(`div`,{className:`row`,children:`One segment per sensor, colored by family`}),(0,$.jsxs)(`div`,{className:`row`,children:[(0,$.jsx)(`svg`,{className:`glyph`,children:(0,$.jsx)(`path`,{d:`M1 6h10`,style:{stroke:`var(--text-secondary)`},strokeWidth:`3`})}),`Operating`]}),(0,$.jsxs)(`div`,{className:`row`,children:[(0,$.jsx)(`svg`,{className:`glyph`,children:(0,$.jsx)(`path`,{d:`M1 6h10`,style:{stroke:`var(--text-secondary)`},strokeWidth:`3`,opacity:`0.28`})}),`Not deployed / retired`]}),(0,$.jsxs)(`div`,{className:`row`,children:[(0,$.jsx)(`svg`,{className:`glyph`,children:(0,$.jsx)(`path`,{d:`M1 6h10`,style:{stroke:`var(--text-secondary)`},strokeWidth:`1.2`})}),`Planned (COSZO)`]}),(0,$.jsxs)(`div`,{className:`row`,children:[(0,$.jsx)(`svg`,{className:`glyph`,children:(0,$.jsx)(`path`,{d:`M1 6h10`,style:{stroke:`var(--text-secondary)`},strokeWidth:`1.2`,strokeDasharray:`1.6 1.4`})}),`Status unknown`]})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`div`,{className:`eyebrow`,children:`Water column`}),(0,$.jsx)(`div`,{className:`row`,children:`Mooring above a seafloor site; solid where sensors sample`})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`div`,{className:`eyebrow`,children:`Cable`}),(0,$.jsxs)(`div`,{className:`row`,children:[(0,$.jsx)(`svg`,{className:`glyph`,children:(0,$.jsx)(`path`,{d:`M0 6h12`,stroke:`#ecebe6`,strokeWidth:`1.5`})}),`Charted or mapped route`]}),(0,$.jsxs)(`div`,{className:`row`,children:[(0,$.jsx)(`svg`,{className:`glyph`,children:(0,$.jsx)(`rect`,{x:`3`,y:`3`,width:`6`,height:`6`,fill:`#121211`,stroke:`#ecebe6`,strokeWidth:`1.5`})}),`Primary node`]})]}),r&&(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`div`,{className:`eyebrow`,children:`Beneath Axial`}),(0,$.jsxs)(`div`,{className:`row`,children:[(0,$.jsx)(`svg`,{className:`glyph`,children:(0,$.jsx)(`circle`,{cx:`6`,cy:`6`,r:`2.2`,fill:`#a8a69d`})}),`Earthquake, 2015–2021`]}),(0,$.jsxs)(`div`,{className:`row`,children:[(0,$.jsx)(`svg`,{className:`glyph`,children:(0,$.jsx)(`circle`,{cx:`6`,cy:`6`,r:`3`,fill:`#ffcc85`})}),`Within 60 days of the slider month`]}),(0,$.jsxs)(`div`,{className:`row`,children:[(0,$.jsx)(`svg`,{className:`glyph`,children:(0,$.jsx)(`rect`,{x:`1`,y:`2`,width:`14`,height:`8`,rx:`1`,fill:`#cc6340`,opacity:`0.75`})}),`Magma chamber (AMC) top`]}),(0,$.jsxs)(`div`,{className:`row`,children:[(0,$.jsx)(`svg`,{className:`glyph`,children:(0,$.jsx)(`rect`,{x:`1.5`,y:`2.5`,width:`13`,height:`7`,rx:`1`,fill:`#edebe0`,fillOpacity:`0.12`,stroke:`#edebe0`,strokeOpacity:`0.5`})}),`Caldera-wall faults`]}),(0,$.jsxs)(`div`,{className:`row`,children:[(0,$.jsx)(`svg`,{className:`glyph`,children:(0,$.jsx)(`path`,{d:`M0 6h12`,stroke:`#ecebe6`,strokeWidth:`1.2`,strokeDasharray:`2 1.6`})}),`Caldera rim`]}),(0,$.jsx)(`div`,{className:`row`,children:`Lines every 100 m of depth; the seafloor above turns to glass`})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`div`,{className:`eyebrow`,children:`Seafloor depth`}),(0,$.jsx)(`div`,{className:`ramp`}),(0,$.jsxs)(`div`,{className:`ramp-labels mono`,children:[(0,$.jsx)(`span`,{children:`0 m`}),(0,$.jsx)(`span`,{children:`1,500`}),(0,$.jsx)(`span`,{children:`3,000`}),(0,$.jsx)(`span`,{children:`4,800`})]})]}),(0,$.jsxs)(`div`,{className:`attribution`,children:[`Bathymetry: `,e,`.`,n&&` Axial summit: MBARI AUV survey (cruise V2506), 1 m.`,` Cable: NOAA/BOEM Marine Cadastre, OOI mariner notices; west of the US EEZ and at Axial, ooi_cables.csv (M. Kidiwela). Status: Nereus.`,r&&` ${r}.`]})]}):(0,$.jsx)(hd,{className:`legend-toggle`,onClick:()=>a(!0),children:`Legend`})}function Ed({regions:e,sensors:t,active:n,onSelect:r,unplaced:i=0,unplacedOpen:a=!1,onUnplaced:o}){let s=t.filter(e=>e.lat!=null),c=[[`overview`,`Full array`,s.length],...e.map(e=>[e.key,e.label,s.filter(t=>t.region===e.key).length])],[l,u]=pd(`regions`);if(l){let e=c.find(([e])=>e===n)?.[1];return(0,$.jsxs)(hd,{className:`regions-toggle`,onClick:()=>u(!1),children:[`Regions`,e?` · ${e}`:``]})}return(0,$.jsxs)(`nav`,{className:`panel regions`,"aria-label":`Regions`,children:[(0,$.jsxs)(`div`,{className:`panel-head`,style:{padding:`2px 4px 4px 10px`},children:[(0,$.jsx)(`span`,{className:`eyebrow`,children:`Regions`}),(0,$.jsx)(md,{label:`regions`,onClick:()=>u(!0)})]}),c.map(([e,t,i])=>(0,$.jsxs)(`button`,{"aria-pressed":n===e,onClick:()=>r(e),children:[t,(0,$.jsx)(`span`,{className:`n mono`,children:i})]},e)),i>0&&o&&(0,$.jsxs)(`button`,{className:`unplaced`,"aria-pressed":a,onClick:o,title:`Sensors with no recorded position and no catalogued site`,children:[`Unplaced sensors`,(0,$.jsx)(`span`,{className:`n mono`,children:i})]})]})}function Dd({credit:e,auv:t=!1,subsurface:n=!1}){return(0,$.jsxs)(`div`,{className:`credit`,"aria-label":`Map credits`,children:[`Bathymetry: `,e??`GMRT, Ryan et al. (2009), CC BY 4.0`,t&&` · Axial summit: MBARI AUV survey, 1 m`,n&&` · Subsurface: M. Kidiwela, axial_visuals`]})}function Od(e,t,n=new Date){if(e.kind===`erddap`)return{label:`Python (erddapy)`,code:`from erddapy import ERDDAP
...
df = e.to_pandas()   # ${t.name}`};if(e.kind===`earthscope`){let t=e.channel??`HHZ`,r=e=>e.toISOString().slice(0,19),i=new Date(Math.floor(n.getTime()/1e3)*1e3);return{label:`FDSN dataselect (MiniSEED, the last hour, UTC)`,code:`curl -o ${e.network}.${e.station}.mseed "https://service.earthscope.org/fdsnws/dataselect/1/query?net=${e.network}&sta=${e.station}&cha=${t}&loc=--&starttime=${r(new Date(i.getTime()-36e5))}&endtime=${r(i)}"`}}return e.kind===`pi_portal`?{label:`List files`,code:`curl -s "${e.url}"`}:null}function kd({sensor:e}){let[t,n]=(0,g.useState)(null);return e.access.length?(0,$.jsxs)(`section`,{className:`gtd`,children:[(0,$.jsx)(`h3`,{children:`Get this data`}),e.access.map((r,i)=>{let a=Od(r,e);return(0,$.jsxs)(`div`,{className:`route`,children:[(0,$.jsx)(`a`,{href:r.url,target:`_blank`,rel:`noreferrer`,children:r.label}),(0,$.jsx)(`p`,{children:r.how}),a&&(0,$.jsxs)(`div`,{className:`snippet`,children:[(0,$.jsxs)(`div`,{className:`snip-head`,children:[(0,$.jsx)(`span`,{children:a.label}),(0,$.jsx)(`button`,{onClick:()=>{navigator.clipboard?.writeText(a.code),n(i)},children:t===i?`Copied`:`Copy`})]}),(0,$.jsx)(`pre`,{className:`mono`,children:a.code})]})]},i)})]}):(0,$.jsxs)(`section`,{className:`gtd`,children:[(0,$.jsx)(`h3`,{children:`Get this data`}),(0,$.jsx)(`p`,{className:`muted`,children:`No access route is documented for this sensor yet.`})]})}var Ad={404:`notfound`,422:`bad`,502:`upstream`,503:`busy`,504:`timeout`};async function jd(e,{signal:t,method:n=`GET`,body:r,fetchImpl:i=fetch}={}){let a;try{a=await i(`${y}${e}`,{signal:t,method:n,headers:r?{"Content-Type":`application/json`}:void 0,body:r?JSON.stringify(r):void 0})}catch(e){if(e?.name===`AbortError`)throw e;return{ok:!1,kind:`unreachable`,source:`gateway`,message:`The live data service is not running.`}}let o;try{o=await a.json()}catch{o=null}return a.ok?{ok:!0,data:o}:o?.error?{ok:!1,kind:Ad[a.status]??`upstream`,source:o.error.source,message:o.error.message}:{ok:!1,kind:`unreachable`,source:`gateway`,message:`The live data service is not running.`}}var Md=e=>new URLSearchParams(Object.entries(e).filter(([,e])=>e!=null&&e!==``)).toString(),Nd=(e,t)=>jd(`/status/${encodeURIComponent(e)}`,t),Pd=(e,t)=>jd(`/series/${encodeURIComponent(e)}/variables`,t),Fd=(e,t,n)=>jd(`/series/${encodeURIComponent(e)}?${Md(t)}`,n),Id=(e,t)=>jd(`/plots/${encodeURIComponent(e)}`,t),Ld=(e,t,n,r)=>jd(`/waveform/${e}?${Md({minutes:t,channel:n})}`,r),Rd=(e,t,n,r)=>jd(`/files/${encodeURIComponent(e)}?${Md({endpoint:t,path:n})}`,r),zd=(e,t)=>jd(`/chat`,{...t,method:`POST`,body:{question:e}}),Bd=e=>({key:e,state:e?`loading`:`idle`,data:null,error:null});function Vd(e,t){let[n,r]=(0,g.useState)(()=>Bd(e)),[i,a]=(0,g.useState)(0);(0,g.useEffect)(()=>{if(r(Bd(e)),!e)return;let n=!0,i=new AbortController;return t({signal:i.signal}).then(t=>{n&&r(t.ok?{key:e,state:`ok`,data:t.data,error:null}:{key:e,state:`error`,data:null,error:t})},t=>{n&&t?.name!==`AbortError`&&r({key:e,state:`error`,data:null,error:{kind:`unreachable`,source:`gateway`,message:String(t)}})}),()=>{n=!1,i.abort()}},[e,i]);let o=(0,g.useCallback)(()=>a(e=>e+1),[]),{key:s,...c}=n.key===e?n:Bd(e);return{...c,retry:o}}function Hd({sensor:e,manifest:t}){let n=Vd(e.refdes?`status:${e.refdes}`:null,t=>Nd(e.refdes,t)),r=`${ed(e.status)}${e.statusSource?` · ${e.statusSource}`:``}`;if(!e.refdes||n.state===`idle`)return(0,$.jsx)(`div`,{className:`live-status`,children:r});if(n.state===`loading`)return(0,$.jsxs)(`div`,{className:`live-status`,children:[r,` · checking live…`]});if(n.state===`ok`){let e=n.data,t=!e.evidenceMode||e.evidenceMode===`live`?`checked live`:e.evidenceMode===`snapshot`?`from Nereus snapshot`:`from Nereus (${e.evidenceMode})`;return(0,$.jsxs)(`div`,{className:`live-status`,children:[ed(e.status??`UNKNOWN`),` · `,t,e.data?.checkedAt?`, data ${e.data.code} at ${new Date(e.data.checkedAt).toUTCString().slice(17,22)} UTC`:``]})}return n.error.kind===`unreachable`?(0,$.jsxs)(`div`,{className:`live-status degraded`,children:[(0,$.jsxs)(`span`,{children:[`Live data unavailable. Showing snapshot from `,nd(e.statusAsOf??t?.corpusSnapshot),`.`]}),(0,$.jsx)(`button`,{onClick:n.retry,children:`Retry`})]}):n.error.kind===`notfound`?(0,$.jsxs)(`div`,{className:`live-status`,children:[r,` · `,n.error.source===`Nereus`?`not tracked live by Nereus`:`${n.error.source}: ${n.error.message}`]}):(0,$.jsxs)(`div`,{className:`live-status degraded`,children:[r,` · `,n.error.source,` failed: `,n.error.message,` `,(0,$.jsx)(`button`,{onClick:n.retry,children:`Retry`})]})}function Ud({error:e,retry:t}){return(0,$.jsxs)(`p`,{className:`degraded`,children:[e.kind===`unreachable`?`Live data unavailable: the live data service is not running.`:`${e.source}: ${e.message}`,(0,$.jsx)(`button`,{onClick:t,children:`Retry`})]})}function Wd({route:e}){let[t,n]=(0,g.useState)(``),r=Vd(`files:${e.instrumentKey}:${e.endpointId}:${t}`,n=>Rd(e.instrumentKey,e.endpointId,t,n)),i=t.split(`/`).filter(Boolean).slice(0,-1).join(`/`);return(0,$.jsxs)(`div`,{className:`files`,children:[(0,$.jsxs)(`div`,{className:`mono crumbs`,children:[e.label,` / `,t||``,t&&(0,$.jsx)(`button`,{onClick:()=>n(i?`${i}/`:``),children:`Up`})]}),r.state===`loading`&&(0,$.jsx)(`p`,{className:`muted`,children:`Listing files…`}),r.state===`error`&&(0,$.jsx)(Ud,{error:r.error,retry:r.retry}),r.state===`ok`&&(0,$.jsxs)(`ul`,{children:[r.data.entries.map(e=>(0,$.jsx)(`li`,{children:e.kind===`directory`?(0,$.jsxs)(`button`,{onClick:()=>n(e.path),children:[e.name,`/`]}):(0,$.jsx)(`a`,{href:e.url,target:`_blank`,rel:`noreferrer`,children:e.name})},e.path)),r.data.message?(0,$.jsx)(`li`,{className:`muted`,children:r.data.message}):r.data.truncated&&(0,$.jsx)(`li`,{className:`muted`,children:`Showing the newest 200 entries.`})]})]})}function Gd({refdes:e}){let t=Vd(`plots:${e}`,t=>Id(e,t)),[n,r]=(0,g.useState)(null);if(t.state===`loading`)return(0,$.jsx)(`p`,{className:`muted`,children:`Loading recent plots…`});if(t.state===`error`)return(0,$.jsx)(Ud,{error:t.error,retry:t.retry});let i=[...new Set(t.data.plots.map(e=>e.variable))];if(!i.length)return(0,$.jsx)(`p`,{className:`muted`,children:`The RCA QA/QC site has no recent plots for this sensor.`});let a=n??i[0],o=t.data.plots.filter(e=>e.variable===a).slice(0,4);return(0,$.jsxs)(`div`,{className:`plots`,children:[(0,$.jsx)(`select`,{"aria-label":`Plotted variable`,value:a,onChange:e=>r(e.target.value),children:i.map(e=>(0,$.jsx)(`option`,{children:e},e))}),o.map(e=>(0,$.jsxs)(`figure`,{children:[(0,$.jsx)(`img`,{src:e.url,alt:`${a}, ${e.timeSpan}`,loading:`lazy`}),(0,$.jsxs)(`figcaption`,{children:[e.timeSpan,` · `,e.dataRange]})]},e.url))]})}var Kd=!0,qd=`uplot`,Jd=`u-hz`,Yd=`u-vt`,Xd=`u-title`,Zd=`u-wrap`,Qd=`u-under`,$d=`u-over`,ef=`u-axis`,tf=`u-off`,nf=`u-select`,rf=`u-cursor-x`,af=`u-cursor-y`,of=`u-cursor-pt`,sf=`u-legend`,cf=`u-live`,lf=`u-inline`,uf=`u-series`,df=`u-marker`,ff=`u-label`,pf=`u-value`,mf=`width`,hf=`height`,gf=`top`,_f=`bottom`,vf=`left`,yf=`right`,bf=`#000`,xf=`#0000`,Sf=`mousemove`,Cf=`mousedown`,wf=`mouseup`,Tf=`mouseenter`,Ef=`mouseleave`,Df=`dblclick`,Of=`resize`,kf=`scroll`,Af=`change`,jf=`dppxchange`,Mf=`--`,Nf=typeof window<`u`,Pf=Nf?document:null,Ff=Nf?window:null,If=Nf?navigator:null,Lf,Rf;function zf(){let e=devicePixelRatio;Lf!=e&&(Lf=e,Rf&&ep(Af,Rf,zf),Rf=matchMedia(`(min-resolution: ${Lf-.001}dppx) and (max-resolution: ${Lf+.001}dppx)`),$f(Af,Rf,zf),Ff.dispatchEvent(new CustomEvent(jf)))}function Bf(e,t){if(t!=null){let n=e.classList;!n.contains(t)&&n.add(t)}}function Vf(e,t){let n=e.classList;n.contains(t)&&n.remove(t)}function Hf(e,t,n){e.style[t]=n+`px`}function Uf(e,t,n,r){let i=Pf.createElement(e);return t!=null&&Bf(i,t),n?.insertBefore(i,r),i}function Wf(e,t){return Uf(`div`,e,t)}var Gf=new WeakMap;function Kf(e,t,n,r,i){let a=`translate(`+t+`px,`+n+`px)`;a!=Gf.get(e)&&(e.style.transform=a,Gf.set(e,a),t<0||n<0||t>r||n>i?Bf(e,tf):Vf(e,tf))}var qf=new WeakMap;function Jf(e,t,n){let r=t+n;r!=qf.get(e)&&(qf.set(e,r),e.style.background=t,e.style.borderColor=n)}var Yf=new WeakMap;function Xf(e,t,n,r){let i=t+``+n;i!=Yf.get(e)&&(Yf.set(e,i),e.style.height=n+`px`,e.style.width=t+`px`,e.style.marginLeft=r?-t/2+`px`:0,e.style.marginTop=r?-n/2+`px`:0)}var Zf={passive:!0},Qf={...Zf,capture:!0};function $f(e,t,n,r){t.addEventListener(e,n,r?Qf:Zf)}function ep(e,t,n,r){t.removeEventListener(e,n,Zf)}Nf&&zf();function tp(e,t,n,r){let i;n||=0,r||=t.length-1;let a=r<=2147483647;for(;r-n>1;)i=a?n+r>>1:Cp((n+r)/2),t[i]<e?n=i:r=i;return e-t[n]<=t[r]-e?n:r}function np(e){return(t,n,r)=>{let i=-1,a=-1;for(let a=n;a<=r;a++)if(e(t[a])){i=a;break}for(let i=r;i>=n;i--)if(e(t[i])){a=i;break}return[i,a]}}var rp=e=>e!=null,ip=e=>e!=null&&e>0,ap=np(rp),op=np(ip);function sp(e,t,n,r=0,i=!1){let a=i?op:ap,o=i?ip:rp;[t,n]=a(e,t,n);let s=e[t],c=e[t];if(t>-1){if(r==1)s=e[t],c=e[n];else if(r==-1)s=e[n],c=e[t];else for(let r=t;r<=n;r++){let t=e[r];o(t)&&(t<s?s=t:t>c&&(c=t))}}return[s??Pp,c??-Pp]}function cp(e,t,n,r){let i=kp(e),a=kp(t);e==t&&(i==-1?(e*=n,t/=n):(e/=n,t*=n));let o=n==10?Ap:jp,s=i==1?Cp:Tp,c=a==1?Tp:Cp,l=s(o(Sp(e))),u=c(o(Sp(t))),d=Op(n,l),f=Op(n,u);return n==10&&(l<0&&(d=Xp(d,-l)),u<0&&(f=Xp(f,-u))),r||n==2?(e=d*i,t=f*a):(e=Yp(e,d),t=Jp(t,f)),[e,t]}function lp(e,t,n,r){let i=cp(e,t,n,r);return e==0&&(i[0]=0),t==0&&(i[1]=0),i}var up=.1,dp={mode:3,pad:up},fp={pad:0,soft:null,mode:0},pp={min:fp,max:fp};function mp(e,t,n,r){return sm(n)?_p(e,t,n):(fp.pad=n,fp.soft=r?0:null,fp.mode=r?3:0,_p(e,t,pp))}function hp(e,t){return e??t}function gp(e,t,n){for(t=hp(t,0),n=hp(n,e.length-1);t<=n;){if(e[t]!=null)return!0;t++}return!1}function _p(e,t,n){let r=n.min,i=n.max,a=hp(r.pad,0),o=hp(i.pad,0),s=hp(r.hard,-Pp),c=hp(i.hard,Pp),l=hp(r.soft,Pp),u=hp(i.soft,-Pp),d=hp(r.mode,0),f=hp(i.mode,0),p=t-e,m=Ap(p),h=Dp(Sp(e),Sp(t)),g=Sp(Ap(h)-m);(p<1e-24||g>10)&&(p=0,(e==0||t==0)&&(p=1e-24,d==2&&l!=Pp&&(a=0),f==2&&u!=-Pp&&(o=0)));let _=p||h||1e3,v=Op(10,Cp(Ap(_))),y=Xp(Yp(e-_*(p==0?e==0?.1:1:a),v/10),24),b=e>=l&&(d==1||d==3&&y<=l||d==2&&y>=l)?l:Pp,x=Dp(s,y<b&&e>=b?b:Ep(b,y)),S=Xp(Jp(t+_*(p==0?t==0?.1:1:o),v/10),24),C=t<=u&&(f==1||f==3&&S>=u||f==2&&S<=u)?u:-Pp,w=Ep(c,S>C&&t<=C?C:Dp(C,S));return x==w&&x==0&&(w=100),[x,w]}var vp=new Intl.NumberFormat(Nf?If.language:`en-US`),yp=e=>vp.format(e),bp=Math,xp=bp.PI,Sp=bp.abs,Cp=bp.floor,wp=bp.round,Tp=bp.ceil,Ep=bp.min,Dp=bp.max,Op=bp.pow,kp=bp.sign,Ap=bp.log10,jp=bp.log2,Mp=(e,t=1)=>bp.sinh(e)*t,Np=(e,t=1)=>bp.asinh(e/t),Pp=1/0;function Fp(e){return(Ap((e^e>>31)-(e>>31))|0)+1}function Ip(e,t,n){return Ep(Dp(e,t),n)}function Lp(e){return typeof e==`function`}function Rp(e){return Lp(e)?e:()=>e}var zp=()=>{},Bp=e=>e,Vp=(e,t)=>t,Hp=e=>null,Up=e=>!0,Wp=(e,t)=>e==t,Gp=/\.\d*?(?=9{6,}|0{6,})/gm,Kp=e=>{if(im(e)||Zp.has(e))return e;let t=`${e}`,n=t.match(Gp);if(n==null)return e;let r=n[0].length-1;if(t.indexOf(`e-`)!=-1){let[e,n]=t.split(`e`);return+`${Kp(e)}e${n}`}return Xp(e,r)};function qp(e,t){return Kp(Xp(Kp(e/t))*t)}function Jp(e,t){return Kp(Tp(Kp(e/t))*t)}function Yp(e,t){return Kp(Cp(Kp(e/t))*t)}function Xp(e,t=0){if(im(e))return e;let n=10**t;return wp(e*n*(1+2**-52))/n}var Zp=new Map;function Qp(e){return((``+e).split(`.`)[1]||``).length}function $p(e,t,n,r){let i=[],a=r.map(Qp);for(let o=t;o<n;o++){let t=Sp(o),n=Xp(Op(e,o),t);for(let s=0;s<r.length;s++){let c=e==10?+`${r[s]}e${o}`:r[s]*n,l=(o>=0?0:t)+(o>=a[s]?0:a[s]),u=e==10?c:Xp(c,l);i.push(u),Zp.set(u,l)}}return i}var em={},tm=[],nm=[null,null],rm=Array.isArray,im=Number.isInteger,am=e=>e===void 0;function om(e){return typeof e==`string`}function sm(e){let t=!1;if(e!=null){let n=e.constructor;t=n==null||n==Object}return t}function cm(e){return typeof e==`object`&&!!e}var lm=Object.getPrototypeOf(Uint8Array),um=`__proto__`;function dm(e,t=sm){let n;if(rm(e)){let r=e.find(e=>e!=null);if(rm(r)||t(r)){n=Array(e.length);for(let r=0;r<e.length;r++)n[r]=dm(e[r],t)}else n=e.slice()}else if(e instanceof lm)n=e.slice();else if(t(e)){n={};for(let r in e)r!=um&&(n[r]=dm(e[r],t))}else n=e;return n}function fm(e){let t=arguments;for(let n=1;n<t.length;n++){let r=t[n];for(let t in r)t!=um&&(sm(e[t])?fm(e[t],dm(r[t])):e[t]=dm(r[t]))}return e}var pm=0,mm=1,hm=2;function gm(e,t,n){for(let r=0,i,a=-1;r<t.length;r++){let o=t[r];if(o>a){for(i=o-1;i>=0&&e[i]==null;)e[i--]=null;for(i=o+1;i<n&&e[i]==null;)e[a=i++]=null}}}function _m(e,t){if(bm(e)){let t=e[0].slice();for(let n=1;n<e.length;n++)t.push(...e[n].slice(1));return xm(t[0])||(t=ym(t)),t}let n=new Set;for(let t=0;t<e.length;t++){let r=e[t][0],i=r.length;for(let e=0;e<i;e++)n.add(r[e])}let r=[Array.from(n).sort((e,t)=>e-t)],i=r[0].length,a=new Map;for(let e=0;e<i;e++)a.set(r[0][e],e);for(let n=0;n<e.length;n++){let o=e[n],s=o[0];for(let e=1;e<o.length;e++){let c=o[e],l=Array(i).fill(void 0),u=t?t[n][e]:mm,d=[];for(let e=0;e<c.length;e++){let t=c[e],n=a.get(s[e]);t===null?u!=pm&&(l[n]=t,u==hm&&d.push(n)):l[n]=t}gm(l,d,i),r.push(l)}}return r}var vm=typeof queueMicrotask>`u`?e=>Promise.resolve().then(e):queueMicrotask;function ym(e){let t=e[0],n=t.length,r=Array(n);for(let e=0;e<r.length;e++)r[e]=e;r.sort((e,n)=>t[e]-t[n]);let i=[];for(let t=0;t<e.length;t++){let a=e[t],o=Array(n);for(let e=0;e<n;e++)o[e]=a[r[e]];i.push(o)}return i}function bm(e){let t=e[0][0],n=t.length;for(let r=1;r<e.length;r++){let i=e[r][0];if(i.length!=n)return!1;if(i!=t){for(let e=0;e<n;e++)if(i[e]!=t[e])return!1}}return!0}function xm(e,t=100){let n=e.length;if(n<=1)return!0;let r=0,i=n-1;for(;r<=i&&e[r]==null;)r++;for(;i>=r&&e[i]==null;)i--;if(i<=r)return!0;let a=Dp(1,Cp((i-r+1)/t));for(let t=e[r],n=r+a;n<=i;n+=a){let r=e[n];if(r!=null){if(r<=t)return!1;t=r}}return!0}var Sm=[`January`,`February`,`March`,`April`,`May`,`June`,`July`,`August`,`September`,`October`,`November`,`December`],Cm=[`Sunday`,`Monday`,`Tuesday`,`Wednesday`,`Thursday`,`Friday`,`Saturday`];function wm(e){return e.slice(0,3)}var Tm=Cm.map(wm),Em={MMMM:Sm,MMM:Sm.map(wm),WWWW:Cm,WWW:Tm};function Dm(e){return(e<10?`0`:``)+e}function Om(e){return(e<10?`00`:e<100?`0`:``)+e}var km={YYYY:e=>e.getFullYear(),YY:e=>(e.getFullYear()+``).slice(2),MMMM:(e,t)=>t.MMMM[e.getMonth()],MMM:(e,t)=>t.MMM[e.getMonth()],MM:e=>Dm(e.getMonth()+1),M:e=>e.getMonth()+1,DD:e=>Dm(e.getDate()),D:e=>e.getDate(),WWWW:(e,t)=>t.WWWW[e.getDay()],WWW:(e,t)=>t.WWW[e.getDay()],HH:e=>Dm(e.getHours()),H:e=>e.getHours(),h:e=>{let t=e.getHours();return t==0?12:t>12?t-12:t},AA:e=>e.getHours()>=12?`PM`:`AM`,aa:e=>e.getHours()>=12?`pm`:`am`,a:e=>e.getHours()>=12?`p`:`a`,mm:e=>Dm(e.getMinutes()),m:e=>e.getMinutes(),ss:e=>Dm(e.getSeconds()),s:e=>e.getSeconds(),fff:e=>Om(e.getMilliseconds())};function Am(e,t){t||=Em;let n=[],r=/\{([a-z]+)\}|[^{]+/gi,i;for(;i=r.exec(e);)n.push(i[0][0]==`{`?km[i[1]]:i[0]);return e=>{let r=``;for(let i=0;i<n.length;i++)r+=typeof n[i]==`string`?n[i]:n[i](e,t);return r}}var jm=new Intl.DateTimeFormat().resolvedOptions().timeZone;function Mm(e,t){let n;return t==`UTC`||t==`Etc/UTC`?n=new Date(+e+e.getTimezoneOffset()*6e4):t==jm?n=e:(n=new Date(e.toLocaleString(`en-US`,{timeZone:t})),n.setMilliseconds(e.getMilliseconds())),n}var Nm=e=>e%1==0,Pm=[1,2,2.5,5],Fm=$p(10,-32,0,Pm),Im=$p(10,0,32,Pm),Lm=Im.filter(Nm),Rm=Fm.concat(Im),zm=`
`,Bm=`{YYYY}`,Vm=zm+Bm,Hm=`{M}/{D}`,Um=zm+Hm,Wm=Um+`/{YY}`,Gm=`{aa}`,Km=`{h}:{mm}`+Gm,qm=zm+Km,Jm=`:{ss}`,Ym=null;function Xm(e){let t=e*1e3,n=t*60,r=n*60,i=r*24,a=i*30,o=i*365,s=(e==1?$p(10,0,3,Pm).filter(Nm):$p(10,-3,0,Pm)).concat([t,t*5,t*10,t*15,t*30,n,n*5,n*10,n*15,n*30,r,r*2,r*3,r*4,r*6,r*8,r*12,i,i*2,i*3,i*4,i*5,i*6,i*7,i*8,i*9,i*10,i*15,a,a*2,a*3,a*4,a*6,o,o*2,o*5,o*10,o*25,o*50,o*100]),c=[[o,Bm,Ym,Ym,Ym,Ym,Ym,Ym,1],[i*28,`{MMM}`,Vm,Ym,Ym,Ym,Ym,Ym,1],[i,Hm,Vm,Ym,Ym,Ym,Ym,Ym,1],[r,`{h}`+Gm,Wm,Ym,Um,Ym,Ym,Ym,1],[n,Km,Wm,Ym,Um,Ym,Ym,Ym,1],[t,Jm,Wm+` `+Km,Ym,Um+` `+Km,Ym,qm,Ym,1],[e,Jm+`.{fff}`,Wm+` `+Km,Ym,Um+` `+Km,Ym,qm,Ym,1]];function l(t){return(s,c,l,u,d,f)=>{let p=[],m=d>=o,h=d>=a&&d<o,g=t(l),_=Xp(g*e,3),v=oh(g.getFullYear(),m?0:g.getMonth(),h||m?1:g.getDate()),y=Xp(v*e,3);if(h||m){let n=h?d/a:0,r=m?d/o:0,i=_==y?_:Xp(oh(v.getFullYear()+r,v.getMonth()+n,1)*e,3),s=new Date(wp(i/e)),c=s.getFullYear(),l=s.getMonth();for(let a=0;i<=u;a++){let o=oh(c+r*a,l+n*a,1),s=o-t(Xp(o*e,3));i=Xp((+o+s)*e,3),i<=u&&p.push(i)}}else{let a=d>=i?i:d,o=y+(Cp(l)-Cp(_))+Jp(_-y,a);p.push(o);let m=t(o),h=m.getHours()+m.getMinutes()/n+m.getSeconds()/r,g=d/r,v=f/s.axes[c]._space;for(;o=Xp(o+d,e==1?0:3),!(o>u);)if(g>1){let e=Cp(Xp(h+g,6))%24,n=t(o).getHours()-e;n>1&&(n=-1),o-=n*r,h=(h+g)%24;let i=p[p.length-1];Xp((o-i)/d,3)*v>=.7&&p.push(o)}else p.push(o)}return p}}return[s,c,l]}var[Zm,Qm,$m]=Xm(1),[eh,th,nh]=Xm(.001);$p(2,-53,53,[1]);function rh(e,t){return e.map(e=>e.map((n,r)=>r==0||r==8||n==null?n:t(r==1||e[8]==0?n:e[1]+n)))}function ih(e,t){return(n,r,i,a,o)=>{let s=t.find(e=>o>=e[0])||t[t.length-1],c,l,u,d,f,p;return r.map(t=>{let n=e(t),r=n.getFullYear(),i=n.getMonth(),a=n.getDate(),o=n.getHours(),m=n.getMinutes(),h=n.getSeconds(),g=r!=c&&s[2]||i!=l&&s[3]||a!=u&&s[4]||o!=d&&s[5]||m!=f&&s[6]||h!=p&&s[7]||s[1];return c=r,l=i,u=a,d=o,f=m,p=h,g(n)})}}function ah(e,t){let n=Am(t);return(t,r,i,a,o)=>r.map(t=>n(e(t)))}function oh(e,t,n){return new Date(e,t,n)}function sh(e,t){return t(e)}var ch=`{YYYY}-{MM}-{DD} {h}:{mm}{aa}`;function lh(e,t){return(n,r,i,a)=>a==null?Mf:t(e(r))}function uh(e,t){let n=e.series[t];return n.width?n.stroke(e,t):n.points.width?n.points.stroke(e,t):null}function dh(e,t){return e.series[t].fill(e,t)}var fh={show:!0,live:!0,isolate:!1,mount:zp,markers:{show:!0,width:2,stroke:uh,fill:dh,dash:`solid`},idx:null,idxs:null,values:[]};function ph(e,t){let n=e.cursor.points,r=Wf(),i=n.size(e,t);Hf(r,mf,i),Hf(r,hf,i);let a=i/-2;Hf(r,`marginLeft`,a),Hf(r,`marginTop`,a);let o=n.width(e,t,i);return o&&Hf(r,`borderWidth`,o),r}function mh(e,t){let n=e.series[t].points;return n._fill||n._stroke}function hh(e,t){let n=e.series[t].points;return n._stroke||n._fill}function gh(e,t){return e.series[t].points.size}var _h=[0,0];function vh(e,t,n){return _h[0]=t,_h[1]=n,_h}function yh(e,t,n,r=!0){return e=>{e.button==0&&(!r||e.target==t)&&n(e)}}function bh(e,t,n,r=!0){return e=>{(!r||e.target==t)&&n(e)}}var xh={show:!0,x:!0,y:!0,lock:!1,move:vh,points:{one:!1,show:ph,size:gh,width:0,stroke:hh,fill:mh},bind:{mousedown:yh,mouseup:yh,click:yh,dblclick:yh,mousemove:bh,mouseleave:bh,mouseenter:bh},drag:{setScale:!0,x:!0,y:!1,dist:0,uni:null,click:(e,t)=>{t.stopPropagation(),t.stopImmediatePropagation()},_x:!1,_y:!1},focus:{dist:(e,t,n,r,i)=>r-i,prox:-1,bias:0},hover:{skip:[void 0],prox:null,bias:0},left:-10,top:-10,idx:null,dataIdx:null,idxs:null,event:null},Sh={show:!0,stroke:`rgba(0,0,0,0.07)`,width:2},Ch=fm({},Sh,{filter:Vp}),wh=fm({},Ch,{size:10}),Th=fm({},Sh,{show:!1}),Eh=`12px system-ui, -apple-system, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji"`,Dh=`bold `+Eh,Oh=1.5,kh={show:!0,scale:`x`,stroke:bf,space:50,gap:5,alignTo:1,size:50,labelGap:0,labelSize:30,labelFont:Dh,side:2,grid:Ch,ticks:wh,border:Th,font:Eh,lineGap:Oh,rotate:0},Ah=`Value`,jh=`Time`,Mh={show:!0,scale:`x`,auto:!1,sorted:1,min:Pp,max:-1/0,idxs:[]};function Nh(e,t,n,r,i){return t.map(e=>e==null?``:yp(e))}function Ph(e,t,n,r,i,a,o){let s=[],c=Zp.get(i)||0;n=o?n:Xp(Jp(n,i),c);for(let e=n;e<=r;e=Xp(e+i,c))s.push(Object.is(e,-0)?0:e);return s}function Fh(e,t,n,r,i,a,o){let s=[],c=e.scales[e.axes[t].scale].log;i=Op(c,Cp((c==10?Ap:jp)(n))),c==10&&(i=Rm[tp(i,Rm)]);let l=n,u=i*c;c==10&&(u=Rm[tp(u,Rm)]);do s.push(l),l+=i,c==10&&!Zp.has(l)&&(l=Xp(l,Zp.get(i))),l>=u&&(i=l,u=i*c,c==10&&(u=Rm[tp(u,Rm)]));while(l<=r);return s}function Ih(e,t,n,r,i,a,o){let s=e.scales[e.axes[t].scale].asinh,c=r>s?Fh(e,t,Dp(s,n),r,i):[s],l=r>=0&&n<=0?[0]:[];return(n<-s?Fh(e,t,Dp(s,-r),-n,i):[s]).reverse().map(e=>-e).concat(l,c)}var Lh=/./,Rh=/[12357]/,zh=/[125]/,Bh=/1/,Vh=(e,t,n,r)=>e.map((e,i)=>t==4&&e==0||i%r==0&&n.test(e.toExponential()[+(e<0)])?e:null);function Hh(e,t,n,r,i){let a=e.axes[n],o=a.scale,s=e.scales[o],c=e.valToPos,l=a._space,u=c(10,o),d=c(9,o)-u>=l?Lh:c(7,o)-u>=l?Rh:c(5,o)-u>=l?zh:Bh;if(d==Bh){let e=Sp(c(1,o)-u);if(e<l)return Vh(t.slice().reverse(),s.distr,d,Tp(l/e)).reverse()}return Vh(t,s.distr,d,1)}function Uh(e,t,n,r,i){let a=e.axes[n],o=a.scale,s=a._space,c=e.valToPos,l=Sp(c(1,o)-c(2,o));return l<s?Vh(t.slice().reverse(),3,Lh,Tp(s/l)).reverse():t}function Wh(e,t,n,r){return r==null?Mf:t==null?``:yp(t)}var Gh={show:!0,scale:`y`,stroke:bf,space:30,gap:5,alignTo:1,size:50,labelGap:0,labelSize:30,labelFont:Dh,side:3,grid:Ch,ticks:wh,border:Th,font:Eh,lineGap:Oh,rotate:0};function Kh(e,t){return Xp((3+(e||1)*2)*t,3)}function qh(e,t){let{scale:n,idxs:r}=e.series[0],i=e._data[0],a=e.valToPos(i[r[0]],n,!0),o=Sp(e.valToPos(i[r[1]],n,!0)-a)/(e.series[t].points.space*Lf);return r[1]-r[0]<=o}var Jh={scale:null,auto:!0,sorted:0,min:Pp,max:-1/0},Yh=(e,t,n,r,i)=>i,Xh={show:!0,auto:!0,sorted:0,gaps:Yh,alpha:1,facets:[fm({},Jh,{scale:`x`}),fm({},Jh,{scale:`y`})]},Zh={scale:`y`,auto:!0,sorted:0,show:!0,spanGaps:!1,gaps:Yh,alpha:1,points:{show:qh,filter:null},values:null,min:Pp,max:-1/0,idxs:[],path:null,clip:null};function Qh(e,t,n,r,i){return n/10}var $h={time:Kd,auto:!0,distr:1,log:10,asinh:1,min:null,max:null,dir:1,ori:0},eg=fm({},$h,{time:!1,ori:1}),tg={};function ng(e,t){let n=tg[e];return n||(n={key:e,plots:[],sub(e){n.plots.push(e)},unsub(e){n.plots=n.plots.filter(t=>t!=e)},pub(e,t,r,i,a,o,s){for(let c=0;c<n.plots.length;c++)n.plots[c]!=t&&n.plots[c].pub(e,t,r,i,a,o,s)}},e!=null&&(tg[e]=n)),n}var rg=1,ig=2;function ag(e,t,n){let r=e.mode,i=e.series[t],a=r==2?e._data[t]:e._data,o=e.scales,s=e.bbox,c=a[0],l=r==2?a[1]:a[t],u=r==2?o[i.facets[0].scale]:o[e.series[0].scale],d=r==2?o[i.facets[1].scale]:o[i.scale],f=s.left,p=s.top,m=s.width,h=s.height,g=e.valToPosH,_=e.valToPosV;return u.ori==0?n(i,c,l,u,d,g,_,f,p,m,h,mg,gg,vg,bg,Sg):n(i,c,l,u,d,_,g,p,f,h,m,hg,_g,yg,xg,Cg)}function og(e,t){let n=0,r=0,i=hp(e.bands,tm);for(let e=0;e<i.length;e++){let a=i[e];a.series[0]==t?n=a.dir:a.series[1]==t&&(a.dir==1?r|=1:r|=2)}return[n,r==1?-1:r==2?1:r==3?2:0]}function sg(e,t,n,r,i){let a=e.mode,o=e.series[t],s=a==2?o.facets[1].scale:o.scale,c=e.scales[s];return i==-1?c.min:i==1?c.max:c.distr==3?c.dir==1?c.min:c.max:0}function cg(e,t,n,r,i,a){return ag(e,t,(e,t,o,s,c,l,u,d,f,p,m)=>{let h=e.pxRound,g=s.dir*(s.ori==0?1:-1),_=s.ori==0?gg:_g,v,y;g==1?(v=n,y=r):(v=r,y=n);let b=h(l(t[v],s,p,d)),x=h(u(o[v],c,m,f)),S=h(l(t[y],s,p,d)),C=h(u(a==1?c.max:c.min,c,m,f)),w=new Path2D(i);return _(w,S,C),_(w,b,C),_(w,b,x),w})}function lg(e,t,n,r,i,a){let o=null;if(e.length>0){o=new Path2D;let s=t==0?vg:yg,c=n;for(let t=0;t<e.length;t++){let n=e[t];if(n[1]>n[0]){let e=n[0]-c;e>0&&s(o,c,r,e,r+a),c=n[1]}}let l=n+i-c;l>0&&s(o,c,r-5,l,r+a+10)}return o}function ug(e,t,n){let r=e[e.length-1];r&&r[0]==t?r[1]=n:e.push([t,n])}function dg(e,t,n,r,i,a,o){let s=[],c=e.length;for(let l=i==1?n:r;l>=n&&l<=r;l+=i)if(t[l]===null){let u=l,d=l;if(i==1)for(;++l<=r&&t[l]===null;)d=l;else for(;--l>=n&&t[l]===null;)d=l;let f=a(e[u]),p=d==u?f:a(e[d]),m=u-i;f=o<=0&&m>=0&&m<c?a(e[m]):f;let h=d+i;p=o>=0&&h>=0&&h<c?a(e[h]):p,p>=f&&s.push([f,p])}return s}function fg(e){return e==0?Bp:e==1?wp:t=>qp(t,e)}function pg(e){let t=e==0?mg:hg,n=e==0?(e,t,n,r,i,a)=>{e.arcTo(t,n,r,i,a)}:(e,t,n,r,i,a)=>{e.arcTo(n,t,i,r,a)},r=e==0?(e,t,n,r,i)=>{e.rect(t,n,r,i)}:(e,t,n,r,i)=>{e.rect(n,t,i,r)};return(e,i,a,o,s,c=0,l=0)=>{c==0&&l==0?r(e,i,a,o,s):(c=Ep(c,o/2,s/2),l=Ep(l,o/2,s/2),t(e,i+c,a),n(e,i+o,a,i+o,a+s,c),n(e,i+o,a+s,i,a+s,l),n(e,i,a+s,i,a,l),n(e,i,a,i+o,a,c),e.closePath())}}var mg=(e,t,n)=>{e.moveTo(t,n)},hg=(e,t,n)=>{e.moveTo(n,t)},gg=(e,t,n)=>{e.lineTo(t,n)},_g=(e,t,n)=>{e.lineTo(n,t)},vg=pg(0),yg=pg(1),bg=(e,t,n,r,i,a)=>{e.arc(t,n,r,i,a)},xg=(e,t,n,r,i,a)=>{e.arc(n,t,r,i,a)},Sg=(e,t,n,r,i,a,o)=>{e.bezierCurveTo(t,n,r,i,a,o)},Cg=(e,t,n,r,i,a,o)=>{e.bezierCurveTo(n,t,i,r,o,a)};function wg(e){return(e,t,n,r,i)=>ag(e,t,(t,a,o,s,c,l,u,d,f,p,m)=>{let{pxRound:h,points:g}=t,_,v;s.ori==0?(_=mg,v=bg):(_=hg,v=xg);let y=Xp(g.width*Lf,3),b=(g.size-g.width)/2*Lf,x=Xp(b*2,3),S=new Path2D,C=new Path2D,{left:w,top:T,width:E,height:D}=e.bbox;vg(C,w-x,T-x,E+x*2,D+x*2);let O=e=>{if(o[e]!=null){let t=h(l(a[e],s,p,d)),n=h(u(o[e],c,m,f));_(S,t+b,n),v(S,t,n,b,0,xp*2)}};if(i)i.forEach(O);else for(let e=n;e<=r;e++)O(e);return{stroke:y>0?S:null,fill:S,clip:C,flags:3}})}function Tg(e){return(t,n,r,i,a,o)=>{r!=i&&(a!=r&&o!=r&&e(t,n,r),a!=i&&o!=i&&e(t,n,i),e(t,n,o))}}var Eg=Tg(gg),Dg=Tg(_g);function Og(e){let t=hp(e?.alignGaps,0);return(e,n,r,i)=>ag(e,n,(a,o,s,c,l,u,d,f,p,m,h)=>{[r,i]=ap(s,r,i);let g=a.pxRound,_=e=>g(u(e,c,m,f)),v=e=>g(d(e,l,h,p)),y,b;c.ori==0?(y=gg,b=Eg):(y=_g,b=Dg);let x=c.dir*(c.ori==0?1:-1),S={stroke:new Path2D,fill:null,clip:null,band:null,gaps:null,flags:rg},C=S.stroke,w=!1;if(i-r>=m*4){let t=t=>e.posToVal(t,c.key,!0),n=null,a=null,l,u,d,f=_(o[x==1?r:i]),p=_(o[r]),m=_(o[i]),h=t(x==1?p+1:m-1);for(let e=x==1?r:i;e>=r&&e<=i;e+=x){let r=o[e],i=(x==1?r<h:r>h)?f:_(r),c=s[e];i==f?c==null?c===null&&(w=!0):(u=c,n==null?(y(C,i,v(u)),l=n=a=u):u<n?n=u:u>a&&(a=u)):(n!=null&&b(C,f,v(n),v(a),v(l),v(u)),c==null?(n=a=null,c===null&&(w=!0)):(u=c,y(C,i,v(u)),n=a=l=u),f=i,h=t(f+x))}n!=null&&n!=a&&d!=f&&b(C,f,v(n),v(a),v(l),v(u))}else for(let e=x==1?r:i;e>=r&&e<=i;e+=x){let t=s[e];t===null?w=!0:t!=null&&y(C,_(o[e]),v(t))}let[T,E]=og(e,n);if(a.fill!=null||T!=0){let t=S.fill=new Path2D(C),s=v(a.fillTo(e,n,a.min,a.max,T)),c=_(o[r]),l=_(o[i]);x==-1&&([l,c]=[c,l]),y(t,l,s),y(t,c,s)}if(!a.spanGaps){let l=[];w&&l.push(...dg(o,s,r,i,x,_,t)),S.gaps=l=a.gaps(e,n,r,i,l),S.clip=lg(l,c.ori,f,p,m,h)}return E!=0&&(S.band=E==2?[cg(e,n,r,i,C,-1),cg(e,n,r,i,C,1)]:cg(e,n,r,i,C,E)),S})}function kg(e){let t=hp(e.align,1),n=hp(e.ascDesc,!1),r=hp(e.alignGaps,0),i=hp(e.extend,!1);return(e,a,o,s)=>ag(e,a,(c,l,u,d,f,p,m,h,g,_,v)=>{[o,s]=ap(u,o,s);let y=c.pxRound,{left:b,width:x}=e.bbox,S=e=>y(p(e,d,_,h)),C=e=>y(m(e,f,v,g)),w=d.ori==0?gg:_g,T={stroke:new Path2D,fill:null,clip:null,band:null,gaps:null,flags:rg},E=T.stroke,D=d.dir*(d.ori==0?1:-1),O=C(u[D==1?o:s]),k=S(l[D==1?o:s]),A=k,j=k;i&&t==-1&&(j=b,w(E,j,O)),w(E,k,O);for(let e=D==1?o:s;e>=o&&e<=s;e+=D){let n=u[e];if(n==null)continue;let r=S(l[e]),i=C(n);t==1?w(E,r,O):w(E,A,i),w(E,r,i),O=i,A=r}let M=A;i&&t==1&&(M=b+x,w(E,M,O));let[ee,N]=og(e,a);if(c.fill!=null||ee!=0){let t=T.fill=new Path2D(E),n=C(c.fillTo(e,a,c.min,c.max,ee));w(t,M,n),w(t,j,n)}if(!c.spanGaps){let i=[];i.push(...dg(l,u,o,s,D,S,r));let f=c.width*Lf/2,p=n||t==1?f:-f,m=n||t==-1?-f:f;i.forEach(e=>{e[0]+=p,e[1]+=m}),T.gaps=i=c.gaps(e,a,o,s,i),T.clip=lg(i,d.ori,h,g,_,v)}return N!=0&&(T.band=N==2?[cg(e,a,o,s,E,-1),cg(e,a,o,s,E,1)]:cg(e,a,o,s,E,N)),T})}function Ag(e,t,n,r,i,a,o=Pp){if(e.length>1){let s=null;for(let c=0,l=1/0;c<e.length;c++)if(t[c]!==void 0){if(s!=null){let t=Sp(e[c]-e[s]);t<l&&(l=t,o=Sp(n(e[c],r,i,a)-n(e[s],r,i,a)))}s=c}}return o}function jg(e){e||=em;let t=hp(e.size,[.6,Pp,1]),n=e.align||0,r=e.gap||0,i=e.radius;i=i==null?[0,0]:typeof i==`number`?[i,0]:i;let a=Rp(i),o=1-t[0],s=hp(t[1],Pp),c=hp(t[2],1),l=hp(e.disp,em),u=hp(e.each,e=>{}),{fill:d,stroke:f}=l;return(e,t,i,p)=>ag(e,t,(m,h,g,_,v,y,b,x,S,C,w)=>{let T=m.pxRound,E=n,D=r*Lf,O=s*Lf,k=c*Lf,A,j;_.ori==0?[A,j]=a(e,t):[j,A]=a(e,t);let M=_.dir*(_.ori==0?1:-1),ee=_.ori==0?vg:yg,N=_.ori==0?u:(e,t,n,r,i,a,o)=>{u(e,t,n,i,r,o,a)},te=hp(e.bands,tm).find(e=>e.series[0]==t),ne=te==null?0:te.dir,re=m.fillTo(e,t,m.min,m.max,ne),P=T(b(re,v,w,S)),F,ie,I,L=C,R=T(m.width*Lf),ae=!1,oe=null,se=null,ce=null,le=null;d!=null&&(R==0||f!=null)&&(ae=!0,oe=d.values(e,t,i,p),se=new Map,new Set(oe).forEach(e=>{e!=null&&se.set(e,new Path2D)}),R>0&&(ce=f.values(e,t,i,p),le=new Map,new Set(ce).forEach(e=>{e!=null&&le.set(e,new Path2D)})));let{x0:ue,size:de}=l;if(ue!=null&&de!=null){E=1,h=ue.values(e,t,i,p),ue.unit==2&&(h=h.map(t=>e.posToVal(x+t*C,_.key,!0)));let n=de.values(e,t,i,p);ie=de.unit==2?n[0]*C:y(n[0],_,C,x)-y(0,_,C,x),L=Ag(h,g,y,_,C,x,L),I=L-ie+D}else L=Ag(h,g,y,_,C,x,L),I=L*o+D,ie=L-I;I<1&&(I=0),R>=ie/2&&(R=0),I<5&&(T=Bp);let z=I>0,fe=L-I-(z?R:0);ie=T(Ip(fe,k,O)),F=(E==0?ie/2:E==M?0:ie)-E*M*((E==0?D/2:0)+(z?R/2:0));let pe={stroke:null,fill:null,clip:null,band:null,gaps:null,flags:0},me=ae?null:new Path2D,B=null;if(te!=null)B=e.data[te.series[1]];else{let{y0:n,y1:r}=l;n!=null&&r!=null&&(g=r.values(e,t,i,p),B=n.values(e,t,i,p))}let he=A*ie,V=j*ie;for(let n=M==1?i:p;n>=i&&n<=p;n+=M){let r=g[n];if(r==null)continue;if(B!=null){let e=B[n]??0;if(r-e==0)continue;P=b(e,v,w,S)}let i=y(_.distr!=2||l!=null?h[n]:n,_,C,x),a=b(hp(r,re),v,w,S),o=T(i-F),s=T(Dp(a,P)),c=T(Ep(a,P)),u=s-c;if(r!=null){let i=r<0?V:he,a=r<0?he:V;ae?(R>0&&ce[n]!=null&&ee(le.get(ce[n]),o,c+Cp(R/2),ie,Dp(0,u-R),i,a),oe[n]!=null&&ee(se.get(oe[n]),o,c+Cp(R/2),ie,Dp(0,u-R),i,a)):ee(me,o,c+Cp(R/2),ie,Dp(0,u-R),i,a),N(e,t,n,o-R/2,c,ie+R,u)}}return R>0?pe.stroke=ae?le:me:ae||(pe._fill=m.width==0?m._fill:m._stroke??m._fill,pe.width=0),pe.fill=ae?se:me,pe})}function Mg(e,t){let n=hp(t?.alignGaps,0);return(t,r,i,a)=>ag(t,r,(o,s,c,l,u,d,f,p,m,h,g)=>{[i,a]=ap(c,i,a);let _=o.pxRound,v=e=>_(d(e,l,h,p)),y=e=>_(f(e,u,g,m)),b,x,S;l.ori==0?(b=mg,S=gg,x=Sg):(b=hg,S=_g,x=Cg);let C=l.dir*(l.ori==0?1:-1),w=v(s[C==1?i:a]),T=w,E=[],D=[];for(let e=C==1?i:a;e>=i&&e<=a;e+=C)if(c[e]!=null){let t=s[e],n=v(t);E.push(T=n),D.push(y(c[e]))}let O={stroke:e(E,D,b,S,x,_),fill:null,clip:null,band:null,gaps:null,flags:rg},k=O.stroke,[A,j]=og(t,r);if(o.fill!=null||A!=0){let e=O.fill=new Path2D(k),n=y(o.fillTo(t,r,o.min,o.max,A));S(e,T,n),S(e,w,n)}if(!o.spanGaps){let e=[];e.push(...dg(s,c,i,a,C,v,n)),O.gaps=e=o.gaps(t,r,i,a,e),O.clip=lg(e,l.ori,p,m,h,g)}return j!=0&&(O.band=j==2?[cg(t,r,i,a,k,-1),cg(t,r,i,a,k,1)]:cg(t,r,i,a,k,j)),O})}function Ng(e){return Mg(Pg,e)}function Pg(e,t,n,r,i,a){let o=e.length;if(o<2)return null;let s=new Path2D;if(n(s,e[0],t[0]),o==2)r(s,e[1],t[1]);else{let n=Array(o),r=Array(o-1),a=Array(o-1),c=Array(o-1);for(let n=0;n<o-1;n++)a[n]=t[n+1]-t[n],c[n]=e[n+1]-e[n],r[n]=a[n]/c[n];n[0]=r[0];for(let e=1;e<o-1;e++)r[e]===0||r[e-1]===0||r[e-1]>0!=r[e]>0?n[e]=0:(n[e]=3*(c[e-1]+c[e])/((2*c[e]+c[e-1])/r[e-1]+(c[e]+2*c[e-1])/r[e]),isFinite(n[e])||(n[e]=0));n[o-1]=r[o-2];for(let r=0;r<o-1;r++)i(s,e[r]+c[r]/3,t[r]+n[r]*c[r]/3,e[r+1]-c[r]/3,t[r+1]-n[r+1]*c[r]/3,e[r+1],t[r+1])}return s}var Fg=new Set;function Ig(){for(let e of Fg)e.syncRect(!0)}Nf&&($f(Of,Ff,Ig),$f(kf,Ff,Ig,!0),$f(jf,Ff,()=>{Qg.pxRatio=Lf}));var Lg=Og(),Rg=wg();function zg(e,t,n,r){return(r?[e[0],e[1]].concat(e.slice(2)):[e[0]].concat(e.slice(1))).map((e,r)=>Vg(e,r,t,n))}function Bg(e,t){return e.map((e,n)=>n==0?{}:fm({},t,e))}function Vg(e,t,n,r){return fm({},t==0?n:r,e)}function Hg(e,t,n){return t==null?nm:[t,n]}var Ug=Hg;function Wg(e,t,n){return t==null?nm:mp(t,n,up,!0)}function Gg(e,t,n,r){return t==null?nm:cp(t,n,e.scales[r].log,!1)}var Kg=Gg;function qg(e,t,n,r){return t==null?nm:lp(t,n,e.scales[r].log,!1)}var Jg=qg;function Yg(e,t,n,r,i){let a=Dp(Fp(e),Fp(t)),o=t-e,s=tp(i/r*o,n);do{let e=n[s],t=r*e/o;if(t>=i&&a+(e<5?Zp.get(e):0)<=17)return[e,t]}while(++s<n.length);return[0,0]}function Xg(e){let t,n;return e=e.replace(/(\d+)px/,(e,r)=>(t=wp((n=+r)*Lf))+`px`),[e,t,n]}function Zg(e){e.show&&[e.font,e.labelFont].forEach(e=>{let t=Xp(e[2]*Lf,1);e[0]=e[0].replace(/[0-9.]+px/,t+`px`),e[1]=t})}function Qg(e,t,n){let r={mode:hp(e.mode,1)},i=r.mode;function a(e,t,n,r){let i=t.valToPct(e);return r+n*(t.dir==-1?1-i:i)}function o(e,t,n,r){let i=t.valToPct(e);return r+n*(t.dir==-1?i:1-i)}function s(e,t,n,r){return t.ori==0?a(e,t,n,r):o(e,t,n,r)}r.valToPosH=a,r.valToPosV=o;let c=!1;r.status=0;let l=r.root=Wf(qd);if(e.id!=null&&(l.id=e.id),Bf(l,e.class),e.title){let t=Wf(Xd,l);t.textContent=e.title}let u=Uf(`canvas`),d=r.ctx=u.getContext(`2d`),f=Wf(Zd,l);$f(`click`,f,e=>{e.target===m&&(en!=Xt||tn!=Zt)&&rn.click(r,e)},!0);let p=r.under=Wf(Qd,f);f.appendChild(u);let m=r.over=Wf($d,f);e=dm(e);let h=+hp(e.pxAlign,1),g=fg(h);(e.plugins||[]).forEach(t=>{t.opts&&(e=t.opts(r,e)||e)});let _=e.ms||.001,v=r.series=i==1?zg(e.series||[],Mh,Zh,!1):Bg(e.series||[null],Xh),y=r.axes=zg(e.axes||[],kh,Gh,!0),b=r.scales={},x=r.bands=e.bands||[];x.forEach(e=>{e.fill=Rp(e.fill||null),e.dir=hp(e.dir,-1)});let S=i==2?v[1].facets[0].scale:v[0].scale,C={axes:It,series:Tt},w=(e.drawOrder||[`axes`,`series`]).map(e=>C[e]);function T(e){let t=e.distr==3?t=>Ap(t>0?t:e.clamp(r,t,e.min,e.max,e.key)):e.distr==4?t=>Np(t,e.asinh):e.distr==100?t=>e.fwd(t):e=>e;return n=>{let r=t(n),{_min:i,_max:a}=e,o=a-i;return(r-i)/o}}function E(t){let n=b[t];if(n==null){let r=(e.scales||em)[t]||em;if(r.from!=null){E(r.from);let e=fm({},b[r.from],r,{key:t});e.valToPct=T(e),b[t]=e}else{n=b[t]=fm({},t==S?$h:eg,r),n.key=t;let e=n.time,a=n.range,o=rm(a);if((t!=S||i==2&&!e)&&(o&&(a[0]==null||a[1]==null)&&(a={min:a[0]==null?dp:{mode:1,hard:a[0],soft:a[0]},max:a[1]==null?dp:{mode:1,hard:a[1],soft:a[1]}},o=!1),!o&&sm(a))){let e=a;a=(t,n,r)=>n==null?nm:mp(n,r,e)}n.range=Rp(a||(e?Ug:t==S?n.distr==3?Kg:n.distr==4?Jg:Hg:n.distr==3?Gg:n.distr==4?qg:Wg)),n.auto=Rp(!o&&n.auto),n.clamp=Rp(n.clamp||Qh),n._min=n._max=null,n.valToPct=T(n)}}}E(`x`),E(`y`),i==1&&v.forEach(e=>{E(e.scale)}),y.forEach(e=>{E(e.scale)});for(let t in e.scales)E(t);let D=b[S],O=D.distr,k,A;D.ori==0?(Bf(l,Jd),k=a,A=o):(Bf(l,Yd),k=o,A=a);let j={};for(let e in b){let t=b[e];(t.min!=null||t.max!=null)&&(j[e]={min:t.min,max:t.max},t.min=t.max=null)}let M=e.tzDate||(e=>new Date(wp(e/_))),ee=e.fmtDate||Am,N=_==1?$m(M):nh(M),te=ih(M,rh(_==1?Qm:th,ee)),ne=lh(M,sh(ch,ee)),re=[],P=r.legend=fm({},fh,e.legend),F=r.cursor=fm({},xh,{drag:{y:i==2}},e.cursor),ie=P.show,I=F.show,L=P.markers;P.idxs=re,L.width=Rp(L.width),L.dash=Rp(L.dash),L.stroke=Rp(L.stroke),L.fill=Rp(L.fill);let R,ae,oe,se=[],ce=[],le,ue=!1,de={};if(P.live){let e=v[1]?v[1].values:null;ue=e!=null,le=ue?e(r,1,0):{_:0};for(let e in le)de[e]=Mf}if(ie){if(R=Uf(`table`,sf,l),oe=Uf(`tbody`,null,R),P.mount(r,R),ue){ae=Uf(`thead`,null,R,oe);let e=Uf(`tr`,null,ae);for(var z in Uf(`th`,null,e),le)Uf(`th`,ff,e).textContent=z}else Bf(R,lf),P.live&&Bf(R,cf)}let fe={show:!0},pe={show:!1};function me(e,t){if(t==0&&(ue||!P.live||i==2))return nm;let n=[],a=Uf(`tr`,uf,oe,oe.childNodes[t]);Bf(a,e.class),e.show||Bf(a,tf);let o=Uf(`th`,null,a);if(L.show){let e=Wf(df,o);if(t>0){let n=L.width(r,t);n&&(e.style.border=n+`px `+L.dash(r,t)+` `+L.stroke(r,t)),e.style.background=L.fill(r,t)}}let s=Wf(ff,o);for(var c in e.label instanceof HTMLElement?s.appendChild(e.label):s.textContent=e.label,t>0&&(L.show||(s.style.color=e.width>0?L.stroke(r,t):L.fill(r,t)),he(`click`,o,t=>{if(F._lock)return;ze(t);let n=v.indexOf(e);if((t.ctrlKey||t.metaKey)!=P.isolate){let e=v.some((e,t)=>t>0&&t!=n&&e.show);v.forEach((t,r)=>{r>0&&dn(r,e?r==n?fe:pe:fe,!0,Yn.setSeries)})}else dn(n,{show:!e.show},!0,Yn.setSeries)},!1),He&&he(Tf,o,t=>{F._lock||(ze(t),dn(v.indexOf(e),vn,!0,Yn.setSeries))},!1)),le){let e=Uf(`td`,pf,a);e.textContent=`--`,n.push(e)}return[a,n]}let B=new Map;function he(e,t,n,i=!0){let a=B.get(t)||{},o=F.bind[e](r,t,n,i);o&&($f(e,t,a[e]=o),B.set(t,a))}function V(e,t,n){let r=B.get(t)||{};for(let n in r)(e==null||n==e)&&(ep(n,t,r[n]),delete r[n]);e??B.delete(t)}let H=0,ge=0,U=0,W=0,_e=0,ve=0,ye=_e,be=ve,xe=U,Se=W,Ce=0,we=0,Te=0,Ee=0;r.bbox={};let De=!1,Oe=!1,ke=!1,Ae=!1,je=!1,Me=!1;function Ne(e,t,n){(n||e!=r.width||t!=r.height)&&Pe(e,t),K(!1),ke=!0,Oe=!0,Bt()}function Pe(e,t){r.width=H=U=e,r.height=ge=W=t,_e=ve=0,Le(),Re();let n=r.bbox;Ce=n.left=qp(_e*Lf,.5),we=n.top=qp(ve*Lf,.5),Te=n.width=qp(U*Lf,.5),Ee=n.height=qp(W*Lf,.5)}function Fe(){let e=!1,t=0;for(;!e;){t++;let n=Pt(t),i=Ft(t);e=t==3||n&&i,e||(Pe(r.width,r.height),Oe=!0)}}function Ie({width:e,height:t}){Ne(e,t)}r.setSize=Ie;function Le(){let e=!1,t=!1,n=!1,r=!1;y.forEach((i,a)=>{if(i.show&&i._show){let{side:a,_size:o}=i,s=a%2,c=o+(i.label==null?0:i.labelSize);c>0&&(s?(U-=c,a==3?(_e+=c,r=!0):n=!0):(W-=c,a==0?(ve+=c,e=!0):t=!0))}}),Ze[0]=e,Ze[1]=n,Ze[2]=t,Ze[3]=r,U-=tt[1]+tt[3],_e+=tt[3],W-=tt[2]+tt[0],ve+=tt[0]}function Re(){let e=_e+U,t=ve+W,n=_e,r=ve;function i(i,a){switch(i){case 1:return e+=a,e-a;case 2:return t+=a,t-a;case 3:return n-=a,n+a;case 0:return r-=a,r+a}}y.forEach((e,t)=>{if(e.show&&e._show){let t=e.side;e._pos=i(t,e._size),e.label!=null&&(e._lpos=i(t,e.labelSize))}})}if(F.dataIdx==null){let e=F.hover,n=e.skip=new Set(e.skip??[]);n.add(void 0);let r=e.prox=Rp(e.prox),i=e.bias??=0;F.dataIdx=(e,a,o,s)=>{if(a==0)return o;let c=o,l=r(e,a,o,s)??Pp,u=l>=0&&l<Pp,d=D.ori==0?U:W,f=F.left,p=t[0],m=t[a];if(n.has(m[o])){c=null;let e=null,t=null,r;if(i==0||i==-1)for(r=o;e==null&&r-->0;)n.has(m[r])||(e=r);if(i==0||i==1)for(r=o;t==null&&r++<m.length;)n.has(m[r])||(t=r);if(e!=null||t!=null){if(u){let n=e==null?-1/0:k(p[e],D,d,0),r=t==null?1/0:k(p[t],D,d,0),i=f-n,a=r-f;i<=a?i<=l&&(c=e):a<=l&&(c=t)}else c=t==null?e:e==null?t:o-e<=t-o?e:t}}else u&&Sp(f-k(p[o],D,d,0))>l&&(c=null);return c}}let ze=e=>{F.event=e};F.idxs=re,F._lock=!1;let Be=F.points;Be.show=Rp(Be.show),Be.size=Rp(Be.size),Be.stroke=Rp(Be.stroke),Be.width=Rp(Be.width),Be.fill=Rp(Be.fill);let Ve=r.focus=fm({},e.focus||{alpha:.3},F.focus),He=Ve.prox>=0,Ue=He&&Be.one,We=[],Ge=[],Ke=[];function qe(e,t){let n=Be.show(r,t);if(n instanceof HTMLElement)return Bf(n,of),Bf(n,e.class),Kf(n,-10,-10,U,W),m.insertBefore(n,We[t]),n}function Je(e,t){if(i==1||t>0){let t=i==1&&b[e.scale].time,n=e.value;e.value=t?om(n)?lh(M,sh(n,ee)):n||ne:n||Wh,e.label=e.label||(t?jh:Ah)}if(Ue||t>0){e.width=e.width==null?1:e.width,e.paths=e.paths||Lg||Hp,e.fillTo=Rp(e.fillTo||sg),e.pxAlign=+hp(e.pxAlign,h),e.pxRound=fg(e.pxAlign),e.stroke=Rp(e.stroke||null),e.fill=Rp(e.fill||null),e._stroke=e._fill=e._paths=e._focus=null;let t=Kh(Dp(1,e.width),1),n=e.points=fm({},{size:t,width:Dp(1,t*.2),stroke:e.stroke,space:t*2,paths:Rg,_stroke:null,_fill:null},e.points);n.show=Rp(n.show),n.filter=Rp(n.filter),n.fill=Rp(n.fill),n.stroke=Rp(n.stroke),n.paths=Rp(n.paths),n.pxAlign=e.pxAlign}if(ie){let n=me(e,t);se.splice(t,0,n[0]),ce.splice(t,0,n[1]),P.values.push(null)}if(I){re.splice(t,0,null);let n=null;Ue?t==0&&(n=qe(e,t)):t>0&&(n=qe(e,t)),We.splice(t,0,n),Ge.splice(t,0,0),Ke.splice(t,0,0)}qn(`addSeries`,t)}function Ye(e,t){t??=v.length,e=i==1?Vg(e,t,Mh,Zh):Vg(e,t,{},Xh),v.splice(t,0,e),Je(v[t],t)}r.addSeries=Ye;function Xe(e){if(v.splice(e,1),ie){P.values.splice(e,1),ce.splice(e,1);let t=se.splice(e,1)[0];V(null,t.firstChild),t.remove()}I&&(re.splice(e,1),We.splice(e,1)[0].remove(),Ge.splice(e,1),Ke.splice(e,1)),qn(`delSeries`,e)}r.delSeries=Xe;let Ze=[!1,!1,!1,!1];function Qe(e,t){if(e._show=e.show,e.show){let n=e.side%2,i=b[e.scale];i??=(e.scale=n?v[1].scale:S,b[e.scale]);let a=i.time;e.size=Rp(e.size),e.space=Rp(e.space),e.rotate=Rp(e.rotate),rm(e.incrs)&&e.incrs.forEach(e=>{!Zp.has(e)&&Zp.set(e,Qp(e))}),e.incrs=Rp(e.incrs||(i.distr==2?Lm:a?_==1?Zm:eh:Rm)),e.splits=Rp(e.splits||(a&&i.distr==1?N:i.distr==3?Fh:i.distr==4?Ih:Ph)),e.stroke=Rp(e.stroke),e.grid.stroke=Rp(e.grid.stroke),e.ticks.stroke=Rp(e.ticks.stroke),e.border.stroke=Rp(e.border.stroke);let o=e.values;e.values=rm(o)&&!rm(o[0])?Rp(o):a?rm(o)?ih(M,rh(o,ee)):om(o)?ah(M,o):o||te:o||Nh,e.filter=Rp(e.filter||(i.distr>=3&&i.log==10?Hh:i.distr==3&&i.log==2?Uh:Vp)),e.font=Xg(e.font),e.labelFont=Xg(e.labelFont),e._size=e.size(r,null,t,0),e._space=e._rotate=e._incrs=e._found=e._splits=e._values=null,e._size>0&&(Ze[t]=!0,e._el=Wf(ef,f))}}function $e(e,t,n,r){let[i,a,o,s]=n,c=t%2,l=0;return c==0&&(s||a)&&(l=t==0&&!i||t==2&&!o?wp(kh.size/3):0),c==1&&(i||o)&&(l=t==1&&!a||t==3&&!s?wp(Gh.size/2):0),l}let et=r.padding=(e.padding||[$e,$e,$e,$e]).map(e=>Rp(hp(e,$e))),tt=r._padding=et.map((e,t)=>e(r,t,Ze,0)),nt,rt=null,it=null,at=i==1?v[0].idxs:null,ot=null,st=!1;function ct(e,n){if(t=e??[],r.data=r._data=t,i==2){nt=0;for(let e=1;e<v.length;e++)nt+=t[e][0].length}else{t.length==0&&(r.data=r._data=t=[[]]),ot=t[0],nt=ot.length;let e=t;if(O==2){e=t.slice();let n=e[0]=Array(nt);for(let e=0;e<nt;e++)n[e]=e}r._data=t=e}if(K(!0),qn(`setData`),O==2&&(ke=!0),n!==!1){let e=D;e.auto(r,st)?lt():un(S,e.min,e.max),Ae||=F.left>=0,Me=!0,Bt()}}r.setData=ct;function lt(){st=!0;let e,n;i==1&&(nt>0?(rt=at[0]=0,it=at[1]=nt-1,e=t[0][rt],n=t[0][it],O==2?(e=rt,n=it):e==n&&(O==3?[e,n]=cp(e,e,D.log,!1):O==4?[e,n]=lp(e,e,D.log,!1):D.time?n=e+wp(86400/_):[e,n]=mp(e,n,up,!0))):(rt=at[0]=e=null,it=at[1]=n=null)),un(S,e,n)}let ut,G,dt,ft,pt,mt,ht,gt,_t,vt;function yt(e,t,n,r,i,a){e??=xf,n??=tm,r??=`butt`,i??=xf,a??=`round`,e!=ut&&(d.strokeStyle=ut=e),i!=G&&(d.fillStyle=G=i),t!=dt&&(d.lineWidth=dt=t),a!=pt&&(d.lineJoin=pt=a),r!=mt&&(d.lineCap=mt=r),n!=ft&&d.setLineDash(ft=n)}function bt(e,t,n,r){t!=G&&(d.fillStyle=G=t),e!=ht&&(d.font=ht=e),n!=gt&&(d.textAlign=gt=n),r!=_t&&(d.textBaseline=_t=r)}function xt(e,t,n,i,a=0){if(i.length>0&&e.auto(r,st)&&(t==null||t.min==null)){let t=hp(rt,0),r=hp(it,i.length-1),o=n.min==null?sp(i,t,r,a,e.distr==3):[n.min,n.max];e.min=Ep(e.min,n.min=o[0]),e.max=Dp(e.max,n.max=o[1])}}let St={min:null,max:null};function Ct(){for(let e in b){let t=b[e];j[e]==null&&(t.min==null||j[S]!=null&&t.auto(r,st))&&(j[e]=St)}for(let e in b){let t=b[e];j[e]==null&&t.from!=null&&j[t.from]!=null&&(j[e]=St)}j[S]!=null&&K(!0);let e={};for(let t in j){let n=j[t];if(n!=null){let a=e[t]=dm(b[t],cm);if(n.min!=null)fm(a,n);else if(t!=S||i==2){if(nt==0&&a.from==null){let e=a.range(r,null,null,t);a.min=e[0],a.max=e[1]}else a.min=Pp,a.max=-1/0}}}if(nt>0){v.forEach((n,a)=>{if(i==1){let i=n.scale,o=j[i];if(o==null)return;let s=e[i];if(a==0){let e=s.range(r,s.min,s.max,i);s.min=e[0],s.max=e[1],rt=tp(s.min,t[0]),it=tp(s.max,t[0]),it-rt>1&&(t[0][rt]<s.min&&rt++,t[0][it]>s.max&&it--),n.min=ot[rt],n.max=ot[it]}else n.show&&n.auto&&xt(s,o,n,t[a],n.sorted);n.idxs[0]=rt,n.idxs[1]=it}else if(a>0&&n.show&&n.auto){let[r,i]=n.facets,o=r.scale,s=i.scale,[c,l]=t[a],u=e[o],d=e[s];u!=null&&xt(u,j[o],r,c,r.sorted),d!=null&&xt(d,j[s],i,l,i.sorted),n.min=i.min,n.max=i.max}});for(let t in e){let n=e[t],i=j[t];if(n.from==null&&(i==null||i.min==null)){let e=n.range(r,n.min==Pp?null:n.min,n.max==-1/0?null:n.max,t);n.min=e[0],n.max=e[1]}}}for(let t in e){let n=e[t];if(n.from!=null){let i=e[n.from];if(i.min==null)n.min=n.max=null;else{let e=n.range(r,i.min,i.max,t);n.min=e[0],n.max=e[1]}}}let n={},a=!1;for(let t in e){let r=e[t],i=b[t];if(i.min!=r.min||i.max!=r.max){i.min=r.min,i.max=r.max;let e=i.distr;i._min=e==3?Ap(i.min):e==4?Np(i.min,i.asinh):e==100?i.fwd(i.min):i.min,i._max=e==3?Ap(i.max):e==4?Np(i.max,i.asinh):e==100?i.fwd(i.max):i.max,n[t]=a=!0}}if(a){v.forEach((e,t)=>{i==2?t>0&&n.y&&(e._paths=null):n[e.scale]&&(e._paths=null)});for(let e in n)ke=!0,qn(`setScale`,e);I&&F.left>=0&&(Ae=Me=!0)}for(let e in j)j[e]=null}function wt(e){let t=Ip(rt-1,0,nt-1),n=Ip(it+1,0,nt-1);for(;e[t]==null&&t>0;)t--;for(;e[n]==null&&n<nt-1;)n++;return[t,n]}function Tt(){if(nt>0){let e=v.some(e=>e._focus)&&vt!=Ve.alpha;e&&(d.globalAlpha=vt=Ve.alpha),v.forEach((e,n)=>{if(n>0&&e.show&&(Et(n,!1),Et(n,!0),e._paths==null)){let a=vt;vt!=e.alpha&&(d.globalAlpha=vt=e.alpha);let o=i==2?[0,t[n][0].length-1]:wt(t[n]);e._paths=e.paths(r,n,o[0],o[1]),vt!=a&&(d.globalAlpha=vt=a)}}),v.forEach((e,t)=>{if(t>0&&e.show){let n=vt;vt!=e.alpha&&(d.globalAlpha=vt=e.alpha),e._paths!=null&&Dt(t,!1);{let n=e._paths==null?null:e._paths.gaps,i=e.points.show(r,t,rt,it,n),a=e.points.filter(r,t,i,n);(i||a)&&(e.points._paths=e.points.paths(r,t,rt,it,a),Dt(t,!0))}vt!=n&&(d.globalAlpha=vt=n),qn(`drawSeries`,t)}}),e&&(d.globalAlpha=vt=1)}}function Et(e,t){let n=t?v[e].points:v[e];n._stroke=n.stroke(r,e),n._fill=n.fill(r,e)}function Dt(e,t){let n=t?v[e].points:v[e],{stroke:r,fill:i,clip:a,flags:o,_stroke:s=n._stroke,_fill:c=n._fill,_width:l=n.width}=n._paths;l=Xp(l*Lf,3);let u=null,f=l%2/2;t&&c==null&&(c=l>0?`#fff`:s);let p=n.pxAlign==1&&f>0;if(p&&d.translate(f,f),!t){let e=Ce-l/2,t=we-l/2,n=Te+l,r=Ee+l;u=new Path2D,u.rect(e,t,n,r)}t?kt(s,l,n.dash,n.cap,c,r,i,o,a):Ot(e,s,l,n.dash,n.cap,c,r,i,o,u,a),p&&d.translate(-f,-f)}function Ot(e,n,i,a,o,s,c,l,u,d,f){let p=!1;u!=0&&x.forEach((m,h)=>{if(m.series[0]==e){let e=v[m.series[1]],g=t[m.series[1]],_=(e._paths||em).band;rm(_)&&(_=m.dir==1?_[0]:_[1]);let y,b=null;e.show&&_&&gp(g,rt,it)?(b=m.fill(r,h)||s,y=e._paths.clip):_=null,kt(n,i,a,o,b,c,l,u,d,f,y,_),p=!0}}),p||kt(n,i,a,o,s,c,l,u,d,f)}function kt(e,t,n,r,i,a,o,s,c,l,u,f){yt(e,t,n,r,i),(c||l||f)&&(d.save(),c&&d.clip(c),l&&d.clip(l)),f?(s&3)==3?(d.clip(f),u&&d.clip(u),jt(i,o),At(e,a,t)):s&ig?(jt(i,o),d.clip(f),At(e,a,t)):s&rg&&(d.save(),d.clip(f),u&&d.clip(u),jt(i,o),d.restore(),At(e,a,t)):(jt(i,o),At(e,a,t)),(c||l||f)&&d.restore()}function At(e,t,n){n>0&&(t instanceof Map?t.forEach((e,t)=>{d.strokeStyle=ut=t,d.stroke(e)}):t!=null&&e&&d.stroke(t))}function jt(e,t){t instanceof Map?t.forEach((e,t)=>{d.fillStyle=G=t,d.fill(e)}):t!=null&&e&&d.fill(t)}function Mt(e,t,n,i){let a=y[e],o;if(i<=0)o=[0,0];else{let s=a._space=a.space(r,e,t,n,i);o=Yg(t,n,a._incrs=a.incrs(r,e,t,n,i,s),i,s)}return a._found=o}function Nt(e,t,n,r,i,a,o,s,c,l){let u=o%2/2;h==1&&d.translate(u,u),yt(s,o,c,l,s),d.beginPath();let f,p,m,g,_=i+(r==0||r==3?-a:a);n==0?(p=i,g=_):(f=i,m=_);for(let r=0;r<e.length;r++)t[r]!=null&&(n==0?f=m=e[r]:p=g=e[r],d.moveTo(f,p),d.lineTo(m,g));d.stroke(),h==1&&d.translate(-u,-u)}function Pt(e){let t=!0;return y.forEach((n,i)=>{if(!n.show)return;let a=b[n.scale];if(a.min==null){n._show&&(t=!1,n._show=!1,K(!1));return}n._show||(t=!1,n._show=!0,K(!1));let o=n.side,s=o%2,{min:c,max:l}=a,[u,d]=Mt(i,c,l,s==0?U:W);if(d==0)return;let f=a.distr==2,p=n._splits=n.splits(r,i,c,l,u,d,f),m=a.distr==2?p.map(e=>ot[e]):p,h=a.distr==2?ot[p[1]]-ot[p[0]]:u,g=n._values=n.values(r,n.filter(r,m,i,d,h),i,d,h);n._rotate=o==2?n.rotate(r,g,i,d):0;let _=n._size;n._size=Tp(n.size(r,g,i,e)),_!=null&&n._size!=_&&(t=!1)}),t}function Ft(e){let t=!0;return et.forEach((n,i)=>{let a=n(r,i,Ze,e);a!=tt[i]&&(t=!1),tt[i]=a}),t}function It(){for(let e=0;e<y.length;e++){let t=y[e];if(!t.show||!t._show)continue;let n=t.side,i=n%2,a,o,c=t.stroke(r,e),l=n==0||n==3?-1:1,[u,f]=t._found;if(t.label!=null){let s=t.labelGap*l,p=wp((t._lpos+s)*Lf);bt(t.labelFont[0],c,`center`,n==2?gf:_f),d.save(),i==1?(a=o=0,d.translate(p,wp(we+Ee/2)),d.rotate((n==3?-xp:xp)/2)):(a=wp(Ce+Te/2),o=p);let m=Lp(t.label)?t.label(r,e,u,f):t.label;d.fillText(m,a,o),d.restore()}if(f==0)continue;let p=b[t.scale],m=i==0?Te:Ee,h=i==0?Ce:we,_=t._splits,v=p.distr==2?_.map(e=>ot[e]):_,x=p.distr==2?ot[_[1]]-ot[_[0]]:u,S=t.ticks,C=t.border,w=S.show?S.size:0,T=wp(w*Lf),E=wp((t.alignTo==2?t._size-w-t.gap:t.gap)*Lf),D=t._rotate*-xp/180,O=g(t._pos*Lf),k=O+(T+E)*l;o=i==0?k:0,a=i==1?k:0;let A=t.font[0];bt(A,c,t.align==1?vf:t.align==2?yf:D>0?vf:D<0?yf:i==0?`center`:n==3?yf:vf,D||i==1?`middle`:n==2?gf:_f);let j=t.font[1]*t.lineGap,M=_.map(e=>g(s(e,p,m,h))),ee=t._values;for(let e=0;e<ee.length;e++){let t=ee[e];if(t!=null){i==0?a=M[e]:o=M[e],t=``+t;let n=t.indexOf(`
`)==-1?[t]:t.split(/\n/gm);for(let e=0;e<n.length;e++){let t=n[e];D?(d.save(),d.translate(a,o+e*j),d.rotate(D),d.fillText(t,0,0),d.restore()):d.fillText(t,a,o+e*j)}}}S.show&&Nt(M,S.filter(r,v,e,f,x),i,n,O,T,Xp(S.width*Lf,3),S.stroke(r,e),S.dash,S.cap);let N=t.grid;N.show&&Nt(M,N.filter(r,v,e,f,x),i,i==0?2:1,i==0?we:Ce,i==0?Ee:Te,Xp(N.width*Lf,3),N.stroke(r,e),N.dash,N.cap),C.show&&Nt([O],[1],+(i==0),i==0?1:2,i==1?we:Ce,i==1?Ee:Te,Xp(C.width*Lf,3),C.stroke(r,e),C.dash,C.cap)}qn(`drawAxes`)}function K(e){v.forEach((t,n)=>{n>0&&(t._paths=null,e&&(i==1?(t.min=null,t.max=null):t.facets.forEach(e=>{e.min=null,e.max=null})))})}let q=!1,Lt=!1,Rt=[];function zt(){Lt=!1;for(let e=0;e<Rt.length;e++)qn(...Rt[e]);Rt.length=0}function Bt(){q||=(vm(Ht),!0)}function Vt(e,t=!1){q=!0,Lt=t,e(r),Ht(),t&&Rt.length>0&&queueMicrotask(zt)}r.batch=Vt;function Ht(){if(De&&=(Ct(),!1),ke&&=(Fe(),!1),Oe){if(Hf(p,vf,_e),Hf(p,gf,ve),Hf(p,mf,U),Hf(p,hf,W),Hf(m,vf,_e),Hf(m,gf,ve),Hf(m,mf,U),Hf(m,hf,W),Hf(f,mf,H),Hf(f,hf,ge),u.width=wp(H*Lf),u.height=wp(ge*Lf),y.forEach(({_el:e,_show:t,_size:n,_pos:r,side:i})=>{if(e!=null){if(t){let t=i===3||i===0?n:0,a=i%2==1;Hf(e,a?`left`:`top`,r-t),Hf(e,a?`width`:`height`,n),Hf(e,a?`top`:`left`,a?ve:_e),Hf(e,a?`height`:`width`,a?W:U),Vf(e,tf)}else Bf(e,tf)}}),ut=G=dt=pt=mt=ht=gt=_t=ft=null,vt=1,jn(!0),_e!=ye||ve!=be||U!=xe||W!=Se){K(!1);let e=U/xe,t=W/Se;if(I&&!Ae&&F.left>=0){F.left*=e,F.top*=t,Kt&&Kf(Kt,wp(F.left),0,U,W),qt&&Kf(qt,0,wp(F.top),U,W);for(let n=0;n<We.length;n++){let r=We[n];r!=null&&(Ge[n]*=e,Ke[n]*=t,Kf(r,Tp(Ge[n]),Tp(Ke[n]),U,W))}}if(J.show&&!je&&J.left>=0&&J.width>0){J.left*=e,J.width*=e,J.top*=t,J.height*=t;for(let e in Pn)Hf(sn,e,J[e])}ye=_e,be=ve,xe=U,Se=W}qn(`setSize`),Oe=!1}H>0&&ge>0&&(d.clearRect(0,0,u.width,u.height),qn(`drawClear`),w.forEach(e=>e()),qn(`draw`)),J.show&&je&&(cn(J),je=!1),I&&Ae&&(kn(null,!0,!1),Ae=!1),P.show&&P.live&&Me&&(Dn(),Me=!1),c||(c=!0,r.status=1,qn(`ready`)),st=!1,q=!1}r.redraw=(e,t)=>{ke=t||!1,e===!1?Bt():un(S,D.min,D.max)};function Ut(e,n){let i=b[e];if(i.from==null){if(nt==0){let t=i.range(r,n.min,n.max,e);n.min=t[0],n.max=t[1]}if(n.min>n.max){let e=n.min;n.min=n.max,n.max=e}if(nt>1&&n.min!=null&&n.max!=null&&n.max-n.min<1e-16)return;e==S&&i.distr==2&&nt>0&&(n.min=tp(n.min,t[0]),n.max=tp(n.max,t[0]),n.min==n.max&&n.max++),j[e]=n,De=!0,Bt()}}r.setScale=Ut;let Wt,Gt,Kt,qt,Jt,Yt,Xt,Zt,Qt,$t,en,tn,nn=!1,rn=F.drag,an=rn.x,on=rn.y;I&&(F.x&&(Wt=Wf(rf,m)),F.y&&(Gt=Wf(af,m)),D.ori==0?(Kt=Wt,qt=Gt):(Kt=Gt,qt=Wt),en=F.left,tn=F.top);let J=r.select=fm({show:!0,over:!0,left:0,width:0,top:0,height:0},e.select),sn=J.show?Wf(nf,J.over?m:p):null;function cn(e,t){if(J.show){for(let t in e)J[t]=e[t],t in Pn&&Hf(sn,t,e[t]);t!==!1&&qn(`setSelect`)}}r.setSelect=cn;function ln(e){if(v[e].show)ie&&Vf(se[e],tf);else if(ie&&Bf(se[e],tf),I){let t=Ue?We[0]:We[e];t!=null&&Kf(t,-10,-10,U,W)}}function un(e,t,n){Ut(e,{min:t,max:n})}function dn(e,t,n,a){t.focus!=null&&yn(e),t.show!=null&&v.forEach((n,r)=>{r>0&&(e==r||e==null)&&(n.show=t.show,ln(r),i==2?(un(n.facets[0].scale,null,null),un(n.facets[1].scale,null,null)):un(n.scale,null,null),Bt())}),n!==!1&&qn(`setSeries`,e,t),a&&Qn(`setSeries`,r,e,t)}r.setSeries=dn;function Y(e,t){fm(x[e],t)}function fn(e,t){e.fill=Rp(e.fill||null),e.dir=hp(e.dir,-1),t??=x.length,x.splice(t,0,e)}function pn(e){e==null?x.length=0:x.splice(e,1)}r.addBand=fn,r.setBand=Y,r.delBand=pn;function mn(e,t){v[e].alpha=t,I&&We[e]!=null&&(We[e].style.opacity=t),ie&&se[e]&&(se[e].style.opacity=t)}let hn,gn,_n,vn={focus:!0};function yn(e){if(e!=_n){let t=e==null,n=Ve.alpha!=1;v.forEach((r,a)=>{if(i==1||a>0){let i=t||a==0||a==e;r._focus=t?null:i,n&&mn(a,i?1:Ve.alpha)}}),_n=e,n&&Bt()}}ie&&He&&he(Ef,R,e=>{F._lock||(ze(e),_n!=null&&dn(null,vn,!0,Yn.setSeries))});function bn(e,t,n){let r=b[t];n&&(e=e/Lf-(r.ori==1?ve:_e));let i=U;r.ori==1&&(i=W,e=i-e),r.dir==-1&&(e=i-e);let a=r._min,o=r._max,s=e/i,c=a+(o-a)*s,l=r.distr;return l==3?Op(10,c):l==4?Mp(c,r.asinh):l==100?r.bwd(c):c}function xn(e,n){return tp(bn(e,S,n),t[0],rt,it)}r.valToIdx=e=>tp(e,t[0]),r.posToIdx=xn,r.posToVal=bn,r.valToPos=(e,t,n)=>b[t].ori==0?a(e,b[t],n?Te:U,n?Ce:0):o(e,b[t],n?Ee:W,n?we:0),r.setCursor=(e,t,n)=>{en=e.left,tn=e.top,kn(null,t,n)};function Sn(e,t){Hf(sn,vf,J.left=e),Hf(sn,mf,J.width=t)}function Cn(e,t){Hf(sn,gf,J.top=e),Hf(sn,hf,J.height=t)}let wn=D.ori==0?Sn:Cn,Tn=D.ori==1?Sn:Cn;function En(){if(ie&&P.live)for(let e=+(i==2);e<v.length;e++){if(e==0&&ue)continue;let t=P.values[e],n=0;for(let r in t)ce[e][n++].firstChild.nodeValue=t[r]}}function Dn(e,t){if(e!=null&&(e.idxs?e.idxs.forEach((e,t)=>{re[t]=e}):am(e.idx)||re.fill(e.idx),P.idx=re[0]),ie&&P.live){for(let e=0;e<v.length;e++)(e>0||i==1&&!ue)&&On(e,re[e]);En()}Me=!1,t!==!1&&qn(`setLegend`)}r.setLegend=Dn;function On(e,n){let i=v[e],a=e==0&&O==2?ot:t[e],o;ue?o=i.values(r,e,n)??de:(o=i.value(r,n==null?null:a[n],e,n),o=o==null?de:{_:o}),P.values[e]=o}function kn(e,n,a){Qt=en,$t=tn,[en,tn]=F.move(r,en,tn),F.left=en,F.top=tn,I&&(Kt&&Kf(Kt,wp(en),0,U,W),qt&&Kf(qt,0,wp(tn),U,W));let o,s=rt>it;hn=Pp,gn=null;let c=D.ori==0?U:W,l=D.ori==1?U:W;if(en<0||nt==0||s){o=F.idx=null;for(let e=0;e<v.length;e++){let t=We[e];t!=null&&Kf(t,-10,-10,U,W)}He&&dn(null,vn,!0,e==null&&Yn.setSeries),P.live&&(re.fill(o),Me=!0)}else{let e,n,a;i==1&&(e=D.ori==0?en:tn,n=bn(e,S),o=F.idx=tp(n,t[0],rt,it),a=k(t[0][o],D,c,0));let s=-10,u=-10,d=0,f=0,p=!0,m=``,h=``;for(let e=+(i==2);e<v.length;e++){let g=v[e],_=re[e],y=_==null?null:i==1?t[e][_]:t[e][1][_],x=F.dataIdx(r,e,o,n),S=x==null?null:i==1?t[e][x]:t[e][1][x];if(Me=Me||S!=y||x!=_,re[e]=x,e>0&&g.show){let n=x==null?-10:x==o?a:k(i==1?t[0][x]:t[e][0][x],D,c,0),_=S==null?-10:A(S,i==1?b[g.scale]:b[g.facets[1].scale],l,0);if(He&&S!=null){let t=D.ori==1?en:tn,n=Sp(Ve.dist(r,e,x,_,t));if(n<hn){let r=Ve.bias;if(r!=0){let i=bn(t,g.scale),a=S>=0?1:-1,o=i>=0?1:-1;o==a&&(o==1?r==1?S>=i:S<=i:r==1?S<=i:S>=i)&&(hn=n,gn=e)}else hn=n,gn=e}}if(Me||Ue){let t,i;D.ori==0?(t=n,i=_):(t=_,i=n);let a,o,c,l,g,v,y=!0,b=Be.bbox;if(b!=null){y=!1;let t=b(r,e);c=t.left,l=t.top,a=t.width,o=t.height}else c=t,l=i,a=o=Be.size(r,e);if(v=Be.fill(r,e),g=Be.stroke(r,e),Ue)e==gn&&hn<=Ve.prox&&(s=c,u=l,d=a,f=o,p=y,m=v,h=g);else{let t=We[e];t!=null&&(Ge[e]=c,Ke[e]=l,Xf(t,a,o,y),Jf(t,v,g),Kf(t,Tp(c),Tp(l),U,W))}}}}if(Ue){let e=Ve.prox;if(Me||(_n==null?hn<=e:hn>e||gn!=_n)){let e=We[0];e!=null&&(Ge[0]=s,Ke[0]=u,Xf(e,d,f,p),Jf(e,m,h),Kf(e,Tp(s),Tp(u),U,W))}}}if(J.show&&nn){if(e!=null){let[t,n]=Yn.scales,[r,i]=Yn.match,[a,o]=e.cursor.sync.scales,s=e.cursor.drag;if(an=s._x,on=s._y,an||on){let{left:s,top:u,width:d,height:f}=e.select,p=e.scales[a].ori,m=e.posToVal,h,g,_,v,y,x=t!=null&&r(t,a),S=n!=null&&i(n,o);x&&an?(p==0?(h=s,g=d):(h=u,g=f),_=b[t],v=k(m(h,a),_,c,0),y=k(m(h+g,a),_,c,0),wn(Ep(v,y),Sp(y-v))):wn(0,c),S&&on?(p==1?(h=s,g=d):(h=u,g=f),_=b[n],v=A(m(h,o),_,l,0),y=A(m(h+g,o),_,l,0),Tn(Ep(v,y),Sp(y-v))):Tn(0,l)}else Fn()}else{let e=Sp(Qt-Jt),t=Sp($t-Yt);if(D.ori==1){let n=e;e=t,t=n}an=rn.x&&e>=rn.dist,on=rn.y&&t>=rn.dist;let n=rn.uni;n==null?rn.x&&rn.y&&(an||on)&&(an=on=!0):an&&on&&(an=e>=n,on=t>=n,!an&&!on&&(t>e?on=!0:an=!0));let r,i;an&&(D.ori==0?(r=Xt,i=en):(r=Zt,i=tn),wn(Ep(r,i),Sp(i-r)),on||Tn(0,l)),on&&(D.ori==1?(r=Xt,i=en):(r=Zt,i=tn),Tn(Ep(r,i),Sp(i-r)),an||wn(0,c)),!an&&!on&&(wn(0,0),Tn(0,0))}}if(rn._x=an,rn._y=on,e==null){if(a){if(Xn!=null){let[e,t]=Yn.scales;Yn.values[0]=e==null?null:bn(D.ori==0?en:tn,e),Yn.values[1]=t==null?null:bn(D.ori==1?en:tn,t)}Qn(Sf,r,en,tn,U,W,o)}if(He){let e=a&&Yn.setSeries,t=Ve.prox;_n==null?hn<=t&&dn(gn,vn,!0,e):hn>t?dn(null,vn,!0,e):gn!=_n&&dn(gn,vn,!0,e)}}Me&&(P.idx=o,Dn()),n!==!1&&qn(`setCursor`)}let An=null;Object.defineProperty(r,"rect",{get(){return An??jn(!1),An}});function jn(e=!1){e?An=null:(An=m.getBoundingClientRect(),qn(`syncRect`,An))}function Mn(e,t,n,r,i,a,o){F._lock||nn&&e!=null&&e.movementX==0&&e.movementY==0||(Nn(e,t,n,r,i,a,o,!1,e!=null),e==null?kn(t,!0,!1):kn(null,!0,!0))}function Nn(e,t,n,i,a,o,c,l,u){if(An??jn(!1),ze(e),e!=null)n=e.clientX-An.left,i=e.clientY-An.top;else{if(n<0||i<0){en=-10,tn=-10;return}let[e,r]=Yn.scales,c=t.cursor.sync,[l,u]=c.values,[d,f]=c.scales,[p,m]=Yn.match,h=t.axes[0].side%2==1,g=D.ori==0?U:W,_=D.ori==1?U:W,v=h?o:a,y=h?a:o,x=h?i:n,S=h?n:i;if(n=d==null?x/v*g:p(e,d)?s(l,b[e],g,0):-10,i=f==null?S/y*_:m(r,f)?s(u,b[r],_,0):-10,D.ori==1){let e=n;n=i,i=e}}u&&(t==null||t.cursor.event.type==Sf)&&((n<=1||n>=U-1)&&(n=qp(n,U)),(i<=1||i>=W-1)&&(i=qp(i,W))),l?(Jt=n,Yt=i,[Xt,Zt]=F.move(r,n,i)):(en=n,tn=i)}let Pn={width:0,height:0,left:0,top:0};function Fn(){cn(Pn,!1)}let In,Ln,Rn,zn;function Bn(e,t,n,i,a,o,s){nn=!0,an=on=rn._x=rn._y=!1,Nn(e,t,n,i,a,o,s,!0,!1),e!=null&&(he(wf,Pf,Vn,!1),Qn(Cf,r,Xt,Zt,U,W,null));let{left:c,top:l,width:u,height:d}=J;In=c,Ln=l,Rn=u,zn=d}function Vn(e,t,n,i,a,o,s){nn=rn._x=rn._y=!1,Nn(e,t,n,i,a,o,s,!1,!0);let{left:c,top:l,width:u,height:d}=J,f=u>0||d>0,p=In!=c||Ln!=l||Rn!=u||zn!=d;if(f&&p&&cn(J),rn.setScale&&f&&p){let e=c,t=u,n=l,r=d;if(D.ori==1&&(e=l,t=d,n=c,r=u),an&&un(S,bn(e,S),bn(e+t,S)),on)for(let e in b){let t=b[e];e!=S&&t.from==null&&t.min!=Pp&&un(e,bn(n+r,e),bn(n,e))}Fn()}else F.lock&&(F._lock=!F._lock,kn(t,!0,e!=null));e!=null&&(V(wf,Pf),Qn(wf,r,en,tn,U,W,null))}function Hn(e,t,n,r,i,a,o){if(F._lock)return;ze(e);let s=nn;if(nn){let e=!0,t=!0,n,r;D.ori==0?(n=an,r=on):(n=on,r=an),n&&r&&(e=en<=10||en>=U-10,t=tn<=10||tn>=W-10),n&&e&&(en=en<Xt?0:U),r&&t&&(tn=tn<Zt?0:W),kn(null,!0,!0),nn=!1}en=-10,tn=-10,re.fill(null),kn(null,!0,!0),s&&(nn=s)}function Un(e,t,n,i,a,o,s){F._lock||(ze(e),lt(),Fn(),e!=null&&Qn(Df,r,en,tn,U,W,null))}function Wn(){y.forEach(Zg),Ne(r.width,r.height,!0)}$f(jf,Ff,Wn);let Gn={};Gn.mousedown=Bn,Gn.mousemove=Mn,Gn.mouseup=Vn,Gn.dblclick=Un,Gn.setSeries=(e,t,n,i)=>{let a=Yn.match[2];n=a(r,t,n),n!=-1&&dn(n,i,!0,!1)},I&&(he(Cf,m,Bn),he(Sf,m,Mn),he(Tf,m,e=>{ze(e),jn(!1)}),he(Ef,m,Hn),he(Df,m,Un),Fg.add(r),r.syncRect=jn);let Kn=r.hooks=e.hooks||{};function qn(e,t,n){Lt?Rt.push([e,t,n]):e in Kn&&Kn[e].forEach(e=>{e.call(null,r,t,n)})}(e.plugins||[]).forEach(e=>{for(let t in e.hooks)Kn[t]=(Kn[t]||[]).concat(e.hooks[t])});let Jn=(e,t,n)=>n,Yn=fm({key:null,setSeries:!1,filters:{pub:Up,sub:Up},scales:[S,v[1]?v[1].scale:null],match:[Wp,Wp,Jn],values:[null,null]},F.sync);Yn.match.length==2&&Yn.match.push(Jn),F.sync=Yn;let Xn=Yn.key,Zn=ng(Xn);function Qn(e,t,n,r,i,a,o){Yn.filters.pub(e,t,n,r,i,a,o)&&Zn.pub(e,t,n,r,i,a,o)}Zn.sub(r);function $n(e,t,n,r,i,a,o){Yn.filters.sub(e,t,n,r,i,a,o)&&Gn[e](null,t,n,r,i,a,o)}r.pub=$n;function er(){Zn.unsub(r),Fg.delete(r),B.clear(),ep(jf,Ff,Wn),l.remove(),R?.remove(),qn(`destroy`)}r.destroy=er;function tr(){qn(`init`,e,t),ct(t||e.data,!1),j[S]?Ut(S,j[S]):lt(),je=J.show&&(J.width>0||J.height>0),Ae=Me=!0,Ne(e.width,e.height)}return v.forEach(Je),y.forEach(Qe),n?n instanceof HTMLElement?(n.appendChild(l),tr()):n(r,tr):tr(),r}Qg.assign=fm,Qg.fmtNum=yp,Qg.rangeNum=mp,Qg.rangeLog=cp,Qg.rangeAsinh=lp,Qg.orient=ag,Qg.pxRatio=Lf,Qg.join=_m,Qg.fmtDate=Am,Qg.tzDate=Mm,Qg.sync=ng;{Qg.addGap=ug,Qg.clipGaps=lg;let e=Qg.paths={points:wg};e.linear=Og,e.stepped=kg,e.bars=jg,e.spline=Ng}var $g={stroke:`#a8a69d`,grid:{stroke:`rgba(255,255,255,0.06)`},ticks:{stroke:`rgba(255,255,255,0.12)`}};function e_({points:e,unit:t,label:n}){let r=(0,g.useRef)(null);return(0,g.useEffect)(()=>{let i=r.current,a=[e.map(e=>e[0]/1e3),e.map(e=>e[1])],o=new Qg({width:i.clientWidth||400,height:200,cursor:{drag:{x:!0,y:!1}},scales:{x:{time:!0}},tzDate:e=>Qg.tzDate(new Date(e*1e3),`Etc/UTC`),axes:[{...$g},{...$g,label:t??``,size:56}],series:[{label:`UTC`},{label:n??`value`,stroke:`#ecebe6`,width:1.5}]},a,i);return()=>o.destroy()},[e,t,n]),(0,$.jsx)(`div`,{ref:r,className:`chart`})}var t_={CTDPF:`sea_water_temperature`,DOSTA:`moles_of_oxygen_per_unit_mass_in_sea_water`,DOFST:`moles_of_oxygen_per_unit_mass_in_sea_water`,PHSEN:`sea_water_ph_reported_on_total_scale`,FLORT:`mass_concentration_of_chlorophyll_a_in_sea_water`,FLORD:`mass_concentration_of_chlorophyll_a_in_sea_water`,FLNTU:`mass_concentration_of_chlorophyll_a_in_sea_water`,FLCDR:`concentration_of_colored_dissolved_organic_matter`,NUTNR:`mole_concentration_of_nitrate_in_sea_water`,PCO2W:`partial_pressure_of_carbon_dioxide_in_sea_water`,PARAD:`downwelling_photosynthetic_photon_flux_in_sea_water`,SPKIR:`spectir_490nm`,VEL3D:`eastward_sea_water_velocity`,VELPT:`eastward_sea_water_velocity`,VADCP:`eastward_sea_water_velocity`,PREST:`sea_water_pressure_at_sea_floor`,BOTPT:`botpres`,TRHPH:`trhphte_abs`,THSPH:`thsphte_th`,TMPSF:`tempsfl_01`};function n_(e,t){let n=t_[(e??``).split(`-`)[3]?.slice(0,5)];return(n&&t.find(e=>e.startsWith(n)))??(t.includes(`sea_water_temperature`)?`sea_water_temperature`:t[0])}var r_=e=>e.toISOString().replace(/\.\d{3}Z$/,`Z`),i_=26784e5;function a_(e,t=new Date,n=null){let r=n?new Date(n):null,i=new Date(r&&!isNaN(r)&&r<t?r:t);i.setUTCSeconds(0,0);let a={"24h":864e5,"7d":6048e5,"30d":2592e6}[e];return{start:r_(new Date(i-a)),end:r_(i)}}function o_(e,t){let n=new Date(`${e}:00Z`),r=new Date(`${t}:00Z`);return isNaN(n)||isNaN(r)?{ok:!1,message:`Enter both times.`}:r<=n?{ok:!1,message:`End must be after start.`}:r-n>i_?{ok:!1,message:`Ranges are limited to 31 days per request. Pick a shorter range or download the data from ERDDAP.`}:{ok:!0,start:r_(n),end:r_(r)}}function s_({refdes:e}){let t=Vd(`vars:${e}`,t=>Pd(e,t)),[n,r]=(0,g.useState)(null),[i,a]=(0,g.useState)(`24h`),[o,s]=(0,g.useState)(null),[c,l]=(0,g.useState)({from:``,to:``}),[u,d]=(0,g.useState)(null),f=t.data?.variables??[],p=n??n_(e,f.map(e=>e.name)),m=t.data?.coverage?.end??null,h=(0,g.useMemo)(()=>i===`custom`?null:a_(i,new Date,m),[i,m]),_=h&&Date.now()-Date.parse(h.end)>108e5,v=i===`custom`?o:h,y=Vd(p&&v?`series:${e}:${p}:${v.start}:${v.end}`:null,t=>Fd(e,{var:p,start:v.start,end:v.end},t));if(t.state===`loading`)return(0,$.jsx)(`p`,{className:`muted`,children:`Loading variables…`});if(t.state===`error`)return(0,$.jsx)(Ud,{error:t.error,retry:t.retry});let b=t.data?.variables??[];if(!b.length)return(0,$.jsx)(`p`,{className:`muted`,children:`This dataset lists no plottable measurements.`});let x=b.find(e=>e.name===p);return(0,$.jsxs)(`div`,{className:`series`,children:[(0,$.jsxs)(`div`,{className:`series-bar`,children:[(0,$.jsx)(`select`,{"aria-label":`Measurement`,value:p,onChange:e=>r(e.target.value),children:b.map(e=>(0,$.jsxs)(`option`,{value:e.name,children:[e.longName??e.name,e.units?` (${e.units})`:``]},e.name))}),(0,$.jsxs)(`div`,{className:`seg`,role:`group`,"aria-label":`Time range`,children:[[`24h`,`7d`,`30d`].map(e=>(0,$.jsx)(`button`,{"aria-pressed":i===e,onClick:()=>a(e),children:e},e)),(0,$.jsx)(`button`,{"aria-pressed":i===`custom`,onClick:()=>a(`custom`),children:`Custom`})]})]}),i===`custom`&&(0,$.jsxs)(`div`,{className:`custom-range`,children:[(0,$.jsxs)(`label`,{children:[`From `,(0,$.jsx)(`input`,{type:`datetime-local`,"aria-label":`From`,value:c.from,onChange:e=>l({...c,from:e.target.value})})]}),(0,$.jsxs)(`label`,{children:[`To `,(0,$.jsx)(`input`,{type:`datetime-local`,"aria-label":`To`,value:c.to,onChange:e=>l({...c,to:e.target.value})})]}),(0,$.jsx)(`button`,{onClick:()=>{let e=o_(c.from,c.to);e.ok?(s(e),d(null)):d(e.message)},children:`Apply`}),(0,$.jsx)(`span`,{className:`muted`,children:`Times in UTC.`}),u&&(0,$.jsx)(`p`,{className:`degraded`,children:u})]}),_&&(0,$.jsxs)(`p`,{className:`muted`,children:[`The newest reading is from `,nd(m),`; the `,i,` window ends there.`]}),y.state===`loading`&&(0,$.jsx)(`p`,{className:`muted`,children:`Loading readings…`}),y.state===`error`&&(0,$.jsx)(Ud,{error:y.error,retry:y.retry}),y.state===`ok`&&(y.data.points.length?(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(e_,{points:y.data.points,unit:y.data.units,label:x?.longName??p}),(0,$.jsxs)(`p`,{className:`chart-foot mono`,children:[y.data.rawCount.toLocaleString(`en-US`),` readings`,y.data.rawCount>y.data.points.length?`, shown as ${y.data.points.length.toLocaleString(`en-US`)}`:``,` · drag to zoom, double-click to reset · `,(0,$.jsx)(`a`,{href:y.data.downloadUrl,target:`_blank`,rel:`noreferrer`,children:`Download this range (CSV)`})]})]}):(0,$.jsxs)(`p`,{className:`muted`,children:[`No readings in this range.`,t.data?.coverage?.end?` The data runs to ${nd(t.data.coverage.end)}.`:``]}))]})}function c_({route:e}){let[t,n]=(0,g.useState)(10),r=`${e.network}.${e.station}`,i=Vd(`wave:${r}:${e.channel}:${t}`,n=>Ld(r,t,e.channel,n));return(0,$.jsxs)(`div`,{className:`waveform`,children:[(0,$.jsx)(`div`,{className:`seg`,role:`group`,"aria-label":`Window`,children:[1,5,10,30,60].map(e=>(0,$.jsxs)(`button`,{"aria-pressed":t===e,onClick:()=>n(e),children:[e,` min`]},e))}),i.state===`loading`&&(0,$.jsx)(`p`,{className:`muted`,children:`Loading the recording…`}),i.state===`error`&&(0,$.jsx)(Ud,{error:i.error,retry:i.retry}),i.state===`ok`&&(i.data.points.length?(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(e_,{points:i.data.points,unit:`counts`,label:`${r} ${i.data.channel}`}),(0,$.jsxs)(`p`,{className:`chart-foot mono`,children:[i.data.channel,` · `,i.data.rate,` samples/s · ends 2 minutes ago · drag to zoom, double-click to reset`]})]}):(0,$.jsx)(`p`,{className:`muted`,children:i.data.message??`No recording in this window.`}))]})}function l_({sensor:e}){let t=t=>e.access.find(e=>e.kind===t),n=t(`erddap`),r=t(`earthscope`),i=t(`qaqc`),a=e.access.filter(e=>e.kind===`pi_portal`);return(0,$.jsxs)(`section`,{className:`live-data`,children:[(0,$.jsx)(`h3`,{children:`Live data`}),n?(0,$.jsx)(s_,{refdes:e.refdes}):r?(0,$.jsx)(c_,{route:r}):i?(0,$.jsx)(Gd,{refdes:e.refdes}):null,n&&i&&(0,$.jsx)(u_,{refdes:e.refdes}),a.map(e=>(0,$.jsx)(Wd,{route:e},e.endpointId??e.url))]})}function u_({refdes:e}){let[t,n]=(0,g.useState)(!1);return(0,$.jsxs)(`details`,{onToggle:e=>e.currentTarget.open&&n(!0),children:[(0,$.jsx)(`summary`,{children:`Recent QA/QC plots`}),t&&(0,$.jsx)(Gd,{refdes:e})]})}function d_({sensor:e,bundle:t,onBack:n,backLabel:r}){let i=t.familyByKey[e.family],a=e.access.some(e=>[`erddap`,`earthscope`,`qaqc`,`pi_portal`].includes(e.kind));return(0,$.jsxs)(`div`,{className:`sensor-detail`,children:[(0,$.jsxs)(`button`,{className:`back`,onClick:n,children:[`← `,r??t.siteById[e.site]?.label??`Back`]}),(0,$.jsxs)(`h2`,{children:[(0,$.jsx)(bd,{glyph:i.glyph,color:i.color,size:13}),` `,e.name]}),(0,$.jsxs)(`div`,{className:`meta mono`,children:[e.type.replaceAll(`_`,` `),` · `,e.depthRange?$u(...e.depthRange):Qu(e.depth),e.manufacturer?` · ${e.manufacturer}${e.model?` `+e.model:``}`:``]}),e.lat==null&&(0,$.jsx)(`div`,{className:`meta`,children:`No recorded position, so it is not drawn on the map.`}),(0,$.jsx)(Hd,{sensor:e,manifest:t.manifest}),a?(0,$.jsx)(l_,{sensor:e}):(0,$.jsxs)(`section`,{className:`no-feed`,children:[(0,$.jsx)(`h3`,{children:`Live data`}),(0,$.jsxs)(`p`,{children:[`No live feed. `,e.statusGroup===`planned`?`This sensor is planned for COSZO; its data will appear here once it is deployed and publishing.`:`No public data service is known for this sensor.`]})]}),(0,$.jsx)(kd,{sensor:e}),(e.sources.length>0||e.corrections.length>0)&&(0,$.jsxs)(`section`,{className:`sources`,children:[(0,$.jsx)(`h3`,{children:`Sources`}),e.sources.map(e=>(0,$.jsx)(`a`,{href:e,target:`_blank`,rel:`noreferrer`,children:e},e)),e.corrections.map(e=>(0,$.jsxs)(`p`,{className:`correction`,children:[`Corrected in the atlas: `,e]},e))]})]})}function f_(e,t){let n=e.seafloor+50;if(e.seafloor<600||!e.column.length){let e=e=>e/n*t;return{y:e,ticks:p_(0,n,n>2e3?500:n>600?200:50).map(t=>({depth:t,y:e(t)})),breakAt:null}}let r=Math.max(300,e.seafloor-300),i=t*.3,a=t*.15,o=t-i-a,s=e=>e<=300?e/300*i:e<=r?i+(e-300)/Math.max(1,r-300)*a:i+a+(e-r)/(n-r)*o,c=[...p_(0,300,100),...p_(Math.ceil(r/100)*100,n,100)];return{y:s,ticks:[...new Set(c)].map(e=>({depth:e,y:s(e)})),breakAt:i+a/2}}var p_=(e,t,n)=>{let r=[];for(let i=e;i<=t;i+=n)r.push(i);return r};function m_(e,t,n=81){let r=1/Zl;return Array.from({length:n},(i,a)=>{let o=a/(n-1);return{x:o,depth:-t(e.lon-r+2*r*o,e.lat)}})}function h_(e,t){let n=Math.min(1,Math.max(0,t))*(e.length-1),r=Math.min(e.length-2,Math.floor(n));return e[r].depth+(e[r+1].depth-e[r].depth)*(n-r)}var g_=(e,t)=>!!e.depthRange||e.depth!=null&&e.depth<t-60,__=[.08,.92];function v_(e,t,n,r,i,a=null){let o=f_(e,i),s=[...t].sort((e,t)=>n[e.family]-n[t.family]||e.id.localeCompare(t.id)),c=r*__[0],l=r*__[1],u=s.length;return s.map((t,n)=>{let i=u===1?r/2:c+(l-c)*n/(u-1);if(t.depthRange&&t.depthRange[0]!==t.depthRange[1])return{id:t.id,family:t.family,x:i,y:o.y(t.depthRange[0]),y2:o.y(t.depthRange[1])};let s=t.depthRange?t.depthRange[0]:t.depth??null;return a&&a.length>1&&!g_(t,e.seafloor)?{id:t.id,family:t.family,x:i,y:o.y(Math.max(0,h_(a,i/r)))}:{id:t.id,family:t.family,x:i,y:o.y(s??e.seafloor)}})}var y_=408,b_=320,x_=36,S_=15,C_={min:14,max:32,tall:32,pad:12};function w_({site:e,bundle:t,elevAt:n,onSensor:r}){let[i,a]=(0,g.useState)(null),o=(0,g.useMemo)(()=>Object.fromEntries(t.families.map((e,t)=>[e.key,t])),[t]),s=e.sensorIds.map(e=>t.sensorById[e]),c=m_(e,n),l=f_(e,b_),u=v_(e,s,o,372,b_,c),d=u.length>1?Math.abs(u[1].x-u[0].x):C_.max,f=Math.min(C_.max,Math.max(C_.min,d)),p=`M `+c.map(e=>`${x_+e.x*372} ${l.y(Math.max(0,e.depth))}`).join(` L `)+` L ${y_} ${b_} L ${x_} ${b_} Z`;return(0,$.jsxs)(`figure`,{className:`depth-section`,"aria-label":`Depth cross-section of ${e.name}`,children:[(0,$.jsxs)(`svg`,{viewBox:`0 -10 ${y_} 338`,width:`100%`,children:[(0,$.jsx)(`line`,{x1:x_,x2:y_,y1:`0`,y2:`0`,className:`surface-line`}),l.ticks.map(e=>(0,$.jsxs)(`g`,{children:[(0,$.jsx)(`line`,{x1:32,x2:x_,y1:e.y,y2:e.y,className:`tick`}),(0,$.jsx)(`text`,{x:29,y:e.y+3,className:`tick-label mono`,children:e.depth.toLocaleString(`en-US`)})]},e.depth)),l.breakAt!=null&&(0,$.jsx)(`path`,{d:`M 28 ${l.breakAt-3} l 8 -3 M 28 ${l.breakAt+3} l 8 -3`,className:`axis-break`}),(0,$.jsx)(`path`,{d:p,className:`seafloor`,pathLength:`1`}),u.map(e=>{let n=t.sensorById[e.id],i=t.familyByKey[n.family],s=td(n.status),c={"--delay":`${500+o[n.family]*60}ms`},l=x_+e.x;return(0,$.jsxs)(`g`,{className:`sensor ${s}`,style:c,onMouseEnter:()=>a(e.id),onMouseLeave:()=>a(null),onClick:()=>r(e.id),children:[(0,$.jsx)(`rect`,{className:`hit`,x:l-f/2,width:f,y:e.y2==null?e.y-C_.tall/2:e.y-C_.pad,height:e.y2==null?C_.tall:e.y2-e.y+2*C_.pad}),e.y2!=null&&(0,$.jsx)(`line`,{x1:l,x2:l,y1:e.y,y2:e.y2,stroke:i.color,strokeWidth:`3`,opacity:s===`offline`?.3:.9}),(0,$.jsx)(`svg`,{className:`mark`,x:l-S_/2,y:e.y-S_/2,width:S_,height:S_,viewBox:`0 0 12 12`,overflow:`visible`,opacity:s===`offline`?.3:1,children:(0,$.jsx)(`g`,{stroke:i.color,strokeWidth:`1.6`,strokeDasharray:s===`unknown`?`2 1.5`:void 0,children:yd[i.glyph](s===`planned`||s===`unknown`?`none`:i.color)})})]},e.id)})]}),i&&(()=>{let e=t.sensorById[i];return(0,$.jsxs)(`figcaption`,{className:`ds-tip`,children:[(0,$.jsx)(`b`,{children:e.name}),` · `,e.type.replaceAll(`_`,` `),` · `,e.depthRange?$u(...e.depthRange):Qu(e.depth),` · `,ed(e.status),e.access.some(e=>[`erddap`,`earthscope`,`qaqc`,`pi_portal`].includes(e.kind))?` · live data`:``]})})()]})}function T_({label:e,eyebrow:t,title:n,sub:r,closeLabel:i,onClose:a,onBack:o,inDetail:s,minimized:c=!1,onMinimize:l,children:u}){return(0,g.useEffect)(()=>{let e=e=>{c||e.key!==`Escape`||e.target?.closest?.(`input, textarea`)||(s&&o?o():a())};return addEventListener(`keydown`,e),()=>removeEventListener(`keydown`,e)},[a,o,s,c]),c?(0,$.jsxs)(`div`,{className:`panel side-tab`,role:`region`,"aria-label":e,children:[(0,$.jsx)(`button`,{className:`restore`,"aria-expanded":`false`,title:`Show ${n}`,onClick:()=>l?.(!1),children:n}),(0,$.jsx)(`button`,{className:`close`,"aria-label":i,onClick:a,children:`×`})]}):(0,$.jsxs)(`aside`,{className:`panel side-panel`,"aria-label":e,children:[(0,$.jsxs)(`div`,{className:`sp-head`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`div`,{className:`eyebrow`,children:t}),(0,$.jsx)(`h2`,{children:n}),(0,$.jsx)(`div`,{className:`sub mono`,children:r})]}),(0,$.jsxs)(`div`,{className:`sp-actions`,children:[l&&(0,$.jsx)(md,{label:e,onClick:()=>l(!0)}),(0,$.jsx)(`button`,{className:`close`,"aria-label":i,onClick:a,children:`×`})]})]}),u]})}function E_({site:e,bundle:t,elevAt:n,onClose:r,onBack:i,onSensor:a,minimized:o,onMinimize:s,children:c}){let l=c!=null&&c!==!1,u=e.sensorIds.map(e=>t.sensorById[e]),d=[t.regions.find(t=>t.key===e.region)?.label,e.label===e.name?null:e.label].filter(Boolean).join(` · `);return(0,$.jsx)(T_,{label:`${e.label} site`,eyebrow:d,title:e.name,closeLabel:`Close site panel`,sub:`${u.length} sensors · seafloor ${Qu(e.seafloor)}`,onClose:r,onBack:i,inDetail:l,minimized:o,onMinimize:s,children:l?c:(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(w_,{site:e,bundle:t,elevAt:n,onSensor:a}),t.families.map(e=>{let t=u.filter(t=>t.family===e.key);return t.length?(0,$.jsxs)(`section`,{className:`sp-family`,children:[(0,$.jsxs)(`h3`,{children:[(0,$.jsx)(bd,{glyph:e.glyph,color:e.color}),` `,e.label]}),t.map(e=>(0,$.jsxs)(`button`,{className:`sp-row`,onClick:()=>a(e.id),"aria-label":`${e.name}, ${ed(e.status)}`,children:[(0,$.jsx)(`span`,{className:`nm`,children:e.name}),(0,$.jsxs)(`span`,{className:`mono d`,children:[ed(e.status),` · `,e.depthRange?$u(...e.depthRange):Qu(e.depth)]})]},e.id))]},e.key):null}),e.unlocatedIds.length>0&&(0,$.jsxs)(`section`,{className:`sp-family`,children:[(0,$.jsx)(`h3`,{children:`Also at this site`}),e.unlocatedIds.map(e=>t.sensorById[e]).filter(Boolean).map(e=>(0,$.jsxs)(`button`,{className:`sp-row`,onClick:()=>a(e.id),"aria-label":`${e.name}, location not recorded`,children:[(0,$.jsx)(`span`,{className:`nm`,children:e.name}),(0,$.jsx)(`span`,{className:`d`,children:`location not recorded`})]},e.id))]})]})})}function D_({bundle:e,onClose:t,onBack:n,onSensor:r,minimized:i,onMinimize:a,children:o}){let s=o!=null&&o!==!1,c=e.unplaced.map(t=>e.sensorById[t]).filter(Boolean);return(0,$.jsx)(T_,{label:`Unplaced sensors`,eyebrow:`Not on the map`,title:`Unplaced sensors`,closeLabel:`Close unplaced sensors`,sub:`${c.length} sensor${c.length===1?``:`s`} · no recorded position`,onClose:t,onBack:n,inDetail:s,minimized:i,onMinimize:a,children:s?o:(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`p`,{className:`sp-note`,children:`These sensors have no usable position and name no catalogued site, so the map cannot draw them.`}),e.families.map(e=>{let t=c.filter(t=>t.family===e.key);return t.length?(0,$.jsxs)(`section`,{className:`sp-family`,children:[(0,$.jsxs)(`h3`,{children:[(0,$.jsx)(bd,{glyph:e.glyph,color:e.color}),` `,e.label]}),t.map(e=>(0,$.jsxs)(`button`,{className:`sp-row`,onClick:()=>r(e.id),"aria-label":`${e.name}, ${ed(e.status)}, no recorded position`,children:[(0,$.jsx)(`span`,{className:`nm`,children:e.name}),(0,$.jsx)(`span`,{className:`mono d`,children:ed(e.status)})]},e.id))]},e.key):null})]})})}var O_={chat:412,side:472,none:16},k_=(e,t,n)=>e-(t?O_.chat:O_.none)-(n?O_.side:O_.none)<580;function A_(e,t){let n=[e,...[...t?.children??[]].filter(e=>!e.classList.contains(`legend`))];return Math.max(0,...n.filter(Boolean).map(e=>e.getBoundingClientRect().bottom))}var j_=6371.0088,M_=e=>e*Math.PI/180;function N_(e,t,n,r){let i=Math.sin(M_(r-t)/2)**2+Math.cos(M_(t))*Math.cos(M_(r))*Math.sin(M_(n-e)/2)**2;return 2*j_*Math.asin(Math.min(1,Math.sqrt(i)))}function P_(e,t,n,r=30){return e.map(e=>({site:e,km:N_(t,n,e.lon,e.lat)})).filter(e=>e.km<=r).sort((e,t)=>e.km-t.km)}var F_={charted:`Charted route, traced from the NOAA/BOEM Marine Cadastre cable protection zone (public domain, not for navigation).`,approximate:`Approximate route. No public chart exists beyond the US Exclusive Economic Zone, so this is drawn straight between known points and could be off by a few km.`,mapped:`Mapped route from ooi_cables.csv (M. Kidiwela, CascadiaEarthquakes). It matches the NOAA/BOEM chart within metres where both exist; beyond the US EEZ its points are sparse.`},I_=14,L_=12,R_={charted:`OOI mariner safety notices and COSZO cruise records, on the charted cable route`,approximate:`no published node coordinates; placed from OOI records`};function z_({node:e,bundle:t}){let n=P_(t.sites,e.lon,e.lat,30),r=e.source??R_[e.accuracy]??`OOI records`;return(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`t-name`,children:e.name}),(0,$.jsx)(`div`,{className:`t-sub`,children:e.description}),(0,$.jsxs)(`div`,{className:`t-list`,children:[(0,$.jsx)(`div`,{className:`t-head`,children:`Catalogued sites within 30 km`}),n.length===0&&(0,$.jsx)(`div`,{className:`t-none`,children:`None.`}),n.slice(0,L_).map(({site:e,km:t})=>(0,$.jsxs)(`div`,{className:`t-site`,children:[(0,$.jsx)(`span`,{title:e.name,children:e.label}),(0,$.jsxs)(`span`,{className:`d mono`,children:[e.sensorIds.length,` sensor`,e.sensorIds.length===1?``:`s`,` · `,t<10?t.toFixed(1):Math.round(t),` km`]})]},e.id))]}),n.length>L_&&(0,$.jsxs)(`div`,{className:`t-more`,children:[`+`,n.length-L_,` more within 30 km.`]}),(0,$.jsxs)(`div`,{className:`t-more`,children:[`Position `,e.accuracy,`. Source: `,r,`.`,e.note?` ${e.note}`:``]})]})}function B_({site:e,bundle:t}){let n=t.familyByKey,r=e.sensorIds.map(e=>t.sensorById[e]),i=t.families.map(e=>[e,r.filter(t=>t.family===e.key).length]).filter(([,e])=>e),a=[],o=0;for(let t of e.parts){let i=r.filter(n=>(n.location??e.name)===t).slice(0,I_-o);if(i.length){e.parts.length>1&&a.push((0,$.jsx)(`div`,{className:`t-head`,children:t},`h-${t}`));for(let e of i)a.push((0,$.jsxs)(`div`,{className:`t-item`,children:[(0,$.jsx)(bd,{glyph:n[e.family].glyph,color:n[e.family].color}),(0,$.jsx)(`span`,{title:e.name,children:e.name}),(0,$.jsxs)(`span`,{className:`d mono`,children:[ed(e.status),` · `,e.depthRange?$u(...e.depthRange):Qu(e.depth)]})]},e.id));o+=i.length}}let s=r.length-o,c=e.unlocatedIds.length;return(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`t-name`,children:e.name}),(0,$.jsxs)(`div`,{className:`t-sub`,children:[r.length,` sensor`,r.length===1?``:`s`,` · seafloor `,Qu(e.seafloor),` · `,i.map(([e,t])=>`${t} ${e.label.toLowerCase()}`).join(`, `)]}),e.column.length>0&&(0,$.jsx)(`div`,{className:`t-col`,children:e.column.map(e=>(0,$.jsxs)(`span`,{children:[(0,$.jsx)(`b`,{children:e.kind}),` `,$u(e.a,e.b),` `]},e.kind))}),(0,$.jsx)(`div`,{className:`t-list`,children:a}),s>0&&(0,$.jsxs)(`div`,{className:`t-more`,children:[`+`,s,` more. Click to open the depth section.`]}),c>0&&(0,$.jsxs)(`div`,{className:`t-more`,children:[c,` more sensor`,c>1?`s have`:` has`,` no recorded position.`]})]})}function V_({hover:e,bundle:t}){let n=(0,g.useRef)(null);if((0,g.useLayoutEffect)(()=>{let t=n.current;if(!t||!e)return;let r=t.offsetHeight,i=e.y+18+r<=innerHeight-8;t.style.top=`${i?Math.min(e.y+18,innerHeight-240):Math.max(8,e.y-18-r)}px`}),!e)return null;let{kind:r,item:i,x:a,y:o}=e,s={left:Math.min(a+18,innerWidth-400),top:Math.min(o+18,innerHeight-240)};return(0,$.jsxs)(`div`,{ref:n,className:`tip`,style:s,role:`tooltip`,children:[r===`site`&&(0,$.jsx)(B_,{site:i,bundle:t}),r===`node`&&(0,$.jsx)(z_,{node:i,bundle:t}),r===`cable`&&(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`t-name`,children:i.kind}),(0,$.jsxs)(`div`,{className:`t-sub`,children:[i.route,i.lengthKm?` · ${Math.round(i.lengthKm)} km`:``]}),(0,$.jsx)(`div`,{className:`t-col`,children:F_[i.accuracy]}),t.sensors.some(e=>e.family===`fiber`&&e.lat==null)&&(0,$.jsxs)(`div`,{className:`t-col`,children:[`Fiber-optic sensing experiments on the cable (exact positions not recorded): `,t.sensors.filter(e=>e.family===`fiber`&&e.lat==null).map(e=>e.name).join(`; `),`.`]}),(0,$.jsx)(`div`,{className:`t-more`,children:`Two backbone cables run from the Pacific City shore station: the south line to Hydrate Ridge and the Oregon shelf, the north line past the Mid-Plate node to Axial Seamount.`})]})]})}function H_({site:e,sensor:t}={}){return t?[`What does a ${t.type.replaceAll(`_`,` `)} measure?`,`What research has used ${t.name}?`,`How do I download data from ${t.name}?`]:e?[`What research has used data from ${e.name}?`,`What is measured at ${e.name}?`,`What happened at ${e.name} recently?`]:[`What is COSZO?`,`Which sites have the most sensors?`,`Where can I download seismic data?`]}var U_=`atlas.chat.open`,W_=()=>localStorage.getItem(U_)!==`false`;function G_({selection:e,onOpenChange:t}){let[n,r]=(0,g.useState)(W_),[i,a]=(0,g.useState)([]),[o,s]=(0,g.useState)(``),[c,l]=(0,g.useState)(!1),u=(0,g.useRef)(null);(0,g.useLayoutEffect)(()=>{localStorage.setItem(U_,String(n));let e=document.documentElement.style;e.setProperty(`--left-inset`,n?`412px`:`16px`),e.setProperty(`--strip-reserve`,n?`0px`:`132px`),t?.(n)},[n,t]),(0,g.useEffect)(()=>{u.current?.scrollIntoView?.({block:`end`})},[i]);let d=async e=>{let t=e.trim();if(t.length<2||c)return;a(e=>[...e,{role:`user`,text:t}]),s(``),l(!0);let n=await zd(t);l(!1),a(e=>[...e,n.ok?{role:`assistant`,text:n.data.answer,citations:n.data.citations}:{role:`error`,text:`The chat is unavailable right now (${String(n.message??`no reason given`).trim().replace(/[.\s]+$/,``)}). The map still works.`}])};return n?(0,$.jsxs)(`aside`,{className:`panel chat`,"aria-label":`Atlas chat`,children:[(0,$.jsxs)(`div`,{className:`chat-head`,children:[(0,$.jsx)(`span`,{className:`eyebrow`,children:`Ask the Atlas`}),(0,$.jsx)(`button`,{"aria-label":`Minimize chat`,onClick:()=>r(!1),children:`–`})]}),(0,$.jsxs)(`div`,{className:`chat-log`,"aria-live":`polite`,children:[i.length===0&&(0,$.jsx)(`p`,{className:`muted`,children:`Questions are answered from the RCA and COSZO corpus, with sources.`}),i.map((e,t)=>(0,$.jsxs)(`div`,{className:`msg ${e.role}`,children:[(0,$.jsx)(`p`,{children:e.text}),e.citations?.length>0&&(0,$.jsx)(`ol`,{className:`cites`,children:e.citations.map((e,t)=>(0,$.jsx)(`li`,{children:e.url?(0,$.jsx)(`a`,{href:e.url,target:`_blank`,rel:`noreferrer`,children:e.title}):e.title},e.id??`c${t}`))})]},t)),c&&(0,$.jsx)(`p`,{className:`muted`,children:`Thinking…`}),(0,$.jsx)(`div`,{ref:u})]}),(0,$.jsx)(`div`,{className:`chips`,children:H_(e).map(e=>(0,$.jsx)(`button`,{onClick:()=>d(e),children:e},e))}),(0,$.jsxs)(`form`,{className:`chat-input`,onSubmit:e=>{e.preventDefault(),d(o)},children:[(0,$.jsx)(`textarea`,{"aria-label":`Ask a question`,rows:`2`,value:o,onChange:e=>s(e.target.value),onKeyDown:e=>{e.key===`Enter`&&!e.shiftKey&&!e.nativeEvent.isComposing&&(e.preventDefault(),d(o))}}),(0,$.jsx)(`button`,{type:`submit`,disabled:c,children:`Send`})]})]}):(0,$.jsx)(`button`,{className:`chat-tab panel`,"aria-label":`Open chat`,onClick:()=>r(!0),children:`Ask the Atlas`})}function K_(){let[e,t]=(0,g.useState)(null),[n,r]=(0,g.useState)(null);return(0,g.useEffect)(()=>{C().then(t,r)},[]),n?(0,$.jsx)(`div`,{className:`app-message`,role:`alert`,children:(0,$.jsxs)(`div`,{children:[n instanceof x?`The atlas data bundle has not been built yet.`:n.message,n instanceof x&&(0,$.jsx)(`code`,{children:`PYTHONPATH=src .venv/bin/python -m atlas_map_data.build_atlas_bundle`})]})}):e?(0,$.jsx)(q_,{bundle:e,onError:r}):(0,$.jsx)(`div`,{className:`app-message`,children:`Loading the atlas…`})}function q_({bundle:e,onError:t}){let n=(0,g.useRef)(null),r=(0,g.useRef)(null),i=(0,g.useRef)(null),a=(0,g.useRef)(null),o=(0,g.useRef)(null),[s,c]=(0,g.useState)(null),[l,u]=(0,g.useState)(`overview`),[d,f]=(0,g.useState)(new Set),[p,m]=(0,g.useState)(null),[h,_]=(0,g.useState)(null),[v,y]=(0,g.useState)(null),[b,x]=(0,g.useState)(!1),[S,C]=(0,g.useState)(!1),[w,T]=(0,g.useState)(W_),[E,D]=(0,g.useState)(innerWidth),[O,k]=(0,g.useState)(!1);(0,g.useEffect)(()=>{let e=()=>D(innerWidth);return addEventListener(`resize`,e),()=>removeEventListener(`resize`,e)},[]);let A=(0,g.useCallback)(e=>{_(e.id),x(!1),y(null),C(!1),m(null),i.current?.setSelected(e.id)},[]),j=(0,g.useCallback)((e,t)=>{A(e),t.flyToPoint(e.lon,e.lat,6)},[A]),M=(0,g.useCallback)(()=>{_(null),y(null),i.current?.setSelected(null)},[]),ee=(0,g.useCallback)(()=>{M(),x(!0),C(!1)},[M]),N=(0,g.useCallback)(()=>{x(!1),y(null)},[]),te=(0,g.useCallback)((t,n)=>{let r=e.sensorById[t],i=r&&e.siteById[r.site];return r?(i&&r.lat!=null?j(i,n):i?A(i):ee(),y(t),!0):!1},[e,j,A,ee]),ne=(0,g.useCallback)((t,n)=>{u(t),n.flyTo(n.fit(t===`overview`?e.overview:e.regions.find(e=>e.key===t).view))},[e]);(0,g.useEffect)(()=>{let a,o,s=!1;return ou(e.terrainMeta).then(async t=>{if(s||(a=new Ku(n.current,e,t),await a.ready,s))return;a.addCable(e.cable),a.addMoorings(e.sites);let l=e=>({x:e.clientX,y:e.clientY});o=new dd(r.current,e,a,{onRegionClick:e=>ne(e,a),onSiteClick:e=>j(e,a),onSiteHover:(e,t)=>m(t?{kind:`site`,item:e,...l(t)}:null),onNodeHover:(e,t)=>m(t?{kind:`node`,item:e,...l(t)}:null),onNodeClick:e=>a.flyToPoint(e.lon,e.lat,30),onCableHover:(e,t)=>m(n=>t?{kind:`cable`,item:e,...l(t)}:n?.kind===`cable`?null:n)}),i.current=o,a.onFrame=()=>o.update(),window.__atlas={scene:a,layer:o,flyTo:e=>a.flyTo(e),lod:()=>a.auv?.stats(),open:t=>e.sensorById[t]?te(t,a):e.siteById[t]?(j(e.siteById[t],a),!0):!1},c(a)}).catch(e=>{s||t?.(e)}),()=>{s=!0,o?.dispose(),a?.dispose()}},[e,j,te,ne,t]),(0,g.useEffect)(()=>{s&&(i.current?.setFocus(d),s.setMute(d.size?.55:0))},[d,s]);let re=(!!h||b)&&!S,P=k_(E,w,re);(0,g.useLayoutEffect)(()=>{let e=document.documentElement.style;e.setProperty(`--right-inset`,`${re?O_.side:O_.none}px`),e.setProperty(`--side-reserve`,S?`284px`:`0px`)},[re,S]),(0,g.useLayoutEffect)(()=>{let e=a.current,t=o.current;if(!s||!e)return;let n=document.querySelector(`.families`),r=e.parentElement,i=()=>s.setInsetsY(A_(e,t),n?innerHeight-n.getBoundingClientRect().top:O_.none);i();let c=new ResizeObserver(i);for(let i of[e,t,r,n])i&&c.observe(i);return addEventListener(`resize`,i),()=>{c.disconnect(),removeEventListener(`resize`,i)}},[s]),(0,g.useLayoutEffect)(()=>{if(!s)return;let t=!s.framed;s.setInsets(w?O_.chat:O_.none,re?O_.side:O_.none,t),t&&s.jumpTo(s.fit(e.overview))},[s,w,re,e]);let F=h?e.siteById[h]:null,ie=v?e.sensorById[v]:null,I=t=>ie&&(0,$.jsx)(d_,{sensor:ie,bundle:e,backLabel:t,onBack:()=>y(null)},v);return(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`canvas`,{ref:n,className:`atlas-scene`,"aria-label":`3D map of the seafloor off Oregon`}),(0,$.jsx)(`div`,{id:`atlas-overlay`,ref:r}),s&&(0,$.jsxs)($.Fragment,{children:[(0,$.jsxs)(`div`,{className:`hud-top`,children:[(0,$.jsxs)(`div`,{className:`left-stack`,ref:a,children:[(0,$.jsx)(wd,{bundle:e,onPick:t=>t.kind===`site`?j(e.siteById[t.id],s):te(t.id,s)}),(0,$.jsx)(Ed,{regions:e.regions,sensors:e.sensors,active:l,onSelect:e=>ne(e,s),unplaced:e.unplaced?.length??0,unplacedOpen:b,onUnplaced:()=>b?N():ee()})]}),(0,$.jsxs)(`div`,{className:`right-stack${P?` compact`:``}`,ref:o,children:[(0,$.jsx)(vd,{scene:s,compact:P,deep:O,onDeep:k}),(0,$.jsx)(Td,{credit:e.terrainMeta.credit,compact:re||P,auv:!!s.auv,subsurface:O?s.subsurface?.credit:null})]})]}),(0,$.jsx)(Dd,{credit:e.terrainMeta.credit,auv:!!s.auv,subsurface:O}),(0,$.jsx)(xd,{families:e.families,sensors:e.sensors,focus:d,onChange:f}),(0,$.jsx)(V_,{hover:p,bundle:e}),(0,$.jsx)(G_,{selection:{site:F,sensor:ie},onOpenChange:T}),F&&(0,$.jsx)(E_,{site:F,bundle:e,elevAt:s.elevAt,onClose:M,onBack:()=>y(null),onSensor:y,minimized:S,onMinimize:C,children:I(F.label)},h),!F&&b&&(0,$.jsx)(D_,{bundle:e,onClose:N,onBack:()=>y(null),onSensor:y,minimized:S,onMinimize:C,children:I(`Unplaced sensors`)})]})]})}(0,_.createRoot)(document.getElementById(`root`)).render((0,$.jsx)(K_,{}));