...
df = e.to_pandas()   # ${t.name}`};if(e.kind===`earthscope`){let t=e.channel??`HHZ`,r=e=>e.toISOString().slice(0,19),i=new Date(Math.floor(n.getTime()/1e3)*1e3);return{label:`FDSN dataselect (MiniSEED, the last hour, UTC)`,code:`curl -o ${e.network}.${e.station}.mseed "https://service.earthscope.org/fdsnws/dataselect/1/query?net=${e.network}&sta=${e.station}&cha=${t}&loc=--&starttime=${r(new Date(i.getTime()-36e5))}&endtime=${r(i)}"`}}return e.kind===`pi_portal`?{label:`List files`,code:`curl -s "${e.url}"`}:null}function Od({sensor:e}){let[t,n]=(0,g.useState)(null);return e.access.length?(0,$.jsxs)(`section`,{className:`gtd`,children:[(0,$.jsx)(`h3`,{children:`Get this data`}),e.access.map((r,i)=>{let a=Dd(r,e);return(0,$.jsxs)(`div`,{className:`route`,children:[(0,$.jsx)(`a`,{href:r.url,target:`_blank`,rel:`noreferrer`,children:r.label}),(0,$.jsx)(`p`,{children:r.how}),a&&(0,$.jsxs)(`div`,{className:`snippet`,children:[(0,$.jsxs)(`div`,{className:`snip-head`,children:[(0,$.jsx)(`span`,{children:a.label}),(0,$.jsx)(`button`,{onClick:()=>{navigator.clipboard?.writeText(a.code),n(i)},children:t===i?`Copied`:`Copy`})]}),(0,$.jsx)(`pre`,{className:`mono`,children:a.code})]})]},i)})]}):(0,$.jsxs)(`section`,{className:`gtd`,children:[(0,$.jsx)(`h3`,{children:`Get this data`}),(0,$.jsx)(`p`,{className:`muted`,children:`No access route is documented for this sensor yet.`})]})}var kd={404:`notfound`,422:`bad`,502:`upstream`,503:`busy`,504:`timeout`},Ad=`https://rca-atlas.quakehunt.workers.dev`,jd=`${Ad}/v1/live`;async function Md(e,{signal:t,method:n=`GET`,body:r,fetchImpl:i=fetch}={}){let a;try{a=await i(`${jd}${e}`,{signal:t,method:n,headers:r?{"Content-Type":`application/json`}:void 0,body:r?JSON.stringify(r):void 0})}catch(e){if(e?.name===`AbortError`)throw e;return{ok:!1,kind:`unreachable`,source:`gateway`,message:`The live data service is not running.`}}let o;try{o=await a.json()}catch{o=null}return a.ok?{ok:!0,data:o}:o?.error?{ok:!1,kind:kd[a.status]??`upstream`,source:o.error.source,message:o.error.message}:{ok:!1,kind:`unreachable`,source:`gateway`,message:`The live data service is not running.`}}var Nd=e=>new URLSearchParams(Object.entries(e).filter(([,e])=>e!=null&&e!==``)).toString(),Pd=(e,t)=>Md(`/status/${encodeURIComponent(e)}`,t),Fd=(e,t)=>Md(`/series/${encodeURIComponent(e)}/variables`,t),Id=(e,t,n)=>Md(`/series/${encodeURIComponent(e)}?${Nd(t)}`,n),Ld=(e,t)=>Md(`/plots/${encodeURIComponent(e)}`,t),Rd=(e,t,n,r)=>Md(`/waveform/${e}?${Nd({minutes:t,channel:n})}`,r),zd=(e,t,n)=>Md(`/waveform/${e}/health?${Nd({channel:t})}`,n),Bd=(e,t,n,r)=>Md(`/files/${encodeURIComponent(e)}?${Nd({endpoint:t,path:n})}`,r);async function Vd(e,{signal:t,fetchImpl:n=fetch}={}){let r;try{r=await n(`${Ad}/v1/answer`,{method:`POST`,signal:t,headers:{"Content-Type":`application/json`},body:JSON.stringify({query:e,answer_mode:`evidence`})})}catch(e){if(e?.name===`AbortError`)throw e;return{ok:!1,kind:`unreachable`,source:`RCA Atlas`,message:`The Graph-RAG service is unavailable.`}}let i=await r.json().catch(()=>({}));return!r.ok||!i.answer?{ok:!1,kind:kd[r.status]??`upstream`,source:`RCA Atlas`,message:i.error||`The Graph-RAG service is unavailable.`}:{ok:!0,data:{answer:i.answer,citations:i.answer_citations||[]}}}var Hd=e=>({key:e,state:e?`loading`:`idle`,data:null,error:null});function Ud(e,t){let[n,r]=(0,g.useState)(()=>Hd(e)),[i,a]=(0,g.useState)(0);(0,g.useEffect)(()=>{if(r(Hd(e)),!e)return;let n=!0,i=new AbortController;return t({signal:i.signal}).then(t=>{n&&r(t.ok?{key:e,state:`ok`,data:t.data,error:null}:{key:e,state:`error`,data:null,error:t})},t=>{n&&t?.name!==`AbortError`&&r({key:e,state:`error`,data:null,error:{kind:`unreachable`,source:`gateway`,message:String(t)}})}),()=>{n=!1,i.abort()}},[e,i]);let o=(0,g.useCallback)(()=>a(e=>e+1),[]),{key:s,...c}=n.key===e?n:Hd(e);return{...c,retry:o}}function Wd({sensor:e,manifest:t}){let n=Ud(e.refdes?`status:${e.refdes}`:null,t=>Pd(e.refdes,t)),r=e.refdes?null:e.access.find(e=>e.kind===`earthscope`),i=Ud(r?`wave-health:${r.network}.${r.station}:${r.channel}`:null,e=>zd(`${r.network}.${r.station}`,r.channel,e)),a=`${$u(e.status)}${e.statusSource?` · ${e.statusSource}`:``}`;if(r)return i.state===`idle`||i.state===`loading`?(0,$.jsx)(`div`,{className:`live-status`,children:`Checking recent EarthScope waveform…`}):i.state===`ok`?(0,$.jsxs)(`div`,{className:`live-status`,children:[i.data.recording?`Waveform available`:`No waveform in the recent window`,` · EarthScope checked live`]}):i.error.kind===`unreachable`?(0,$.jsxs)(`div`,{className:`live-status degraded`,children:[`EarthScope live check unavailable `,(0,$.jsx)(`button`,{onClick:i.retry,children:`Retry`})]}):(0,$.jsxs)(`div`,{className:`live-status degraded`,children:[`EarthScope: `,i.error.message,` `,(0,$.jsx)(`button`,{onClick:i.retry,children:`Retry`})]});if(!e.refdes||n.state===`idle`)return(0,$.jsx)(`div`,{className:`live-status`,children:a});if(n.state===`loading`)return(0,$.jsxs)(`div`,{className:`live-status`,children:[a,` · checking live…`]});if(n.state===`ok`){let e=n.data,t=!e.evidenceMode||e.evidenceMode===`live`?`checked live`:e.evidenceMode===`snapshot`?`from Nereus snapshot`:`from Nereus (${e.evidenceMode})`;return(0,$.jsxs)(`div`,{className:`live-status`,children:[$u(e.status??`UNKNOWN`),` · `,t,e.data?.checkedAt?`, data ${e.data.code} at ${new Date(e.data.checkedAt).toUTCString().slice(17,22)} UTC`:``]})}return n.error.kind===`unreachable`?(0,$.jsxs)(`div`,{className:`live-status degraded`,children:[(0,$.jsxs)(`span`,{children:[`Live data unavailable. Showing snapshot from `,td(e.statusAsOf??t?.corpusSnapshot),`.`]}),(0,$.jsx)(`button`,{onClick:n.retry,children:`Retry`})]}):n.error.kind===`notfound`?(0,$.jsxs)(`div`,{className:`live-status`,children:[a,` · `,n.error.source===`Nereus`?`not tracked live by Nereus`:`${n.error.source}: ${n.error.message}`]}):(0,$.jsxs)(`div`,{className:`live-status degraded`,children:[a,` · `,n.error.source,` failed: `,n.error.message,` `,(0,$.jsx)(`button`,{onClick:n.retry,children:`Retry`})]})}function Gd({error:e,retry:t}){return(0,$.jsxs)(`p`,{className:`degraded`,children:[e.kind===`unreachable`?`Live data unavailable: the live data service is not running.`:`${e.source}: ${e.message}`,(0,$.jsx)(`button`,{onClick:t,children:`Retry`})]})}function Kd({route:e}){let[t,n]=(0,g.useState)(``),r=Ud(`files:${e.instrumentKey}:${e.endpointId}:${t}`,n=>Bd(e.instrumentKey,e.endpointId,t,n)),i=t.split(`/`).filter(Boolean).slice(0,-1).join(`/`);return(0,$.jsxs)(`div`,{className:`files`,children:[(0,$.jsxs)(`div`,{className:`mono crumbs`,children:[e.label,` / `,t||``,t&&(0,$.jsx)(`button`,{onClick:()=>n(i?`${i}/`:``),children:`Up`})]}),r.state===`loading`&&(0,$.jsx)(`p`,{className:`muted`,children:`Listing files…`}),r.state===`error`&&(0,$.jsx)(Gd,{error:r.error,retry:r.retry}),r.state===`ok`&&(0,$.jsxs)(`ul`,{children:[r.data.entries.map(e=>(0,$.jsx)(`li`,{children:e.kind===`directory`?(0,$.jsxs)(`button`,{onClick:()=>n(e.path),children:[e.name,`/`]}):(0,$.jsx)(`a`,{href:e.url,target:`_blank`,rel:`noreferrer`,children:e.name})},e.path)),r.data.message?(0,$.jsx)(`li`,{className:`muted`,children:r.data.message}):r.data.truncated&&(0,$.jsx)(`li`,{className:`muted`,children:`Showing the newest 200 entries.`})]})]})}function qd({refdes:e}){let t=Ud(`plots:${e}`,t=>Ld(e,t)),[n,r]=(0,g.useState)(null);if(t.state===`loading`)return(0,$.jsx)(`p`,{className:`muted`,children:`Loading recent plots…`});if(t.state===`error`)return(0,$.jsx)(Gd,{error:t.error,retry:t.retry});let i=[...new Set(t.data.plots.map(e=>e.variable))];if(!i.length)return(0,$.jsx)(`p`,{className:`muted`,children:`The RCA QA/QC site has no recent plots for this sensor.`});let a=n??i[0],o=t.data.plots.filter(e=>e.variable===a).slice(0,4);return(0,$.jsxs)(`div`,{className:`plots`,children:[(0,$.jsx)(`select`,{"aria-label":`Plotted variable`,value:a,onChange:e=>r(e.target.value),children:i.map(e=>(0,$.jsx)(`option`,{children:e},e))}),o.map(e=>(0,$.jsxs)(`figure`,{children:[(0,$.jsx)(`img`,{src:e.url,alt:`${a}, ${e.timeSpan}`,loading:`lazy`}),(0,$.jsxs)(`figcaption`,{children:[e.timeSpan,` · `,e.dataRange]})]},e.url))]})}var Jd=!0,Yd=`uplot`,Xd=`u-hz`,Zd=`u-vt`,Qd=`u-title`,$d=`u-wrap`,ef=`u-under`,tf=`u-over`,nf=`u-axis`,rf=`u-off`,af=`u-select`,of=`u-cursor-x`,sf=`u-cursor-y`,cf=`u-cursor-pt`,lf=`u-legend`,uf=`u-live`,df=`u-inline`,ff=`u-series`,pf=`u-marker`,mf=`u-label`,hf=`u-value`,gf=`width`,_f=`height`,vf=`top`,yf=`bottom`,bf=`left`,xf=`right`,Sf=`#000`,Cf=`#0000`,wf=`mousemove`,Tf=`mousedown`,Ef=`mouseup`,Df=`mouseenter`,Of=`mouseleave`,kf=`dblclick`,Af=`resize`,jf=`scroll`,Mf=`change`,Nf=`dppxchange`,Pf=`--`,Ff=typeof window<`u`,If=Ff?document:null,Lf=Ff?window:null,Rf=Ff?navigator:null,zf,Bf;function Vf(){let e=devicePixelRatio;zf!=e&&(zf=e,Bf&&np(Mf,Bf,Vf),Bf=matchMedia(`(min-resolution: ${zf-.001}dppx) and (max-resolution: ${zf+.001}dppx)`),tp(Mf,Bf,Vf),Lf.dispatchEvent(new CustomEvent(Nf)))}function Hf(e,t){if(t!=null){let n=e.classList;!n.contains(t)&&n.add(t)}}function Uf(e,t){let n=e.classList;n.contains(t)&&n.remove(t)}function Wf(e,t,n){e.style[t]=n+`px`}function Gf(e,t,n,r){let i=If.createElement(e);return t!=null&&Hf(i,t),n?.insertBefore(i,r),i}function Kf(e,t){return Gf(`div`,e,t)}var qf=new WeakMap;function Jf(e,t,n,r,i){let a=`translate(`+t+`px,`+n+`px)`;a!=qf.get(e)&&(e.style.transform=a,qf.set(e,a),t<0||n<0||t>r||n>i?Hf(e,rf):Uf(e,rf))}var Yf=new WeakMap;function Xf(e,t,n){let r=t+n;r!=Yf.get(e)&&(Yf.set(e,r),e.style.background=t,e.style.borderColor=n)}var Zf=new WeakMap;function Qf(e,t,n,r){let i=t+``+n;i!=Zf.get(e)&&(Zf.set(e,i),e.style.height=n+`px`,e.style.width=t+`px`,e.style.marginLeft=r?-t/2+`px`:0,e.style.marginTop=r?-n/2+`px`:0)}var $f={passive:!0},ep={...$f,capture:!0};function tp(e,t,n,r){t.addEventListener(e,n,r?ep:$f)}function np(e,t,n,r){t.removeEventListener(e,n,$f)}Ff&&Vf();function rp(e,t,n,r){let i;n||=0,r||=t.length-1;let a=r<=2147483647;for(;r-n>1;)i=a?n+r>>1:Tp((n+r)/2),t[i]<e?n=i:r=i;return e-t[n]<=t[r]-e?n:r}function ip(e){return(t,n,r)=>{let i=-1,a=-1;for(let a=n;a<=r;a++)if(e(t[a])){i=a;break}for(let i=r;i>=n;i--)if(e(t[i])){a=i;break}return[i,a]}}var ap=e=>e!=null,op=e=>e!=null&&e>0,sp=ip(ap),cp=ip(op);function lp(e,t,n,r=0,i=!1){let a=i?cp:sp,o=i?op:ap;[t,n]=a(e,t,n);let s=e[t],c=e[t];if(t>-1){if(r==1)s=e[t],c=e[n];else if(r==-1)s=e[n],c=e[t];else for(let r=t;r<=n;r++){let t=e[r];o(t)&&(t<s?s=t:t>c&&(c=t))}}return[s??Ip,c??-Ip]}function up(e,t,n,r){let i=jp(e),a=jp(t);e==t&&(i==-1?(e*=n,t/=n):(e/=n,t*=n));let o=n==10?Mp:Np,s=i==1?Tp:Dp,c=a==1?Dp:Tp,l=s(o(wp(e))),u=c(o(wp(t))),d=Ap(n,l),f=Ap(n,u);return n==10&&(l<0&&(d=Qp(d,-l)),u<0&&(f=Qp(f,-u))),r||n==2?(e=d*i,t=f*a):(e=Zp(e,d),t=Xp(t,f)),[e,t]}function dp(e,t,n,r){let i=up(e,t,n,r);return e==0&&(i[0]=0),t==0&&(i[1]=0),i}var fp=.1,pp={mode:3,pad:fp},mp={pad:0,soft:null,mode:0},hp={min:mp,max:mp};function gp(e,t,n,r){return lm(n)?yp(e,t,n):(mp.pad=n,mp.soft=r?0:null,mp.mode=r?3:0,yp(e,t,hp))}function _p(e,t){return e??t}function vp(e,t,n){for(t=_p(t,0),n=_p(n,e.length-1);t<=n;){if(e[t]!=null)return!0;t++}return!1}function yp(e,t,n){let r=n.min,i=n.max,a=_p(r.pad,0),o=_p(i.pad,0),s=_p(r.hard,-Ip),c=_p(i.hard,Ip),l=_p(r.soft,Ip),u=_p(i.soft,-Ip),d=_p(r.mode,0),f=_p(i.mode,0),p=t-e,m=Mp(p),h=kp(wp(e),wp(t)),g=wp(Mp(h)-m);(p<1e-24||g>10)&&(p=0,(e==0||t==0)&&(p=1e-24,d==2&&l!=Ip&&(a=0),f==2&&u!=-Ip&&(o=0)));let _=p||h||1e3,v=Ap(10,Tp(Mp(_))),y=Qp(Zp(e-_*(p==0?e==0?.1:1:a),v/10),24),b=e>=l&&(d==1||d==3&&y<=l||d==2&&y>=l)?l:Ip,x=kp(s,y<b&&e>=b?b:Op(b,y)),S=Qp(Xp(t+_*(p==0?t==0?.1:1:o),v/10),24),C=t<=u&&(f==1||f==3&&S>=u||f==2&&S<=u)?u:-Ip,w=Op(c,S>C&&t<=C?C:kp(C,S));return x==w&&x==0&&(w=100),[x,w]}var bp=new Intl.NumberFormat(Ff?Rf.language:`en-US`),xp=e=>bp.format(e),Sp=Math,Cp=Sp.PI,wp=Sp.abs,Tp=Sp.floor,Ep=Sp.round,Dp=Sp.ceil,Op=Sp.min,kp=Sp.max,Ap=Sp.pow,jp=Sp.sign,Mp=Sp.log10,Np=Sp.log2,Pp=(e,t=1)=>Sp.sinh(e)*t,Fp=(e,t=1)=>Sp.asinh(e/t),Ip=1/0;function Lp(e){return(Mp((e^e>>31)-(e>>31))|0)+1}function Rp(e,t,n){return Op(kp(e,t),n)}function zp(e){return typeof e==`function`}function Bp(e){return zp(e)?e:()=>e}var Vp=()=>{},Hp=e=>e,Up=(e,t)=>t,Wp=e=>null,Gp=e=>!0,Kp=(e,t)=>e==t,qp=/\.\d*?(?=9{6,}|0{6,})/gm,Jp=e=>{if(om(e)||$p.has(e))return e;let t=`${e}`,n=t.match(qp);if(n==null)return e;let r=n[0].length-1;if(t.indexOf(`e-`)!=-1){let[e,n]=t.split(`e`);return+`${Jp(e)}e${n}`}return Qp(e,r)};function Yp(e,t){return Jp(Qp(Jp(e/t))*t)}function Xp(e,t){return Jp(Dp(Jp(e/t))*t)}function Zp(e,t){return Jp(Tp(Jp(e/t))*t)}function Qp(e,t=0){if(om(e))return e;let n=10**t;return Ep(e*n*(1+2**-52))/n}var $p=new Map;function em(e){return((``+e).split(`.`)[1]||``).length}function tm(e,t,n,r){let i=[],a=r.map(em);for(let o=t;o<n;o++){let t=wp(o),n=Qp(Ap(e,o),t);for(let s=0;s<r.length;s++){let c=e==10?+`${r[s]}e${o}`:r[s]*n,l=(o>=0?0:t)+(o>=a[s]?0:a[s]),u=e==10?c:Qp(c,l);i.push(u),$p.set(u,l)}}return i}var nm={},rm=[],im=[null,null],am=Array.isArray,om=Number.isInteger,sm=e=>e===void 0;function cm(e){return typeof e==`string`}function lm(e){let t=!1;if(e!=null){let n=e.constructor;t=n==null||n==Object}return t}function um(e){return typeof e==`object`&&!!e}var dm=Object.getPrototypeOf(Uint8Array),fm=`__proto__`;function pm(e,t=lm){let n;if(am(e)){let r=e.find(e=>e!=null);if(am(r)||t(r)){n=Array(e.length);for(let r=0;r<e.length;r++)n[r]=pm(e[r],t)}else n=e.slice()}else if(e instanceof dm)n=e.slice();else if(t(e)){n={};for(let r in e)r!=fm&&(n[r]=pm(e[r],t))}else n=e;return n}function mm(e){let t=arguments;for(let n=1;n<t.length;n++){let r=t[n];for(let t in r)t!=fm&&(lm(e[t])?mm(e[t],pm(r[t])):e[t]=pm(r[t]))}return e}var hm=0,gm=1,_m=2;function vm(e,t,n){for(let r=0,i,a=-1;r<t.length;r++){let o=t[r];if(o>a){for(i=o-1;i>=0&&e[i]==null;)e[i--]=null;for(i=o+1;i<n&&e[i]==null;)e[a=i++]=null}}}function ym(e,t){if(Sm(e)){let t=e[0].slice();for(let n=1;n<e.length;n++)t.push(...e[n].slice(1));return Cm(t[0])||(t=xm(t)),t}let n=new Set;for(let t=0;t<e.length;t++){let r=e[t][0],i=r.length;for(let e=0;e<i;e++)n.add(r[e])}let r=[Array.from(n).sort((e,t)=>e-t)],i=r[0].length,a=new Map;for(let e=0;e<i;e++)a.set(r[0][e],e);for(let n=0;n<e.length;n++){let o=e[n],s=o[0];for(let e=1;e<o.length;e++){let c=o[e],l=Array(i).fill(void 0),u=t?t[n][e]:gm,d=[];for(let e=0;e<c.length;e++){let t=c[e],n=a.get(s[e]);t===null?u!=hm&&(l[n]=t,u==_m&&d.push(n)):l[n]=t}vm(l,d,i),r.push(l)}}return r}var bm=typeof queueMicrotask>`u`?e=>Promise.resolve().then(e):queueMicrotask;function xm(e){let t=e[0],n=t.length,r=Array(n);for(let e=0;e<r.length;e++)r[e]=e;r.sort((e,n)=>t[e]-t[n]);let i=[];for(let t=0;t<e.length;t++){let a=e[t],o=Array(n);for(let e=0;e<n;e++)o[e]=a[r[e]];i.push(o)}return i}function Sm(e){let t=e[0][0],n=t.length;for(let r=1;r<e.length;r++){let i=e[r][0];if(i.length!=n)return!1;if(i!=t){for(let e=0;e<n;e++)if(i[e]!=t[e])return!1}}return!0}function Cm(e,t=100){let n=e.length;if(n<=1)return!0;let r=0,i=n-1;for(;r<=i&&e[r]==null;)r++;for(;i>=r&&e[i]==null;)i--;if(i<=r)return!0;let a=kp(1,Tp((i-r+1)/t));for(let t=e[r],n=r+a;n<=i;n+=a){let r=e[n];if(r!=null){if(r<=t)return!1;t=r}}return!0}var wm=[`January`,`February`,`March`,`April`,`May`,`June`,`July`,`August`,`September`,`October`,`November`,`December`],Tm=[`Sunday`,`Monday`,`Tuesday`,`Wednesday`,`Thursday`,`Friday`,`Saturday`];function Em(e){return e.slice(0,3)}var Dm=Tm.map(Em),Om={MMMM:wm,MMM:wm.map(Em),WWWW:Tm,WWW:Dm};function km(e){return(e<10?`0`:``)+e}function Am(e){return(e<10?`00`:e<100?`0`:``)+e}var jm={YYYY:e=>e.getFullYear(),YY:e=>(e.getFullYear()+``).slice(2),MMMM:(e,t)=>t.MMMM[e.getMonth()],MMM:(e,t)=>t.MMM[e.getMonth()],MM:e=>km(e.getMonth()+1),M:e=>e.getMonth()+1,DD:e=>km(e.getDate()),D:e=>e.getDate(),WWWW:(e,t)=>t.WWWW[e.getDay()],WWW:(e,t)=>t.WWW[e.getDay()],HH:e=>km(e.getHours()),H:e=>e.getHours(),h:e=>{let t=e.getHours();return t==0?12:t>12?t-12:t},AA:e=>e.getHours()>=12?`PM`:`AM`,aa:e=>e.getHours()>=12?`pm`:`am`,a:e=>e.getHours()>=12?`p`:`a`,mm:e=>km(e.getMinutes()),m:e=>e.getMinutes(),ss:e=>km(e.getSeconds()),s:e=>e.getSeconds(),fff:e=>Am(e.getMilliseconds())};function Mm(e,t){t||=Om;let n=[],r=/\{([a-z]+)\}|[^{]+/gi,i;for(;i=r.exec(e);)n.push(i[0][0]==`{`?jm[i[1]]:i[0]);return e=>{let r=``;for(let i=0;i<n.length;i++)r+=typeof n[i]==`string`?n[i]:n[i](e,t);return r}}var Nm=new Intl.DateTimeFormat().resolvedOptions().timeZone;function Pm(e,t){let n;return t==`UTC`||t==`Etc/UTC`?n=new Date(+e+e.getTimezoneOffset()*6e4):t==Nm?n=e:(n=new Date(e.toLocaleString(`en-US`,{timeZone:t})),n.setMilliseconds(e.getMilliseconds())),n}var Fm=e=>e%1==0,Im=[1,2,2.5,5],Lm=tm(10,-32,0,Im),Rm=tm(10,0,32,Im),zm=Rm.filter(Fm),Bm=Lm.concat(Rm),Vm=`
`,Hm=`{YYYY}`,Um=Vm+Hm,Wm=`{M}/{D}`,Gm=Vm+Wm,Km=Gm+`/{YY}`,qm=`{aa}`,Jm=`{h}:{mm}`+qm,Ym=Vm+Jm,Xm=`:{ss}`,Zm=null;function Qm(e){let t=e*1e3,n=t*60,r=n*60,i=r*24,a=i*30,o=i*365,s=(e==1?tm(10,0,3,Im).filter(Fm):tm(10,-3,0,Im)).concat([t,t*5,t*10,t*15,t*30,n,n*5,n*10,n*15,n*30,r,r*2,r*3,r*4,r*6,r*8,r*12,i,i*2,i*3,i*4,i*5,i*6,i*7,i*8,i*9,i*10,i*15,a,a*2,a*3,a*4,a*6,o,o*2,o*5,o*10,o*25,o*50,o*100]),c=[[o,Hm,Zm,Zm,Zm,Zm,Zm,Zm,1],[i*28,`{MMM}`,Um,Zm,Zm,Zm,Zm,Zm,1],[i,Wm,Um,Zm,Zm,Zm,Zm,Zm,1],[r,`{h}`+qm,Km,Zm,Gm,Zm,Zm,Zm,1],[n,Jm,Km,Zm,Gm,Zm,Zm,Zm,1],[t,Xm,Km+` `+Jm,Zm,Gm+` `+Jm,Zm,Ym,Zm,1],[e,Xm+`.{fff}`,Km+` `+Jm,Zm,Gm+` `+Jm,Zm,Ym,Zm,1]];function l(t){return(s,c,l,u,d,f)=>{let p=[],m=d>=o,h=d>=a&&d<o,g=t(l),_=Qp(g*e,3),v=ch(g.getFullYear(),m?0:g.getMonth(),h||m?1:g.getDate()),y=Qp(v*e,3);if(h||m){let n=h?d/a:0,r=m?d/o:0,i=_==y?_:Qp(ch(v.getFullYear()+r,v.getMonth()+n,1)*e,3),s=new Date(Ep(i/e)),c=s.getFullYear(),l=s.getMonth();for(let a=0;i<=u;a++){let o=ch(c+r*a,l+n*a,1),s=o-t(Qp(o*e,3));i=Qp((+o+s)*e,3),i<=u&&p.push(i)}}else{let a=d>=i?i:d,o=y+(Tp(l)-Tp(_))+Xp(_-y,a);p.push(o);let m=t(o),h=m.getHours()+m.getMinutes()/n+m.getSeconds()/r,g=d/r,v=f/s.axes[c]._space;for(;o=Qp(o+d,e==1?0:3),!(o>u);)if(g>1){let e=Tp(Qp(h+g,6))%24,n=t(o).getHours()-e;n>1&&(n=-1),o-=n*r,h=(h+g)%24;let i=p[p.length-1];Qp((o-i)/d,3)*v>=.7&&p.push(o)}else p.push(o)}return p}}return[s,c,l]}var[$m,eh,th]=Qm(1),[nh,rh,ih]=Qm(.001);tm(2,-53,53,[1]);function ah(e,t){return e.map(e=>e.map((n,r)=>r==0||r==8||n==null?n:t(r==1||e[8]==0?n:e[1]+n)))}function oh(e,t){return(n,r,i,a,o)=>{let s=t.find(e=>o>=e[0])||t[t.length-1],c,l,u,d,f,p;return r.map(t=>{let n=e(t),r=n.getFullYear(),i=n.getMonth(),a=n.getDate(),o=n.getHours(),m=n.getMinutes(),h=n.getSeconds(),g=r!=c&&s[2]||i!=l&&s[3]||a!=u&&s[4]||o!=d&&s[5]||m!=f&&s[6]||h!=p&&s[7]||s[1];return c=r,l=i,u=a,d=o,f=m,p=h,g(n)})}}function sh(e,t){let n=Mm(t);return(t,r,i,a,o)=>r.map(t=>n(e(t)))}function ch(e,t,n){return new Date(e,t,n)}function lh(e,t){return t(e)}var uh=`{YYYY}-{MM}-{DD} {h}:{mm}{aa}`;function dh(e,t){return(n,r,i,a)=>a==null?Pf:t(e(r))}function fh(e,t){let n=e.series[t];return n.width?n.stroke(e,t):n.points.width?n.points.stroke(e,t):null}function ph(e,t){return e.series[t].fill(e,t)}var mh={show:!0,live:!0,isolate:!1,mount:Vp,markers:{show:!0,width:2,stroke:fh,fill:ph,dash:`solid`},idx:null,idxs:null,values:[]};function hh(e,t){let n=e.cursor.points,r=Kf(),i=n.size(e,t);Wf(r,gf,i),Wf(r,_f,i);let a=i/-2;Wf(r,`marginLeft`,a),Wf(r,`marginTop`,a);let o=n.width(e,t,i);return o&&Wf(r,`borderWidth`,o),r}function gh(e,t){let n=e.series[t].points;return n._fill||n._stroke}function _h(e,t){let n=e.series[t].points;return n._stroke||n._fill}function vh(e,t){return e.series[t].points.size}var yh=[0,0];function bh(e,t,n){return yh[0]=t,yh[1]=n,yh}function xh(e,t,n,r=!0){return e=>{e.button==0&&(!r||e.target==t)&&n(e)}}function Sh(e,t,n,r=!0){return e=>{(!r||e.target==t)&&n(e)}}var Ch={show:!0,x:!0,y:!0,lock:!1,move:bh,points:{one:!1,show:hh,size:vh,width:0,stroke:_h,fill:gh},bind:{mousedown:xh,mouseup:xh,click:xh,dblclick:xh,mousemove:Sh,mouseleave:Sh,mouseenter:Sh},drag:{setScale:!0,x:!0,y:!1,dist:0,uni:null,click:(e,t)=>{t.stopPropagation(),t.stopImmediatePropagation()},_x:!1,_y:!1},focus:{dist:(e,t,n,r,i)=>r-i,prox:-1,bias:0},hover:{skip:[void 0],prox:null,bias:0},left:-10,top:-10,idx:null,dataIdx:null,idxs:null,event:null},wh={show:!0,stroke:`rgba(0,0,0,0.07)`,width:2},Th=mm({},wh,{filter:Up}),Eh=mm({},Th,{size:10}),Dh=mm({},wh,{show:!1}),Oh=`12px system-ui, -apple-system, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji"`,kh=`bold `+Oh,Ah=1.5,jh={show:!0,scale:`x`,stroke:Sf,space:50,gap:5,alignTo:1,size:50,labelGap:0,labelSize:30,labelFont:kh,side:2,grid:Th,ticks:Eh,border:Dh,font:Oh,lineGap:Ah,rotate:0},Mh=`Value`,Nh=`Time`,Ph={show:!0,scale:`x`,auto:!1,sorted:1,min:Ip,max:-1/0,idxs:[]};function Fh(e,t,n,r,i){return t.map(e=>e==null?``:xp(e))}function Ih(e,t,n,r,i,a,o){let s=[],c=$p.get(i)||0;n=o?n:Qp(Xp(n,i),c);for(let e=n;e<=r;e=Qp(e+i,c))s.push(Object.is(e,-0)?0:e);return s}function Lh(e,t,n,r,i,a,o){let s=[],c=e.scales[e.axes[t].scale].log;i=Ap(c,Tp((c==10?Mp:Np)(n))),c==10&&(i=Bm[rp(i,Bm)]);let l=n,u=i*c;c==10&&(u=Bm[rp(u,Bm)]);do s.push(l),l+=i,c==10&&!$p.has(l)&&(l=Qp(l,$p.get(i))),l>=u&&(i=l,u=i*c,c==10&&(u=Bm[rp(u,Bm)]));while(l<=r);return s}function Rh(e,t,n,r,i,a,o){let s=e.scales[e.axes[t].scale].asinh,c=r>s?Lh(e,t,kp(s,n),r,i):[s],l=r>=0&&n<=0?[0]:[];return(n<-s?Lh(e,t,kp(s,-r),-n,i):[s]).reverse().map(e=>-e).concat(l,c)}var zh=/./,Bh=/[12357]/,Vh=/[125]/,Hh=/1/,Uh=(e,t,n,r)=>e.map((e,i)=>t==4&&e==0||i%r==0&&n.test(e.toExponential()[+(e<0)])?e:null);function Wh(e,t,n,r,i){let a=e.axes[n],o=a.scale,s=e.scales[o],c=e.valToPos,l=a._space,u=c(10,o),d=c(9,o)-u>=l?zh:c(7,o)-u>=l?Bh:c(5,o)-u>=l?Vh:Hh;if(d==Hh){let e=wp(c(1,o)-u);if(e<l)return Uh(t.slice().reverse(),s.distr,d,Dp(l/e)).reverse()}return Uh(t,s.distr,d,1)}function Gh(e,t,n,r,i){let a=e.axes[n],o=a.scale,s=a._space,c=e.valToPos,l=wp(c(1,o)-c(2,o));return l<s?Uh(t.slice().reverse(),3,zh,Dp(s/l)).reverse():t}function Kh(e,t,n,r){return r==null?Pf:t==null?``:xp(t)}var qh={show:!0,scale:`y`,stroke:Sf,space:30,gap:5,alignTo:1,size:50,labelGap:0,labelSize:30,labelFont:kh,side:3,grid:Th,ticks:Eh,border:Dh,font:Oh,lineGap:Ah,rotate:0};function Jh(e,t){return Qp((3+(e||1)*2)*t,3)}function Yh(e,t){let{scale:n,idxs:r}=e.series[0],i=e._data[0],a=e.valToPos(i[r[0]],n,!0),o=wp(e.valToPos(i[r[1]],n,!0)-a)/(e.series[t].points.space*zf);return r[1]-r[0]<=o}var Xh={scale:null,auto:!0,sorted:0,min:Ip,max:-1/0},Zh=(e,t,n,r,i)=>i,Qh={show:!0,auto:!0,sorted:0,gaps:Zh,alpha:1,facets:[mm({},Xh,{scale:`x`}),mm({},Xh,{scale:`y`})]},$h={scale:`y`,auto:!0,sorted:0,show:!0,spanGaps:!1,gaps:Zh,alpha:1,points:{show:Yh,filter:null},values:null,min:Ip,max:-1/0,idxs:[],path:null,clip:null};function eg(e,t,n,r,i){return n/10}var tg={time:Jd,auto:!0,distr:1,log:10,asinh:1,min:null,max:null,dir:1,ori:0},ng=mm({},tg,{time:!1,ori:1}),rg={};function ig(e,t){let n=rg[e];return n||(n={key:e,plots:[],sub(e){n.plots.push(e)},unsub(e){n.plots=n.plots.filter(t=>t!=e)},pub(e,t,r,i,a,o,s){for(let c=0;c<n.plots.length;c++)n.plots[c]!=t&&n.plots[c].pub(e,t,r,i,a,o,s)}},e!=null&&(rg[e]=n)),n}var ag=1,og=2;function sg(e,t,n){let r=e.mode,i=e.series[t],a=r==2?e._data[t]:e._data,o=e.scales,s=e.bbox,c=a[0],l=r==2?a[1]:a[t],u=r==2?o[i.facets[0].scale]:o[e.series[0].scale],d=r==2?o[i.facets[1].scale]:o[i.scale],f=s.left,p=s.top,m=s.width,h=s.height,g=e.valToPosH,_=e.valToPosV;return u.ori==0?n(i,c,l,u,d,g,_,f,p,m,h,gg,vg,bg,Sg,wg):n(i,c,l,u,d,_,g,p,f,h,m,_g,yg,xg,Cg,Tg)}function cg(e,t){let n=0,r=0,i=_p(e.bands,rm);for(let e=0;e<i.length;e++){let a=i[e];a.series[0]==t?n=a.dir:a.series[1]==t&&(a.dir==1?r|=1:r|=2)}return[n,r==1?-1:r==2?1:r==3?2:0]}function lg(e,t,n,r,i){let a=e.mode,o=e.series[t],s=a==2?o.facets[1].scale:o.scale,c=e.scales[s];return i==-1?c.min:i==1?c.max:c.distr==3?c.dir==1?c.min:c.max:0}function ug(e,t,n,r,i,a){return sg(e,t,(e,t,o,s,c,l,u,d,f,p,m)=>{let h=e.pxRound,g=s.dir*(s.ori==0?1:-1),_=s.ori==0?vg:yg,v,y;g==1?(v=n,y=r):(v=r,y=n);let b=h(l(t[v],s,p,d)),x=h(u(o[v],c,m,f)),S=h(l(t[y],s,p,d)),C=h(u(a==1?c.max:c.min,c,m,f)),w=new Path2D(i);return _(w,S,C),_(w,b,C),_(w,b,x),w})}function dg(e,t,n,r,i,a){let o=null;if(e.length>0){o=new Path2D;let s=t==0?bg:xg,c=n;for(let t=0;t<e.length;t++){let n=e[t];if(n[1]>n[0]){let e=n[0]-c;e>0&&s(o,c,r,e,r+a),c=n[1]}}let l=n+i-c;l>0&&s(o,c,r-5,l,r+a+10)}return o}function fg(e,t,n){let r=e[e.length-1];r&&r[0]==t?r[1]=n:e.push([t,n])}function pg(e,t,n,r,i,a,o){let s=[],c=e.length;for(let l=i==1?n:r;l>=n&&l<=r;l+=i)if(t[l]===null){let u=l,d=l;if(i==1)for(;++l<=r&&t[l]===null;)d=l;else for(;--l>=n&&t[l]===null;)d=l;let f=a(e[u]),p=d==u?f:a(e[d]),m=u-i;f=o<=0&&m>=0&&m<c?a(e[m]):f;let h=d+i;p=o>=0&&h>=0&&h<c?a(e[h]):p,p>=f&&s.push([f,p])}return s}function mg(e){return e==0?Hp:e==1?Ep:t=>Yp(t,e)}function hg(e){let t=e==0?gg:_g,n=e==0?(e,t,n,r,i,a)=>{e.arcTo(t,n,r,i,a)}:(e,t,n,r,i,a)=>{e.arcTo(n,t,i,r,a)},r=e==0?(e,t,n,r,i)=>{e.rect(t,n,r,i)}:(e,t,n,r,i)=>{e.rect(n,t,i,r)};return(e,i,a,o,s,c=0,l=0)=>{c==0&&l==0?r(e,i,a,o,s):(c=Op(c,o/2,s/2),l=Op(l,o/2,s/2),t(e,i+c,a),n(e,i+o,a,i+o,a+s,c),n(e,i+o,a+s,i,a+s,l),n(e,i,a+s,i,a,l),n(e,i,a,i+o,a,c),e.closePath())}}var gg=(e,t,n)=>{e.moveTo(t,n)},_g=(e,t,n)=>{e.moveTo(n,t)},vg=(e,t,n)=>{e.lineTo(t,n)},yg=(e,t,n)=>{e.lineTo(n,t)},bg=hg(0),xg=hg(1),Sg=(e,t,n,r,i,a)=>{e.arc(t,n,r,i,a)},Cg=(e,t,n,r,i,a)=>{e.arc(n,t,r,i,a)},wg=(e,t,n,r,i,a,o)=>{e.bezierCurveTo(t,n,r,i,a,o)},Tg=(e,t,n,r,i,a,o)=>{e.bezierCurveTo(n,t,i,r,o,a)};function Eg(e){return(e,t,n,r,i)=>sg(e,t,(t,a,o,s,c,l,u,d,f,p,m)=>{let{pxRound:h,points:g}=t,_,v;s.ori==0?(_=gg,v=Sg):(_=_g,v=Cg);let y=Qp(g.width*zf,3),b=(g.size-g.width)/2*zf,x=Qp(b*2,3),S=new Path2D,C=new Path2D,{left:w,top:T,width:E,height:D}=e.bbox;bg(C,w-x,T-x,E+x*2,D+x*2);let O=e=>{if(o[e]!=null){let t=h(l(a[e],s,p,d)),n=h(u(o[e],c,m,f));_(S,t+b,n),v(S,t,n,b,0,Cp*2)}};if(i)i.forEach(O);else for(let e=n;e<=r;e++)O(e);return{stroke:y>0?S:null,fill:S,clip:C,flags:3}})}function Dg(e){return(t,n,r,i,a,o)=>{r!=i&&(a!=r&&o!=r&&e(t,n,r),a!=i&&o!=i&&e(t,n,i),e(t,n,o))}}var Og=Dg(vg),kg=Dg(yg);function Ag(e){let t=_p(e?.alignGaps,0);return(e,n,r,i)=>sg(e,n,(a,o,s,c,l,u,d,f,p,m,h)=>{[r,i]=sp(s,r,i);let g=a.pxRound,_=e=>g(u(e,c,m,f)),v=e=>g(d(e,l,h,p)),y,b;c.ori==0?(y=vg,b=Og):(y=yg,b=kg);let x=c.dir*(c.ori==0?1:-1),S={stroke:new Path2D,fill:null,clip:null,band:null,gaps:null,flags:ag},C=S.stroke,w=!1;if(i-r>=m*4){let t=t=>e.posToVal(t,c.key,!0),n=null,a=null,l,u,d,f=_(o[x==1?r:i]),p=_(o[r]),m=_(o[i]),h=t(x==1?p+1:m-1);for(let e=x==1?r:i;e>=r&&e<=i;e+=x){let r=o[e],i=(x==1?r<h:r>h)?f:_(r),c=s[e];i==f?c==null?c===null&&(w=!0):(u=c,n==null?(y(C,i,v(u)),l=n=a=u):u<n?n=u:u>a&&(a=u)):(n!=null&&b(C,f,v(n),v(a),v(l),v(u)),c==null?(n=a=null,c===null&&(w=!0)):(u=c,y(C,i,v(u)),n=a=l=u),f=i,h=t(f+x))}n!=null&&n!=a&&d!=f&&b(C,f,v(n),v(a),v(l),v(u))}else for(let e=x==1?r:i;e>=r&&e<=i;e+=x){let t=s[e];t===null?w=!0:t!=null&&y(C,_(o[e]),v(t))}let[T,E]=cg(e,n);if(a.fill!=null||T!=0){let t=S.fill=new Path2D(C),s=v(a.fillTo(e,n,a.min,a.max,T)),c=_(o[r]),l=_(o[i]);x==-1&&([l,c]=[c,l]),y(t,l,s),y(t,c,s)}if(!a.spanGaps){let l=[];w&&l.push(...pg(o,s,r,i,x,_,t)),S.gaps=l=a.gaps(e,n,r,i,l),S.clip=dg(l,c.ori,f,p,m,h)}return E!=0&&(S.band=E==2?[ug(e,n,r,i,C,-1),ug(e,n,r,i,C,1)]:ug(e,n,r,i,C,E)),S})}function jg(e){let t=_p(e.align,1),n=_p(e.ascDesc,!1),r=_p(e.alignGaps,0),i=_p(e.extend,!1);return(e,a,o,s)=>sg(e,a,(c,l,u,d,f,p,m,h,g,_,v)=>{[o,s]=sp(u,o,s);let y=c.pxRound,{left:b,width:x}=e.bbox,S=e=>y(p(e,d,_,h)),C=e=>y(m(e,f,v,g)),w=d.ori==0?vg:yg,T={stroke:new Path2D,fill:null,clip:null,band:null,gaps:null,flags:ag},E=T.stroke,D=d.dir*(d.ori==0?1:-1),O=C(u[D==1?o:s]),k=S(l[D==1?o:s]),A=k,j=k;i&&t==-1&&(j=b,w(E,j,O)),w(E,k,O);for(let e=D==1?o:s;e>=o&&e<=s;e+=D){let n=u[e];if(n==null)continue;let r=S(l[e]),i=C(n);t==1?w(E,r,O):w(E,A,i),w(E,r,i),O=i,A=r}let M=A;i&&t==1&&(M=b+x,w(E,M,O));let[ee,N]=cg(e,a);if(c.fill!=null||ee!=0){let t=T.fill=new Path2D(E),n=C(c.fillTo(e,a,c.min,c.max,ee));w(t,M,n),w(t,j,n)}if(!c.spanGaps){let i=[];i.push(...pg(l,u,o,s,D,S,r));let f=c.width*zf/2,p=n||t==1?f:-f,m=n||t==-1?-f:f;i.forEach(e=>{e[0]+=p,e[1]+=m}),T.gaps=i=c.gaps(e,a,o,s,i),T.clip=dg(i,d.ori,h,g,_,v)}return N!=0&&(T.band=N==2?[ug(e,a,o,s,E,-1),ug(e,a,o,s,E,1)]:ug(e,a,o,s,E,N)),T})}function Mg(e,t,n,r,i,a,o=Ip){if(e.length>1){let s=null;for(let c=0,l=1/0;c<e.length;c++)if(t[c]!==void 0){if(s!=null){let t=wp(e[c]-e[s]);t<l&&(l=t,o=wp(n(e[c],r,i,a)-n(e[s],r,i,a)))}s=c}}return o}function Ng(e){e||=nm;let t=_p(e.size,[.6,Ip,1]),n=e.align||0,r=e.gap||0,i=e.radius;i=i==null?[0,0]:typeof i==`number`?[i,0]:i;let a=Bp(i),o=1-t[0],s=_p(t[1],Ip),c=_p(t[2],1),l=_p(e.disp,nm),u=_p(e.each,e=>{}),{fill:d,stroke:f}=l;return(e,t,i,p)=>sg(e,t,(m,h,g,_,v,y,b,x,S,C,w)=>{let T=m.pxRound,E=n,D=r*zf,O=s*zf,k=c*zf,A,j;_.ori==0?[A,j]=a(e,t):[j,A]=a(e,t);let M=_.dir*(_.ori==0?1:-1),ee=_.ori==0?bg:xg,N=_.ori==0?u:(e,t,n,r,i,a,o)=>{u(e,t,n,i,r,o,a)},te=_p(e.bands,rm).find(e=>e.series[0]==t),ne=te==null?0:te.dir,re=m.fillTo(e,t,m.min,m.max,ne),P=T(b(re,v,w,S)),F,I,ie,L=C,R=T(m.width*zf),ae=!1,oe=null,se=null,ce=null,le=null;d!=null&&(R==0||f!=null)&&(ae=!0,oe=d.values(e,t,i,p),se=new Map,new Set(oe).forEach(e=>{e!=null&&se.set(e,new Path2D)}),R>0&&(ce=f.values(e,t,i,p),le=new Map,new Set(ce).forEach(e=>{e!=null&&le.set(e,new Path2D)})));let{x0:ue,size:de}=l;if(ue!=null&&de!=null){E=1,h=ue.values(e,t,i,p),ue.unit==2&&(h=h.map(t=>e.posToVal(x+t*C,_.key,!0)));let n=de.values(e,t,i,p);I=de.unit==2?n[0]*C:y(n[0],_,C,x)-y(0,_,C,x),L=Mg(h,g,y,_,C,x,L),ie=L-I+D}else L=Mg(h,g,y,_,C,x,L),ie=L*o+D,I=L-ie;ie<1&&(ie=0),R>=I/2&&(R=0),ie<5&&(T=Hp);let z=ie>0,fe=L-ie-(z?R:0);I=T(Rp(fe,k,O)),F=(E==0?I/2:E==M?0:I)-E*M*((E==0?D/2:0)+(z?R/2:0));let pe={stroke:null,fill:null,clip:null,band:null,gaps:null,flags:0},me=ae?null:new Path2D,B=null;if(te!=null)B=e.data[te.series[1]];else{let{y0:n,y1:r}=l;n!=null&&r!=null&&(g=r.values(e,t,i,p),B=n.values(e,t,i,p))}let he=A*I,V=j*I;for(let n=M==1?i:p;n>=i&&n<=p;n+=M){let r=g[n];if(r==null)continue;if(B!=null){let e=B[n]??0;if(r-e==0)continue;P=b(e,v,w,S)}let i=y(_.distr!=2||l!=null?h[n]:n,_,C,x),a=b(_p(r,re),v,w,S),o=T(i-F),s=T(kp(a,P)),c=T(Op(a,P)),u=s-c;if(r!=null){let i=r<0?V:he,a=r<0?he:V;ae?(R>0&&ce[n]!=null&&ee(le.get(ce[n]),o,c+Tp(R/2),I,kp(0,u-R),i,a),oe[n]!=null&&ee(se.get(oe[n]),o,c+Tp(R/2),I,kp(0,u-R),i,a)):ee(me,o,c+Tp(R/2),I,kp(0,u-R),i,a),N(e,t,n,o-R/2,c,I+R,u)}}return R>0?pe.stroke=ae?le:me:ae||(pe._fill=m.width==0?m._fill:m._stroke??m._fill,pe.width=0),pe.fill=ae?se:me,pe})}function Pg(e,t){let n=_p(t?.alignGaps,0);return(t,r,i,a)=>sg(t,r,(o,s,c,l,u,d,f,p,m,h,g)=>{[i,a]=sp(c,i,a);let _=o.pxRound,v=e=>_(d(e,l,h,p)),y=e=>_(f(e,u,g,m)),b,x,S;l.ori==0?(b=gg,S=vg,x=wg):(b=_g,S=yg,x=Tg);let C=l.dir*(l.ori==0?1:-1),w=v(s[C==1?i:a]),T=w,E=[],D=[];for(let e=C==1?i:a;e>=i&&e<=a;e+=C)if(c[e]!=null){let t=s[e],n=v(t);E.push(T=n),D.push(y(c[e]))}let O={stroke:e(E,D,b,S,x,_),fill:null,clip:null,band:null,gaps:null,flags:ag},k=O.stroke,[A,j]=cg(t,r);if(o.fill!=null||A!=0){let e=O.fill=new Path2D(k),n=y(o.fillTo(t,r,o.min,o.max,A));S(e,T,n),S(e,w,n)}if(!o.spanGaps){let e=[];e.push(...pg(s,c,i,a,C,v,n)),O.gaps=e=o.gaps(t,r,i,a,e),O.clip=dg(e,l.ori,p,m,h,g)}return j!=0&&(O.band=j==2?[ug(t,r,i,a,k,-1),ug(t,r,i,a,k,1)]:ug(t,r,i,a,k,j)),O})}function Fg(e){return Pg(Ig,e)}function Ig(e,t,n,r,i,a){let o=e.length;if(o<2)return null;let s=new Path2D;if(n(s,e[0],t[0]),o==2)r(s,e[1],t[1]);else{let n=Array(o),r=Array(o-1),a=Array(o-1),c=Array(o-1);for(let n=0;n<o-1;n++)a[n]=t[n+1]-t[n],c[n]=e[n+1]-e[n],r[n]=a[n]/c[n];n[0]=r[0];for(let e=1;e<o-1;e++)r[e]===0||r[e-1]===0||r[e-1]>0!=r[e]>0?n[e]=0:(n[e]=3*(c[e-1]+c[e])/((2*c[e]+c[e-1])/r[e-1]+(c[e]+2*c[e-1])/r[e]),isFinite(n[e])||(n[e]=0));n[o-1]=r[o-2];for(let r=0;r<o-1;r++)i(s,e[r]+c[r]/3,t[r]+n[r]*c[r]/3,e[r+1]-c[r]/3,t[r+1]-n[r+1]*c[r]/3,e[r+1],t[r+1])}return s}var Lg=new Set;function Rg(){for(let e of Lg)e.syncRect(!0)}Ff&&(tp(Af,Lf,Rg),tp(jf,Lf,Rg,!0),tp(Nf,Lf,()=>{e_.pxRatio=zf}));var zg=Ag(),Bg=Eg();function Vg(e,t,n,r){return(r?[e[0],e[1]].concat(e.slice(2)):[e[0]].concat(e.slice(1))).map((e,r)=>Ug(e,r,t,n))}function Hg(e,t){return e.map((e,n)=>n==0?{}:mm({},t,e))}function Ug(e,t,n,r){return mm({},t==0?n:r,e)}function Wg(e,t,n){return t==null?im:[t,n]}var Gg=Wg;function Kg(e,t,n){return t==null?im:gp(t,n,fp,!0)}function qg(e,t,n,r){return t==null?im:up(t,n,e.scales[r].log,!1)}var Jg=qg;function Yg(e,t,n,r){return t==null?im:dp(t,n,e.scales[r].log,!1)}var Xg=Yg;function Zg(e,t,n,r,i){let a=kp(Lp(e),Lp(t)),o=t-e,s=rp(i/r*o,n);do{let e=n[s],t=r*e/o;if(t>=i&&a+(e<5?$p.get(e):0)<=17)return[e,t]}while(++s<n.length);return[0,0]}function Qg(e){let t,n;return e=e.replace(/(\d+)px/,(e,r)=>(t=Ep((n=+r)*zf))+`px`),[e,t,n]}function $g(e){e.show&&[e.font,e.labelFont].forEach(e=>{let t=Qp(e[2]*zf,1);e[0]=e[0].replace(/[0-9.]+px/,t+`px`),e[1]=t})}function e_(e,t,n){let r={mode:_p(e.mode,1)},i=r.mode;function a(e,t,n,r){let i=t.valToPct(e);return r+n*(t.dir==-1?1-i:i)}function o(e,t,n,r){let i=t.valToPct(e);return r+n*(t.dir==-1?i:1-i)}function s(e,t,n,r){return t.ori==0?a(e,t,n,r):o(e,t,n,r)}r.valToPosH=a,r.valToPosV=o;let c=!1;r.status=0;let l=r.root=Kf(Yd);if(e.id!=null&&(l.id=e.id),Hf(l,e.class),e.title){let t=Kf(Qd,l);t.textContent=e.title}let u=Gf(`canvas`),d=r.ctx=u.getContext(`2d`),f=Kf($d,l);tp(`click`,f,e=>{e.target===m&&(tn!=Zt||nn!=Qt)&&an.click(r,e)},!0);let p=r.under=Kf(ef,f);f.appendChild(u);let m=r.over=Kf(tf,f);e=pm(e);let h=+_p(e.pxAlign,1),g=mg(h);(e.plugins||[]).forEach(t=>{t.opts&&(e=t.opts(r,e)||e)});let _=e.ms||.001,v=r.series=i==1?Vg(e.series||[],Ph,$h,!1):Hg(e.series||[null],Qh),y=r.axes=Vg(e.axes||[],jh,qh,!0),b=r.scales={},x=r.bands=e.bands||[];x.forEach(e=>{e.fill=Bp(e.fill||null),e.dir=_p(e.dir,-1)});let S=i==2?v[1].facets[0].scale:v[0].scale,C={axes:G,series:Et},w=(e.drawOrder||[`axes`,`series`]).map(e=>C[e]);function T(e){let t=e.distr==3?t=>Mp(t>0?t:e.clamp(r,t,e.min,e.max,e.key)):e.distr==4?t=>Fp(t,e.asinh):e.distr==100?t=>e.fwd(t):e=>e;return n=>{let r=t(n),{_min:i,_max:a}=e,o=a-i;return(r-i)/o}}function E(t){let n=b[t];if(n==null){let r=(e.scales||nm)[t]||nm;if(r.from!=null){E(r.from);let e=mm({},b[r.from],r,{key:t});e.valToPct=T(e),b[t]=e}else{n=b[t]=mm({},t==S?tg:ng,r),n.key=t;let e=n.time,a=n.range,o=am(a);if((t!=S||i==2&&!e)&&(o&&(a[0]==null||a[1]==null)&&(a={min:a[0]==null?pp:{mode:1,hard:a[0],soft:a[0]},max:a[1]==null?pp:{mode:1,hard:a[1],soft:a[1]}},o=!1),!o&&lm(a))){let e=a;a=(t,n,r)=>n==null?im:gp(n,r,e)}n.range=Bp(a||(e?Gg:t==S?n.distr==3?Jg:n.distr==4?Xg:Wg:n.distr==3?qg:n.distr==4?Yg:Kg)),n.auto=Bp(!o&&n.auto),n.clamp=Bp(n.clamp||eg),n._min=n._max=null,n.valToPct=T(n)}}}E(`x`),E(`y`),i==1&&v.forEach(e=>{E(e.scale)}),y.forEach(e=>{E(e.scale)});for(let t in e.scales)E(t);let D=b[S],O=D.distr,k,A;D.ori==0?(Hf(l,Xd),k=a,A=o):(Hf(l,Zd),k=o,A=a);let j={};for(let e in b){let t=b[e];(t.min!=null||t.max!=null)&&(j[e]={min:t.min,max:t.max},t.min=t.max=null)}let M=e.tzDate||(e=>new Date(Ep(e/_))),ee=e.fmtDate||Mm,N=_==1?th(M):ih(M),te=oh(M,ah(_==1?eh:rh,ee)),ne=dh(M,lh(uh,ee)),re=[],P=r.legend=mm({},mh,e.legend),F=r.cursor=mm({},Ch,{drag:{y:i==2}},e.cursor),I=P.show,ie=F.show,L=P.markers;P.idxs=re,L.width=Bp(L.width),L.dash=Bp(L.dash),L.stroke=Bp(L.stroke),L.fill=Bp(L.fill);let R,ae,oe,se=[],ce=[],le,ue=!1,de={};if(P.live){let e=v[1]?v[1].values:null;ue=e!=null,le=ue?e(r,1,0):{_:0};for(let e in le)de[e]=Pf}if(I){if(R=Gf(`table`,lf,l),oe=Gf(`tbody`,null,R),P.mount(r,R),ue){ae=Gf(`thead`,null,R,oe);let e=Gf(`tr`,null,ae);for(var z in Gf(`th`,null,e),le)Gf(`th`,mf,e).textContent=z}else Hf(R,df),P.live&&Hf(R,uf)}let fe={show:!0},pe={show:!1};function me(e,t){if(t==0&&(ue||!P.live||i==2))return im;let n=[],a=Gf(`tr`,ff,oe,oe.childNodes[t]);Hf(a,e.class),e.show||Hf(a,rf);let o=Gf(`th`,null,a);if(L.show){let e=Kf(pf,o);if(t>0){let n=L.width(r,t);n&&(e.style.border=n+`px `+L.dash(r,t)+` `+L.stroke(r,t)),e.style.background=L.fill(r,t)}}let s=Kf(mf,o);for(var c in e.label instanceof HTMLElement?s.appendChild(e.label):s.textContent=e.label,t>0&&(L.show||(s.style.color=e.width>0?L.stroke(r,t):L.fill(r,t)),he(`click`,o,t=>{if(F._lock)return;ze(t);let n=v.indexOf(e);if((t.ctrlKey||t.metaKey)!=P.isolate){let e=v.some((e,t)=>t>0&&t!=n&&e.show);v.forEach((t,r)=>{r>0&&J(r,e?r==n?fe:pe:fe,!0,Xn.setSeries)})}else J(n,{show:!e.show},!0,Xn.setSeries)},!1),He&&he(Df,o,t=>{F._lock||(ze(t),J(v.indexOf(e),yn,!0,Xn.setSeries))},!1)),le){let e=Gf(`td`,hf,a);e.textContent=`--`,n.push(e)}return[a,n]}let B=new Map;function he(e,t,n,i=!0){let a=B.get(t)||{},o=F.bind[e](r,t,n,i);o&&(tp(e,t,a[e]=o),B.set(t,a))}function V(e,t,n){let r=B.get(t)||{};for(let n in r)(e==null||n==e)&&(np(n,t,r[n]),delete r[n]);e??B.delete(t)}let H=0,ge=0,U=0,W=0,_e=0,ve=0,ye=_e,be=ve,xe=U,Se=W,Ce=0,we=0,Te=0,Ee=0;r.bbox={};let De=!1,Oe=!1,ke=!1,Ae=!1,je=!1,Me=!1;function Ne(e,t,n){(n||e!=r.width||t!=r.height)&&Pe(e,t),K(!1),ke=!0,Oe=!0,Vt()}function Pe(e,t){r.width=H=U=e,r.height=ge=W=t,_e=ve=0,Le(),Re();let n=r.bbox;Ce=n.left=Yp(_e*zf,.5),we=n.top=Yp(ve*zf,.5),Te=n.width=Yp(U*zf,.5),Ee=n.height=Yp(W*zf,.5)}function Fe(){let e=!1,t=0;for(;!e;){t++;let n=Ft(t),i=It(t);e=t==3||n&&i,e||(Pe(r.width,r.height),Oe=!0)}}function Ie({width:e,height:t}){Ne(e,t)}r.setSize=Ie;function Le(){let e=!1,t=!1,n=!1,r=!1;y.forEach((i,a)=>{if(i.show&&i._show){let{side:a,_size:o}=i,s=a%2,c=o+(i.label==null?0:i.labelSize);c>0&&(s?(U-=c,a==3?(_e+=c,r=!0):n=!0):(W-=c,a==0?(ve+=c,e=!0):t=!0))}}),Ze[0]=e,Ze[1]=n,Ze[2]=t,Ze[3]=r,U-=tt[1]+tt[3],_e+=tt[3],W-=tt[2]+tt[0],ve+=tt[0]}function Re(){let e=_e+U,t=ve+W,n=_e,r=ve;function i(i,a){switch(i){case 1:return e+=a,e-a;case 2:return t+=a,t-a;case 3:return n-=a,n+a;case 0:return r-=a,r+a}}y.forEach((e,t)=>{if(e.show&&e._show){let t=e.side;e._pos=i(t,e._size),e.label!=null&&(e._lpos=i(t,e.labelSize))}})}if(F.dataIdx==null){let e=F.hover,n=e.skip=new Set(e.skip??[]);n.add(void 0);let r=e.prox=Bp(e.prox),i=e.bias??=0;F.dataIdx=(e,a,o,s)=>{if(a==0)return o;let c=o,l=r(e,a,o,s)??Ip,u=l>=0&&l<Ip,d=D.ori==0?U:W,f=F.left,p=t[0],m=t[a];if(n.has(m[o])){c=null;let e=null,t=null,r;if(i==0||i==-1)for(r=o;e==null&&r-->0;)n.has(m[r])||(e=r);if(i==0||i==1)for(r=o;t==null&&r++<m.length;)n.has(m[r])||(t=r);if(e!=null||t!=null){if(u){let n=e==null?-1/0:k(p[e],D,d,0),r=t==null?1/0:k(p[t],D,d,0),i=f-n,a=r-f;i<=a?i<=l&&(c=e):a<=l&&(c=t)}else c=t==null?e:e==null?t:o-e<=t-o?e:t}}else u&&wp(f-k(p[o],D,d,0))>l&&(c=null);return c}}let ze=e=>{F.event=e};F.idxs=re,F._lock=!1;let Be=F.points;Be.show=Bp(Be.show),Be.size=Bp(Be.size),Be.stroke=Bp(Be.stroke),Be.width=Bp(Be.width),Be.fill=Bp(Be.fill);let Ve=r.focus=mm({},e.focus||{alpha:.3},F.focus),He=Ve.prox>=0,Ue=He&&Be.one,We=[],Ge=[],Ke=[];function qe(e,t){let n=Be.show(r,t);if(n instanceof HTMLElement)return Hf(n,cf),Hf(n,e.class),Jf(n,-10,-10,U,W),m.insertBefore(n,We[t]),n}function Je(e,t){if(i==1||t>0){let t=i==1&&b[e.scale].time,n=e.value;e.value=t?cm(n)?dh(M,lh(n,ee)):n||ne:n||Kh,e.label=e.label||(t?Nh:Mh)}if(Ue||t>0){e.width=e.width==null?1:e.width,e.paths=e.paths||zg||Wp,e.fillTo=Bp(e.fillTo||lg),e.pxAlign=+_p(e.pxAlign,h),e.pxRound=mg(e.pxAlign),e.stroke=Bp(e.stroke||null),e.fill=Bp(e.fill||null),e._stroke=e._fill=e._paths=e._focus=null;let t=Jh(kp(1,e.width),1),n=e.points=mm({},{size:t,width:kp(1,t*.2),stroke:e.stroke,space:t*2,paths:Bg,_stroke:null,_fill:null},e.points);n.show=Bp(n.show),n.filter=Bp(n.filter),n.fill=Bp(n.fill),n.stroke=Bp(n.stroke),n.paths=Bp(n.paths),n.pxAlign=e.pxAlign}if(I){let n=me(e,t);se.splice(t,0,n[0]),ce.splice(t,0,n[1]),P.values.push(null)}if(ie){re.splice(t,0,null);let n=null;Ue?t==0&&(n=qe(e,t)):t>0&&(n=qe(e,t)),We.splice(t,0,n),Ge.splice(t,0,0),Ke.splice(t,0,0)}Jn(`addSeries`,t)}function Ye(e,t){t??=v.length,e=i==1?Ug(e,t,Ph,$h):Ug(e,t,{},Qh),v.splice(t,0,e),Je(v[t],t)}r.addSeries=Ye;function Xe(e){if(v.splice(e,1),I){P.values.splice(e,1),ce.splice(e,1);let t=se.splice(e,1)[0];V(null,t.firstChild),t.remove()}ie&&(re.splice(e,1),We.splice(e,1)[0].remove(),Ge.splice(e,1),Ke.splice(e,1)),Jn(`delSeries`,e)}r.delSeries=Xe;let Ze=[!1,!1,!1,!1];function Qe(e,t){if(e._show=e.show,e.show){let n=e.side%2,i=b[e.scale];i??=(e.scale=n?v[1].scale:S,b[e.scale]);let a=i.time;e.size=Bp(e.size),e.space=Bp(e.space),e.rotate=Bp(e.rotate),am(e.incrs)&&e.incrs.forEach(e=>{!$p.has(e)&&$p.set(e,em(e))}),e.incrs=Bp(e.incrs||(i.distr==2?zm:a?_==1?$m:nh:Bm)),e.splits=Bp(e.splits||(a&&i.distr==1?N:i.distr==3?Lh:i.distr==4?Rh:Ih)),e.stroke=Bp(e.stroke),e.grid.stroke=Bp(e.grid.stroke),e.ticks.stroke=Bp(e.ticks.stroke),e.border.stroke=Bp(e.border.stroke);let o=e.values;e.values=am(o)&&!am(o[0])?Bp(o):a?am(o)?oh(M,ah(o,ee)):cm(o)?sh(M,o):o||te:o||Fh,e.filter=Bp(e.filter||(i.distr>=3&&i.log==10?Wh:i.distr==3&&i.log==2?Gh:Up)),e.font=Qg(e.font),e.labelFont=Qg(e.labelFont),e._size=e.size(r,null,t,0),e._space=e._rotate=e._incrs=e._found=e._splits=e._values=null,e._size>0&&(Ze[t]=!0,e._el=Kf(nf,f))}}function $e(e,t,n,r){let[i,a,o,s]=n,c=t%2,l=0;return c==0&&(s||a)&&(l=t==0&&!i||t==2&&!o?Ep(jh.size/3):0),c==1&&(i||o)&&(l=t==1&&!a||t==3&&!s?Ep(qh.size/2):0),l}let et=r.padding=(e.padding||[$e,$e,$e,$e]).map(e=>Bp(_p(e,$e))),tt=r._padding=et.map((e,t)=>e(r,t,Ze,0)),nt,rt=null,it=null,at=i==1?v[0].idxs:null,ot=null,st=!1;function ct(e,n){if(t=e??[],r.data=r._data=t,i==2){nt=0;for(let e=1;e<v.length;e++)nt+=t[e][0].length}else{t.length==0&&(r.data=r._data=t=[[]]),ot=t[0],nt=ot.length;let e=t;if(O==2){e=t.slice();let n=e[0]=Array(nt);for(let e=0;e<nt;e++)n[e]=e}r._data=t=e}if(K(!0),Jn(`setData`),O==2&&(ke=!0),n!==!1){let e=D;e.auto(r,st)?lt():dn(S,e.min,e.max),Ae||=F.left>=0,Me=!0,Vt()}}r.setData=ct;function lt(){st=!0;let e,n;i==1&&(nt>0?(rt=at[0]=0,it=at[1]=nt-1,e=t[0][rt],n=t[0][it],O==2?(e=rt,n=it):e==n&&(O==3?[e,n]=up(e,e,D.log,!1):O==4?[e,n]=dp(e,e,D.log,!1):D.time?n=e+Ep(86400/_):[e,n]=gp(e,n,fp,!0))):(rt=at[0]=e=null,it=at[1]=n=null)),dn(S,e,n)}let ut,dt,ft,pt,mt,ht,gt,_t,vt,yt;function bt(e,t,n,r,i,a){e??=Cf,n??=rm,r??=`butt`,i??=Cf,a??=`round`,e!=ut&&(d.strokeStyle=ut=e),i!=dt&&(d.fillStyle=dt=i),t!=ft&&(d.lineWidth=ft=t),a!=mt&&(d.lineJoin=mt=a),r!=ht&&(d.lineCap=ht=r),n!=pt&&d.setLineDash(pt=n)}function xt(e,t,n,r){t!=dt&&(d.fillStyle=dt=t),e!=gt&&(d.font=gt=e),n!=_t&&(d.textAlign=_t=n),r!=vt&&(d.textBaseline=vt=r)}function St(e,t,n,i,a=0){if(i.length>0&&e.auto(r,st)&&(t==null||t.min==null)){let t=_p(rt,0),r=_p(it,i.length-1),o=n.min==null?lp(i,t,r,a,e.distr==3):[n.min,n.max];e.min=Op(e.min,n.min=o[0]),e.max=kp(e.max,n.max=o[1])}}let Ct={min:null,max:null};function wt(){for(let e in b){let t=b[e];j[e]==null&&(t.min==null||j[S]!=null&&t.auto(r,st))&&(j[e]=Ct)}for(let e in b){let t=b[e];j[e]==null&&t.from!=null&&j[t.from]!=null&&(j[e]=Ct)}j[S]!=null&&K(!0);let e={};for(let t in j){let n=j[t];if(n!=null){let a=e[t]=pm(b[t],um);if(n.min!=null)mm(a,n);else if(t!=S||i==2){if(nt==0&&a.from==null){let e=a.range(r,null,null,t);a.min=e[0],a.max=e[1]}else a.min=Ip,a.max=-1/0}}}if(nt>0){v.forEach((n,a)=>{if(i==1){let i=n.scale,o=j[i];if(o==null)return;let s=e[i];if(a==0){let e=s.range(r,s.min,s.max,i);s.min=e[0],s.max=e[1],rt=rp(s.min,t[0]),it=rp(s.max,t[0]),it-rt>1&&(t[0][rt]<s.min&&rt++,t[0][it]>s.max&&it--),n.min=ot[rt],n.max=ot[it]}else n.show&&n.auto&&St(s,o,n,t[a],n.sorted);n.idxs[0]=rt,n.idxs[1]=it}else if(a>0&&n.show&&n.auto){let[r,i]=n.facets,o=r.scale,s=i.scale,[c,l]=t[a],u=e[o],d=e[s];u!=null&&St(u,j[o],r,c,r.sorted),d!=null&&St(d,j[s],i,l,i.sorted),n.min=i.min,n.max=i.max}});for(let t in e){let n=e[t],i=j[t];if(n.from==null&&(i==null||i.min==null)){let e=n.range(r,n.min==Ip?null:n.min,n.max==-1/0?null:n.max,t);n.min=e[0],n.max=e[1]}}}for(let t in e){let n=e[t];if(n.from!=null){let i=e[n.from];if(i.min==null)n.min=n.max=null;else{let e=n.range(r,i.min,i.max,t);n.min=e[0],n.max=e[1]}}}let n={},a=!1;for(let t in e){let r=e[t],i=b[t];if(i.min!=r.min||i.max!=r.max){i.min=r.min,i.max=r.max;let e=i.distr;i._min=e==3?Mp(i.min):e==4?Fp(i.min,i.asinh):e==100?i.fwd(i.min):i.min,i._max=e==3?Mp(i.max):e==4?Fp(i.max,i.asinh):e==100?i.fwd(i.max):i.max,n[t]=a=!0}}if(a){v.forEach((e,t)=>{i==2?t>0&&n.y&&(e._paths=null):n[e.scale]&&(e._paths=null)});for(let e in n)ke=!0,Jn(`setScale`,e);ie&&F.left>=0&&(Ae=Me=!0)}for(let e in j)j[e]=null}function Tt(e){let t=Rp(rt-1,0,nt-1),n=Rp(it+1,0,nt-1);for(;e[t]==null&&t>0;)t--;for(;e[n]==null&&n<nt-1;)n++;return[t,n]}function Et(){if(nt>0){let e=v.some(e=>e._focus)&&yt!=Ve.alpha;e&&(d.globalAlpha=yt=Ve.alpha),v.forEach((e,n)=>{if(n>0&&e.show&&(Dt(n,!1),Dt(n,!0),e._paths==null)){let a=yt;yt!=e.alpha&&(d.globalAlpha=yt=e.alpha);let o=i==2?[0,t[n][0].length-1]:Tt(t[n]);e._paths=e.paths(r,n,o[0],o[1]),yt!=a&&(d.globalAlpha=yt=a)}}),v.forEach((e,t)=>{if(t>0&&e.show){let n=yt;yt!=e.alpha&&(d.globalAlpha=yt=e.alpha),e._paths!=null&&Ot(t,!1);{let n=e._paths==null?null:e._paths.gaps,i=e.points.show(r,t,rt,it,n),a=e.points.filter(r,t,i,n);(i||a)&&(e.points._paths=e.points.paths(r,t,rt,it,a),Ot(t,!0))}yt!=n&&(d.globalAlpha=yt=n),Jn(`drawSeries`,t)}}),e&&(d.globalAlpha=yt=1)}}function Dt(e,t){let n=t?v[e].points:v[e];n._stroke=n.stroke(r,e),n._fill=n.fill(r,e)}function Ot(e,t){let n=t?v[e].points:v[e],{stroke:r,fill:i,clip:a,flags:o,_stroke:s=n._stroke,_fill:c=n._fill,_width:l=n.width}=n._paths;l=Qp(l*zf,3);let u=null,f=l%2/2;t&&c==null&&(c=l>0?`#fff`:s);let p=n.pxAlign==1&&f>0;if(p&&d.translate(f,f),!t){let e=Ce-l/2,t=we-l/2,n=Te+l,r=Ee+l;u=new Path2D,u.rect(e,t,n,r)}t?At(s,l,n.dash,n.cap,c,r,i,o,a):kt(e,s,l,n.dash,n.cap,c,r,i,o,u,a),p&&d.translate(-f,-f)}function kt(e,n,i,a,o,s,c,l,u,d,f){let p=!1;u!=0&&x.forEach((m,h)=>{if(m.series[0]==e){let e=v[m.series[1]],g=t[m.series[1]],_=(e._paths||nm).band;am(_)&&(_=m.dir==1?_[0]:_[1]);let y,b=null;e.show&&_&&vp(g,rt,it)?(b=m.fill(r,h)||s,y=e._paths.clip):_=null,At(n,i,a,o,b,c,l,u,d,f,y,_),p=!0}}),p||At(n,i,a,o,s,c,l,u,d,f)}function At(e,t,n,r,i,a,o,s,c,l,u,f){bt(e,t,n,r,i),(c||l||f)&&(d.save(),c&&d.clip(c),l&&d.clip(l)),f?(s&3)==3?(d.clip(f),u&&d.clip(u),Mt(i,o),jt(e,a,t)):s&og?(Mt(i,o),d.clip(f),jt(e,a,t)):s&ag&&(d.save(),d.clip(f),u&&d.clip(u),Mt(i,o),d.restore(),jt(e,a,t)):(Mt(i,o),jt(e,a,t)),(c||l||f)&&d.restore()}function jt(e,t,n){n>0&&(t instanceof Map?t.forEach((e,t)=>{d.strokeStyle=ut=t,d.stroke(e)}):t!=null&&e&&d.stroke(t))}function Mt(e,t){t instanceof Map?t.forEach((e,t)=>{d.fillStyle=dt=t,d.fill(e)}):t!=null&&e&&d.fill(t)}function Nt(e,t,n,i){let a=y[e],o;if(i<=0)o=[0,0];else{let s=a._space=a.space(r,e,t,n,i);o=Zg(t,n,a._incrs=a.incrs(r,e,t,n,i,s),i,s)}return a._found=o}function Pt(e,t,n,r,i,a,o,s,c,l){let u=o%2/2;h==1&&d.translate(u,u),bt(s,o,c,l,s),d.beginPath();let f,p,m,g,_=i+(r==0||r==3?-a:a);n==0?(p=i,g=_):(f=i,m=_);for(let r=0;r<e.length;r++)t[r]!=null&&(n==0?f=m=e[r]:p=g=e[r],d.moveTo(f,p),d.lineTo(m,g));d.stroke(),h==1&&d.translate(-u,-u)}function Ft(e){let t=!0;return y.forEach((n,i)=>{if(!n.show)return;let a=b[n.scale];if(a.min==null){n._show&&(t=!1,n._show=!1,K(!1));return}n._show||(t=!1,n._show=!0,K(!1));let o=n.side,s=o%2,{min:c,max:l}=a,[u,d]=Nt(i,c,l,s==0?U:W);if(d==0)return;let f=a.distr==2,p=n._splits=n.splits(r,i,c,l,u,d,f),m=a.distr==2?p.map(e=>ot[e]):p,h=a.distr==2?ot[p[1]]-ot[p[0]]:u,g=n._values=n.values(r,n.filter(r,m,i,d,h),i,d,h);n._rotate=o==2?n.rotate(r,g,i,d):0;let _=n._size;n._size=Dp(n.size(r,g,i,e)),_!=null&&n._size!=_&&(t=!1)}),t}function It(e){let t=!0;return et.forEach((n,i)=>{let a=n(r,i,Ze,e);a!=tt[i]&&(t=!1),tt[i]=a}),t}function G(){for(let e=0;e<y.length;e++){let t=y[e];if(!t.show||!t._show)continue;let n=t.side,i=n%2,a,o,c=t.stroke(r,e),l=n==0||n==3?-1:1,[u,f]=t._found;if(t.label!=null){let s=t.labelGap*l,p=Ep((t._lpos+s)*zf);xt(t.labelFont[0],c,`center`,n==2?vf:yf),d.save(),i==1?(a=o=0,d.translate(p,Ep(we+Ee/2)),d.rotate((n==3?-Cp:Cp)/2)):(a=Ep(Ce+Te/2),o=p);let m=zp(t.label)?t.label(r,e,u,f):t.label;d.fillText(m,a,o),d.restore()}if(f==0)continue;let p=b[t.scale],m=i==0?Te:Ee,h=i==0?Ce:we,_=t._splits,v=p.distr==2?_.map(e=>ot[e]):_,x=p.distr==2?ot[_[1]]-ot[_[0]]:u,S=t.ticks,C=t.border,w=S.show?S.size:0,T=Ep(w*zf),E=Ep((t.alignTo==2?t._size-w-t.gap:t.gap)*zf),D=t._rotate*-Cp/180,O=g(t._pos*zf),k=O+(T+E)*l;o=i==0?k:0,a=i==1?k:0;let A=t.font[0];xt(A,c,t.align==1?bf:t.align==2?xf:D>0?bf:D<0?xf:i==0?`center`:n==3?xf:bf,D||i==1?`middle`:n==2?vf:yf);let j=t.font[1]*t.lineGap,M=_.map(e=>g(s(e,p,m,h))),ee=t._values;for(let e=0;e<ee.length;e++){let t=ee[e];if(t!=null){i==0?a=M[e]:o=M[e],t=``+t;let n=t.indexOf(`
`)==-1?[t]:t.split(/\n/gm);for(let e=0;e<n.length;e++){let t=n[e];D?(d.save(),d.translate(a,o+e*j),d.rotate(D),d.fillText(t,0,0),d.restore()):d.fillText(t,a,o+e*j)}}}S.show&&Pt(M,S.filter(r,v,e,f,x),i,n,O,T,Qp(S.width*zf,3),S.stroke(r,e),S.dash,S.cap);let N=t.grid;N.show&&Pt(M,N.filter(r,v,e,f,x),i,i==0?2:1,i==0?we:Ce,i==0?Ee:Te,Qp(N.width*zf,3),N.stroke(r,e),N.dash,N.cap),C.show&&Pt([O],[1],+(i==0),i==0?1:2,i==1?we:Ce,i==1?Ee:Te,Qp(C.width*zf,3),C.stroke(r,e),C.dash,C.cap)}Jn(`drawAxes`)}function K(e){v.forEach((t,n)=>{n>0&&(t._paths=null,e&&(i==1?(t.min=null,t.max=null):t.facets.forEach(e=>{e.min=null,e.max=null})))})}let Lt=!1,Rt=!1,zt=[];function Bt(){Rt=!1;for(let e=0;e<zt.length;e++)Jn(...zt[e]);zt.length=0}function Vt(){Lt||=(bm(Ut),!0)}function Ht(e,t=!1){Lt=!0,Rt=t,e(r),Ut(),t&&zt.length>0&&queueMicrotask(Bt)}r.batch=Ht;function Ut(){if(De&&=(wt(),!1),ke&&=(Fe(),!1),Oe){if(Wf(p,bf,_e),Wf(p,vf,ve),Wf(p,gf,U),Wf(p,_f,W),Wf(m,bf,_e),Wf(m,vf,ve),Wf(m,gf,U),Wf(m,_f,W),Wf(f,gf,H),Wf(f,_f,ge),u.width=Ep(H*zf),u.height=Ep(ge*zf),y.forEach(({_el:e,_show:t,_size:n,_pos:r,side:i})=>{if(e!=null){if(t){let t=i===3||i===0?n:0,a=i%2==1;Wf(e,a?`left`:`top`,r-t),Wf(e,a?`width`:`height`,n),Wf(e,a?`top`:`left`,a?ve:_e),Wf(e,a?`height`:`width`,a?W:U),Uf(e,rf)}else Hf(e,rf)}}),ut=dt=ft=mt=ht=gt=_t=vt=pt=null,yt=1,Mn(!0),_e!=ye||ve!=be||U!=xe||W!=Se){K(!1);let e=U/xe,t=W/Se;if(ie&&!Ae&&F.left>=0){F.left*=e,F.top*=t,qt&&Jf(qt,Ep(F.left),0,U,W),Jt&&Jf(Jt,0,Ep(F.top),U,W);for(let n=0;n<We.length;n++){let r=We[n];r!=null&&(Ge[n]*=e,Ke[n]*=t,Jf(r,Dp(Ge[n]),Dp(Ke[n]),U,W))}}if(sn.show&&!je&&sn.left>=0&&sn.width>0){sn.left*=e,sn.width*=e,sn.top*=t,sn.height*=t;for(let e in Fn)Wf(cn,e,sn[e])}ye=_e,be=ve,xe=U,Se=W}Jn(`setSize`),Oe=!1}H>0&&ge>0&&(d.clearRect(0,0,u.width,u.height),Jn(`drawClear`),w.forEach(e=>e()),Jn(`draw`)),sn.show&&je&&(ln(sn),je=!1),ie&&Ae&&(An(null,!0,!1),Ae=!1),P.show&&P.live&&Me&&(On(),Me=!1),c||(c=!0,r.status=1,Jn(`ready`)),st=!1,Lt=!1}r.redraw=(e,t)=>{ke=t||!1,e===!1?Vt():dn(S,D.min,D.max)};function Wt(e,n){let i=b[e];if(i.from==null){if(nt==0){let t=i.range(r,n.min,n.max,e);n.min=t[0],n.max=t[1]}if(n.min>n.max){let e=n.min;n.min=n.max,n.max=e}if(nt>1&&n.min!=null&&n.max!=null&&n.max-n.min<1e-16)return;e==S&&i.distr==2&&nt>0&&(n.min=rp(n.min,t[0]),n.max=rp(n.max,t[0]),n.min==n.max&&n.max++),j[e]=n,De=!0,Vt()}}r.setScale=Wt;let Gt,Kt,qt,Jt,Yt,Xt,Zt,Qt,$t,en,tn,nn,rn=!1,an=F.drag,on=an.x,q=an.y;ie&&(F.x&&(Gt=Kf(of,m)),F.y&&(Kt=Kf(sf,m)),D.ori==0?(qt=Gt,Jt=Kt):(qt=Kt,Jt=Gt),tn=F.left,nn=F.top);let sn=r.select=mm({show:!0,over:!0,left:0,width:0,top:0,height:0},e.select),cn=sn.show?Kf(af,sn.over?m:p):null;function ln(e,t){if(sn.show){for(let t in e)sn[t]=e[t],t in Fn&&Wf(cn,t,e[t]);t!==!1&&Jn(`setSelect`)}}r.setSelect=ln;function un(e){if(v[e].show)I&&Uf(se[e],rf);else if(I&&Hf(se[e],rf),ie){let t=Ue?We[0]:We[e];t!=null&&Jf(t,-10,-10,U,W)}}function dn(e,t,n){Wt(e,{min:t,max:n})}function J(e,t,n,a){t.focus!=null&&bn(e),t.show!=null&&v.forEach((n,r)=>{r>0&&(e==r||e==null)&&(n.show=t.show,un(r),i==2?(dn(n.facets[0].scale,null,null),dn(n.facets[1].scale,null,null)):dn(n.scale,null,null),Vt())}),n!==!1&&Jn(`setSeries`,e,t),a&&$n(`setSeries`,r,e,t)}r.setSeries=J;function fn(e,t){mm(x[e],t)}function pn(e,t){e.fill=Bp(e.fill||null),e.dir=_p(e.dir,-1),t??=x.length,x.splice(t,0,e)}function mn(e){e==null?x.length=0:x.splice(e,1)}r.addBand=pn,r.setBand=fn,r.delBand=mn;function hn(e,t){v[e].alpha=t,ie&&We[e]!=null&&(We[e].style.opacity=t),I&&se[e]&&(se[e].style.opacity=t)}let gn,_n,vn,yn={focus:!0};function bn(e){if(e!=vn){let t=e==null,n=Ve.alpha!=1;v.forEach((r,a)=>{if(i==1||a>0){let i=t||a==0||a==e;r._focus=t?null:i,n&&hn(a,i?1:Ve.alpha)}}),vn=e,n&&Vt()}}I&&He&&he(Of,R,e=>{F._lock||(ze(e),vn!=null&&J(null,yn,!0,Xn.setSeries))});function xn(e,t,n){let r=b[t];n&&(e=e/zf-(r.ori==1?ve:_e));let i=U;r.ori==1&&(i=W,e=i-e),r.dir==-1&&(e=i-e);let a=r._min,o=r._max,s=e/i,c=a+(o-a)*s,l=r.distr;return l==3?Ap(10,c):l==4?Pp(c,r.asinh):l==100?r.bwd(c):c}function Sn(e,n){return rp(xn(e,S,n),t[0],rt,it)}r.valToIdx=e=>rp(e,t[0]),r.posToIdx=Sn,r.posToVal=xn,r.valToPos=(e,t,n)=>b[t].ori==0?a(e,b[t],n?Te:U,n?Ce:0):o(e,b[t],n?Ee:W,n?we:0),r.setCursor=(e,t,n)=>{tn=e.left,nn=e.top,An(null,t,n)};function Cn(e,t){Wf(cn,bf,sn.left=e),Wf(cn,gf,sn.width=t)}function wn(e,t){Wf(cn,vf,sn.top=e),Wf(cn,_f,sn.height=t)}let Tn=D.ori==0?Cn:wn,En=D.ori==1?Cn:wn;function Dn(){if(I&&P.live)for(let e=+(i==2);e<v.length;e++){if(e==0&&ue)continue;let t=P.values[e],n=0;for(let r in t)ce[e][n++].firstChild.nodeValue=t[r]}}function On(e,t){if(e!=null&&(e.idxs?e.idxs.forEach((e,t)=>{re[t]=e}):sm(e.idx)||re.fill(e.idx),P.idx=re[0]),I&&P.live){for(let e=0;e<v.length;e++)(e>0||i==1&&!ue)&&kn(e,re[e]);Dn()}Me=!1,t!==!1&&Jn(`setLegend`)}r.setLegend=On;function kn(e,n){let i=v[e],a=e==0&&O==2?ot:t[e],o;ue?o=i.values(r,e,n)??de:(o=i.value(r,n==null?null:a[n],e,n),o=o==null?de:{_:o}),P.values[e]=o}function An(e,n,a){$t=tn,en=nn,[tn,nn]=F.move(r,tn,nn),F.left=tn,F.top=nn,ie&&(qt&&Jf(qt,Ep(tn),0,U,W),Jt&&Jf(Jt,0,Ep(nn),U,W));let o,s=rt>it;gn=Ip,_n=null;let c=D.ori==0?U:W,l=D.ori==1?U:W;if(tn<0||nt==0||s){o=F.idx=null;for(let e=0;e<v.length;e++){let t=We[e];t!=null&&Jf(t,-10,-10,U,W)}He&&J(null,yn,!0,e==null&&Xn.setSeries),P.live&&(re.fill(o),Me=!0)}else{let e,n,a;i==1&&(e=D.ori==0?tn:nn,n=xn(e,S),o=F.idx=rp(n,t[0],rt,it),a=k(t[0][o],D,c,0));let s=-10,u=-10,d=0,f=0,p=!0,m=``,h=``;for(let e=+(i==2);e<v.length;e++){let g=v[e],_=re[e],y=_==null?null:i==1?t[e][_]:t[e][1][_],x=F.dataIdx(r,e,o,n),S=x==null?null:i==1?t[e][x]:t[e][1][x];if(Me=Me||S!=y||x!=_,re[e]=x,e>0&&g.show){let n=x==null?-10:x==o?a:k(i==1?t[0][x]:t[e][0][x],D,c,0),_=S==null?-10:A(S,i==1?b[g.scale]:b[g.facets[1].scale],l,0);if(He&&S!=null){let t=D.ori==1?tn:nn,n=wp(Ve.dist(r,e,x,_,t));if(n<gn){let r=Ve.bias;if(r!=0){let i=xn(t,g.scale),a=S>=0?1:-1,o=i>=0?1:-1;o==a&&(o==1?r==1?S>=i:S<=i:r==1?S<=i:S>=i)&&(gn=n,_n=e)}else gn=n,_n=e}}if(Me||Ue){let t,i;D.ori==0?(t=n,i=_):(t=_,i=n);let a,o,c,l,g,v,y=!0,b=Be.bbox;if(b!=null){y=!1;let t=b(r,e);c=t.left,l=t.top,a=t.width,o=t.height}else c=t,l=i,a=o=Be.size(r,e);if(v=Be.fill(r,e),g=Be.stroke(r,e),Ue)e==_n&&gn<=Ve.prox&&(s=c,u=l,d=a,f=o,p=y,m=v,h=g);else{let t=We[e];t!=null&&(Ge[e]=c,Ke[e]=l,Qf(t,a,o,y),Xf(t,v,g),Jf(t,Dp(c),Dp(l),U,W))}}}}if(Ue){let e=Ve.prox;if(Me||(vn==null?gn<=e:gn>e||_n!=vn)){let e=We[0];e!=null&&(Ge[0]=s,Ke[0]=u,Qf(e,d,f,p),Xf(e,m,h),Jf(e,Dp(s),Dp(u),U,W))}}}if(sn.show&&rn){if(e!=null){let[t,n]=Xn.scales,[r,i]=Xn.match,[a,o]=e.cursor.sync.scales,s=e.cursor.drag;if(on=s._x,q=s._y,on||q){let{left:s,top:u,width:d,height:f}=e.select,p=e.scales[a].ori,m=e.posToVal,h,g,_,v,y,x=t!=null&&r(t,a),S=n!=null&&i(n,o);x&&on?(p==0?(h=s,g=d):(h=u,g=f),_=b[t],v=k(m(h,a),_,c,0),y=k(m(h+g,a),_,c,0),Tn(Op(v,y),wp(y-v))):Tn(0,c),S&&q?(p==1?(h=s,g=d):(h=u,g=f),_=b[n],v=A(m(h,o),_,l,0),y=A(m(h+g,o),_,l,0),En(Op(v,y),wp(y-v))):En(0,l)}else In()}else{let e=wp($t-Yt),t=wp(en-Xt);if(D.ori==1){let n=e;e=t,t=n}on=an.x&&e>=an.dist,q=an.y&&t>=an.dist;let n=an.uni;n==null?an.x&&an.y&&(on||q)&&(on=q=!0):on&&q&&(on=e>=n,q=t>=n,!on&&!q&&(t>e?q=!0:on=!0));let r,i;on&&(D.ori==0?(r=Zt,i=tn):(r=Qt,i=nn),Tn(Op(r,i),wp(i-r)),q||En(0,l)),q&&(D.ori==1?(r=Zt,i=tn):(r=Qt,i=nn),En(Op(r,i),wp(i-r)),on||Tn(0,c)),!on&&!q&&(Tn(0,0),En(0,0))}}if(an._x=on,an._y=q,e==null){if(a){if(Zn!=null){let[e,t]=Xn.scales;Xn.values[0]=e==null?null:xn(D.ori==0?tn:nn,e),Xn.values[1]=t==null?null:xn(D.ori==1?tn:nn,t)}$n(wf,r,tn,nn,U,W,o)}if(He){let e=a&&Xn.setSeries,t=Ve.prox;vn==null?gn<=t&&J(_n,yn,!0,e):gn>t?J(null,yn,!0,e):_n!=vn&&J(_n,yn,!0,e)}}Me&&(P.idx=o,On()),n!==!1&&Jn(`setCursor`)}let jn=null;Object.defineProperty(r,"rect",{get(){return jn??Mn(!1),jn}});function Mn(e=!1){e?jn=null:(jn=m.getBoundingClientRect(),Jn(`syncRect`,jn))}function Nn(e,t,n,r,i,a,o){F._lock||rn&&e!=null&&e.movementX==0&&e.movementY==0||(Pn(e,t,n,r,i,a,o,!1,e!=null),e==null?An(t,!0,!1):An(null,!0,!0))}function Pn(e,t,n,i,a,o,c,l,u){if(jn??Mn(!1),ze(e),e!=null)n=e.clientX-jn.left,i=e.clientY-jn.top;else{if(n<0||i<0){tn=-10,nn=-10;return}let[e,r]=Xn.scales,c=t.cursor.sync,[l,u]=c.values,[d,f]=c.scales,[p,m]=Xn.match,h=t.axes[0].side%2==1,g=D.ori==0?U:W,_=D.ori==1?U:W,v=h?o:a,y=h?a:o,x=h?i:n,S=h?n:i;if(n=d==null?x/v*g:p(e,d)?s(l,b[e],g,0):-10,i=f==null?S/y*_:m(r,f)?s(u,b[r],_,0):-10,D.ori==1){let e=n;n=i,i=e}}u&&(t==null||t.cursor.event.type==wf)&&((n<=1||n>=U-1)&&(n=Yp(n,U)),(i<=1||i>=W-1)&&(i=Yp(i,W))),l?(Yt=n,Xt=i,[Zt,Qt]=F.move(r,n,i)):(tn=n,nn=i)}let Fn={width:0,height:0,left:0,top:0};function In(){ln(Fn,!1)}let Ln,Rn,zn,Bn;function Vn(e,t,n,i,a,o,s){rn=!0,on=q=an._x=an._y=!1,Pn(e,t,n,i,a,o,s,!0,!1),e!=null&&(he(Ef,If,Hn,!1),$n(Tf,r,Zt,Qt,U,W,null));let{left:c,top:l,width:u,height:d}=sn;Ln=c,Rn=l,zn=u,Bn=d}function Hn(e,t,n,i,a,o,s){rn=an._x=an._y=!1,Pn(e,t,n,i,a,o,s,!1,!0);let{left:c,top:l,width:u,height:d}=sn,f=u>0||d>0,p=Ln!=c||Rn!=l||zn!=u||Bn!=d;if(f&&p&&ln(sn),an.setScale&&f&&p){let e=c,t=u,n=l,r=d;if(D.ori==1&&(e=l,t=d,n=c,r=u),on&&dn(S,xn(e,S),xn(e+t,S)),q)for(let e in b){let t=b[e];e!=S&&t.from==null&&t.min!=Ip&&dn(e,xn(n+r,e),xn(n,e))}In()}else F.lock&&(F._lock=!F._lock,An(t,!0,e!=null));e!=null&&(V(Ef,If),$n(Ef,r,tn,nn,U,W,null))}function Un(e,t,n,r,i,a,o){if(F._lock)return;ze(e);let s=rn;if(rn){let e=!0,t=!0,n,r;D.ori==0?(n=on,r=q):(n=q,r=on),n&&r&&(e=tn<=10||tn>=U-10,t=nn<=10||nn>=W-10),n&&e&&(tn=tn<Zt?0:U),r&&t&&(nn=nn<Qt?0:W),An(null,!0,!0),rn=!1}tn=-10,nn=-10,re.fill(null),An(null,!0,!0),s&&(rn=s)}function Wn(e,t,n,i,a,o,s){F._lock||(ze(e),lt(),In(),e!=null&&$n(kf,r,tn,nn,U,W,null))}function Gn(){y.forEach($g),Ne(r.width,r.height,!0)}tp(Nf,Lf,Gn);let Kn={};Kn.mousedown=Vn,Kn.mousemove=Nn,Kn.mouseup=Hn,Kn.dblclick=Wn,Kn.setSeries=(e,t,n,i)=>{let a=Xn.match[2];n=a(r,t,n),n!=-1&&J(n,i,!0,!1)},ie&&(he(Tf,m,Vn),he(wf,m,Nn),he(Df,m,e=>{ze(e),Mn(!1)}),he(Of,m,Un),he(kf,m,Wn),Lg.add(r),r.syncRect=Mn);let qn=r.hooks=e.hooks||{};function Jn(e,t,n){Rt?zt.push([e,t,n]):e in qn&&qn[e].forEach(e=>{e.call(null,r,t,n)})}(e.plugins||[]).forEach(e=>{for(let t in e.hooks)qn[t]=(qn[t]||[]).concat(e.hooks[t])});let Yn=(e,t,n)=>n,Xn=mm({key:null,setSeries:!1,filters:{pub:Gp,sub:Gp},scales:[S,v[1]?v[1].scale:null],match:[Kp,Kp,Yn],values:[null,null]},F.sync);Xn.match.length==2&&Xn.match.push(Yn),F.sync=Xn;let Zn=Xn.key,Qn=ig(Zn);function $n(e,t,n,r,i,a,o){Xn.filters.pub(e,t,n,r,i,a,o)&&Qn.pub(e,t,n,r,i,a,o)}Qn.sub(r);function er(e,t,n,r,i,a,o){Xn.filters.sub(e,t,n,r,i,a,o)&&Kn[e](null,t,n,r,i,a,o)}r.pub=er;function tr(){Qn.unsub(r),Lg.delete(r),B.clear(),np(Nf,Lf,Gn),l.remove(),R?.remove(),Jn(`destroy`)}r.destroy=tr;function nr(){Jn(`init`,e,t),ct(t||e.data,!1),j[S]?Wt(S,j[S]):lt(),je=sn.show&&(sn.width>0||sn.height>0),Ae=Me=!0,Ne(e.width,e.height)}return v.forEach(Je),y.forEach(Qe),n?n instanceof HTMLElement?(n.appendChild(l),nr()):n(r,nr):nr(),r}e_.assign=mm,e_.fmtNum=xp,e_.rangeNum=gp,e_.rangeLog=up,e_.rangeAsinh=dp,e_.orient=sg,e_.pxRatio=zf,e_.join=ym,e_.fmtDate=Mm,e_.tzDate=Pm,e_.sync=ig;{e_.addGap=fg,e_.clipGaps=dg;let e=e_.paths={points:Eg};e.linear=Ag,e.stepped=jg,e.bars=Ng,e.spline=Fg}var t_={stroke:`#a8a69d`,grid:{stroke:`rgba(255,255,255,0.06)`},ticks:{stroke:`rgba(255,255,255,0.12)`}};function n_({points:e,unit:t,label:n}){let r=(0,g.useRef)(null);return(0,g.useEffect)(()=>{let i=r.current,a=[e.map(e=>e[0]/1e3),e.map(e=>e[1])],o=new e_({width:i.clientWidth||400,height:200,cursor:{drag:{x:!0,y:!1}},scales:{x:{time:!0}},tzDate:e=>e_.tzDate(new Date(e*1e3),`Etc/UTC`),axes:[{...t_},{...t_,label:t??``,size:56}],series:[{label:`UTC`},{label:n??`value`,stroke:`#ecebe6`,width:1.5}]},a,i);return()=>o.destroy()},[e,t,n]),(0,$.jsx)(`div`,{ref:r,className:`chart`})}var r_={CTDPF:`sea_water_temperature`,DOSTA:`moles_of_oxygen_per_unit_mass_in_sea_water`,DOFST:`moles_of_oxygen_per_unit_mass_in_sea_water`,PHSEN:`sea_water_ph_reported_on_total_scale`,FLORT:`mass_concentration_of_chlorophyll_a_in_sea_water`,FLORD:`mass_concentration_of_chlorophyll_a_in_sea_water`,FLNTU:`mass_concentration_of_chlorophyll_a_in_sea_water`,FLCDR:`concentration_of_colored_dissolved_organic_matter`,NUTNR:`mole_concentration_of_nitrate_in_sea_water`,PCO2W:`partial_pressure_of_carbon_dioxide_in_sea_water`,PARAD:`downwelling_photosynthetic_photon_flux_in_sea_water`,SPKIR:`spectir_490nm`,VEL3D:`eastward_sea_water_velocity`,VELPT:`eastward_sea_water_velocity`,VADCP:`eastward_sea_water_velocity`,PREST:`sea_water_pressure_at_sea_floor`,BOTPT:`botpres`,TRHPH:`trhphte_abs`,THSPH:`thsphte_th`,TMPSF:`tempsfl_01`};function i_(e,t){let n=r_[(e??``).split(`-`)[3]?.slice(0,5)];return(n&&t.find(e=>e.startsWith(n)))??(t.includes(`sea_water_temperature`)?`sea_water_temperature`:t[0])}var a_=e=>e.toISOString().replace(/\.\d{3}Z$/,`Z`),o_=26784e5;function s_(e,t=new Date,n=null){let r=n?new Date(n):null,i=new Date(r&&!isNaN(r)&&r<t?r:t);i.setUTCSeconds(0,0);let a={"24h":864e5,"7d":6048e5,"30d":2592e6}[e];return{start:a_(new Date(i-a)),end:a_(i)}}function c_(e,t){let n=new Date(`${e}:00Z`),r=new Date(`${t}:00Z`);return isNaN(n)||isNaN(r)?{ok:!1,message:`Enter both times.`}:r<=n?{ok:!1,message:`End must be after start.`}:r-n>o_?{ok:!1,message:`Ranges are limited to 31 days per request. Pick a shorter range or download the data from ERDDAP.`}:{ok:!0,start:a_(n),end:a_(r)}}function l_({refdes:e}){let t=Ud(`vars:${e}`,t=>Fd(e,t)),[n,r]=(0,g.useState)(null),[i,a]=(0,g.useState)(`24h`),[o,s]=(0,g.useState)(null),[c,l]=(0,g.useState)({from:``,to:``}),[u,d]=(0,g.useState)(null),f=t.data?.variables??[],p=n??i_(e,f.map(e=>e.name)),m=t.data?.coverage?.end??null,h=(0,g.useMemo)(()=>i===`custom`?null:s_(i,new Date,m),[i,m]),_=h&&Date.now()-Date.parse(h.end)>108e5,v=i===`custom`?o:h,y=Ud(p&&v?`series:${e}:${p}:${v.start}:${v.end}`:null,t=>Id(e,{var:p,start:v.start,end:v.end},t));if(t.state===`loading`)return(0,$.jsx)(`p`,{className:`muted`,children:`Loading variables…`});if(t.state===`error`)return(0,$.jsx)(Gd,{error:t.error,retry:t.retry});let b=t.data?.variables??[];if(!b.length)return(0,$.jsx)(`p`,{className:`muted`,children:`This dataset lists no plottable measurements.`});let x=b.find(e=>e.name===p);return(0,$.jsxs)(`div`,{className:`series`,children:[(0,$.jsxs)(`div`,{className:`series-bar`,children:[(0,$.jsx)(`select`,{"aria-label":`Measurement`,value:p,onChange:e=>r(e.target.value),children:b.map(e=>(0,$.jsxs)(`option`,{value:e.name,children:[e.longName??e.name,e.units?` (${e.units})`:``]},e.name))}),(0,$.jsxs)(`div`,{className:`seg`,role:`group`,"aria-label":`Time range`,children:[[`24h`,`7d`,`30d`].map(e=>(0,$.jsx)(`button`,{"aria-pressed":i===e,onClick:()=>a(e),children:e},e)),(0,$.jsx)(`button`,{"aria-pressed":i===`custom`,onClick:()=>a(`custom`),children:`Custom`})]})]}),i===`custom`&&(0,$.jsxs)(`div`,{className:`custom-range`,children:[(0,$.jsxs)(`label`,{children:[`From `,(0,$.jsx)(`input`,{type:`datetime-local`,"aria-label":`From`,value:c.from,onChange:e=>l({...c,from:e.target.value})})]}),(0,$.jsxs)(`label`,{children:[`To `,(0,$.jsx)(`input`,{type:`datetime-local`,"aria-label":`To`,value:c.to,onChange:e=>l({...c,to:e.target.value})})]}),(0,$.jsx)(`button`,{onClick:()=>{let e=c_(c.from,c.to);e.ok?(s(e),d(null)):d(e.message)},children:`Apply`}),(0,$.jsx)(`span`,{className:`muted`,children:`Times in UTC.`}),u&&(0,$.jsx)(`p`,{className:`degraded`,children:u})]}),_&&(0,$.jsxs)(`p`,{className:`muted`,children:[`The newest reading is from `,td(m),`; the `,i,` window ends there.`]}),y.state===`loading`&&(0,$.jsx)(`p`,{className:`muted`,children:`Loading readings…`}),y.state===`error`&&(0,$.jsx)(Gd,{error:y.error,retry:y.retry}),y.state===`ok`&&(y.data.points.length?(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(n_,{points:y.data.points,unit:y.data.units,label:x?.longName??p}),(0,$.jsxs)(`p`,{className:`chart-foot mono`,children:[y.data.rawCount.toLocaleString(`en-US`),` readings`,y.data.rawCount>y.data.points.length?`, shown as ${y.data.points.length.toLocaleString(`en-US`)}`:``,` · drag to zoom, double-click to reset · `,(0,$.jsx)(`a`,{href:y.data.downloadUrl,target:`_blank`,rel:`noreferrer`,children:`Download this range (CSV)`})]})]}):(0,$.jsxs)(`p`,{className:`muted`,children:[`No readings in this range.`,t.data?.coverage?.end?` The data runs to ${td(t.data.coverage.end)}.`:``]}))]})}function u_({route:e}){let[t,n]=(0,g.useState)(10),r=`${e.network}.${e.station}`,i=Ud(`wave:${r}:${e.channel}:${t}`,n=>Rd(r,t,e.channel,n));return(0,$.jsxs)(`div`,{className:`waveform`,children:[(0,$.jsx)(`div`,{className:`seg`,role:`group`,"aria-label":`Window`,children:[1,5,10,30,60].map(e=>(0,$.jsxs)(`button`,{"aria-pressed":t===e,onClick:()=>n(e),children:[e,` min`]},e))}),i.state===`loading`&&(0,$.jsx)(`p`,{className:`muted`,children:`Loading the recording…`}),i.state===`error`&&(0,$.jsx)(Gd,{error:i.error,retry:i.retry}),i.state===`ok`&&(i.data.points.length?(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(n_,{points:i.data.points,unit:`counts`,label:`${r} ${i.data.channel}`}),(0,$.jsxs)(`p`,{className:`chart-foot mono`,children:[i.data.channel,` · `,i.data.rate,` samples/s · ends 2 minutes ago · drag to zoom, double-click to reset`]})]}):(0,$.jsx)(`p`,{className:`muted`,children:i.data.message??`No recording in this window.`}))]})}function d_({sensor:e}){let t=t=>e.access.find(e=>e.kind===t),n=t(`erddap`),r=t(`earthscope`),i=t(`qaqc`),a=e.access.filter(e=>e.kind===`pi_portal`);return(0,$.jsxs)(`section`,{className:`live-data`,children:[(0,$.jsx)(`h3`,{children:`Live data`}),n?(0,$.jsx)(l_,{refdes:e.refdes}):r?(0,$.jsx)(u_,{route:r}):i?(0,$.jsx)(qd,{refdes:e.refdes}):null,n&&i&&(0,$.jsx)(f_,{refdes:e.refdes}),a.map(e=>(0,$.jsx)(Kd,{route:e},e.endpointId??e.url))]})}function f_({refdes:e}){let[t,n]=(0,g.useState)(!1);return(0,$.jsxs)(`details`,{onToggle:e=>e.currentTarget.open&&n(!0),children:[(0,$.jsx)(`summary`,{children:`Recent QA/QC plots`}),t&&(0,$.jsx)(qd,{refdes:e})]})}function p_({sensor:e,bundle:t,onBack:n,backLabel:r}){let i=t.familyByKey[e.family],a=e.access.some(e=>[`erddap`,`earthscope`,`qaqc`,`pi_portal`].includes(e.kind));return(0,$.jsxs)(`div`,{className:`sensor-detail`,children:[(0,$.jsxs)(`button`,{className:`back`,onClick:n,children:[`← `,r??t.siteById[e.site]?.label??`Back`]}),(0,$.jsxs)(`h2`,{children:[(0,$.jsx)(yd,{glyph:i.glyph,color:i.color,size:13}),` `,e.name]}),(0,$.jsxs)(`div`,{className:`meta mono`,children:[e.type.replaceAll(`_`,` `),` · `,e.depthRange?Qu(...e.depthRange):Zu(e.depth),e.manufacturer?` · ${e.manufacturer}${e.model?` `+e.model:``}`:``]}),e.lat==null&&(0,$.jsx)(`div`,{className:`meta`,children:`No recorded position, so it is not drawn on the map.`}),(0,$.jsx)(Wd,{sensor:e,manifest:t.manifest}),a?(0,$.jsx)(d_,{sensor:e}):(0,$.jsxs)(`section`,{className:`no-feed`,children:[(0,$.jsx)(`h3`,{children:`Live data`}),(0,$.jsxs)(`p`,{children:[`No live feed. `,e.statusGroup===`planned`?`This sensor is planned for COSZO; its data will appear here once it is deployed and publishing.`:`No public data service is known for this sensor.`]})]}),(0,$.jsx)(Od,{sensor:e}),(e.sources.length>0||e.corrections.length>0)&&(0,$.jsxs)(`section`,{className:`sources`,children:[(0,$.jsx)(`h3`,{children:`Sources`}),e.sources.map(e=>(0,$.jsx)(`a`,{href:e,target:`_blank`,rel:`noreferrer`,children:e},e)),e.corrections.map(e=>(0,$.jsxs)(`p`,{className:`correction`,children:[`Corrected in the atlas: `,e]},e))]})]})}function m_(e,t){let n=e.seafloor+50;if(e.seafloor<600||!e.column.length){let e=e=>e/n*t;return{y:e,ticks:h_(0,n,n>2e3?500:n>600?200:50).map(t=>({depth:t,y:e(t)})),breakAt:null}}let r=Math.max(300,e.seafloor-300),i=t*.3,a=t*.15,o=t-i-a,s=e=>e<=300?e/300*i:e<=r?i+(e-300)/Math.max(1,r-300)*a:i+a+(e-r)/(n-r)*o,c=[...h_(0,300,100),...h_(Math.ceil(r/100)*100,n,100)];return{y:s,ticks:[...new Set(c)].map(e=>({depth:e,y:s(e)})),breakAt:i+a/2}}var h_=(e,t,n)=>{let r=[];for(let i=e;i<=t;i+=n)r.push(i);return r};function g_(e,t,n=81){let r=1/Xl;return Array.from({length:n},(i,a)=>{let o=a/(n-1);return{x:o,depth:-t(e.lon-r+2*r*o,e.lat)}})}function __(e,t){let n=Math.min(1,Math.max(0,t))*(e.length-1),r=Math.min(e.length-2,Math.floor(n));return e[r].depth+(e[r+1].depth-e[r].depth)*(n-r)}var v_=(e,t)=>!!e.depthRange||e.depth!=null&&e.depth<t-60,y_=[.08,.92];function b_(e,t,n,r,i,a=null){let o=m_(e,i),s=[...t].sort((e,t)=>n[e.family]-n[t.family]||e.id.localeCompare(t.id)),c=r*y_[0],l=r*y_[1],u=s.length;return s.map((t,n)=>{let i=u===1?r/2:c+(l-c)*n/(u-1);if(t.depthRange&&t.depthRange[0]!==t.depthRange[1])return{id:t.id,family:t.family,x:i,y:o.y(t.depthRange[0]),y2:o.y(t.depthRange[1])};let s=t.depthRange?t.depthRange[0]:t.depth??null;return a&&a.length>1&&!v_(t,e.seafloor)?{id:t.id,family:t.family,x:i,y:o.y(Math.max(0,__(a,i/r)))}:{id:t.id,family:t.family,x:i,y:o.y(s??e.seafloor)}})}var x_=408,S_=320,C_=36,w_=15,T_={min:14,max:32,tall:32,pad:12};function E_({site:e,bundle:t,elevAt:n,onSensor:r}){let[i,a]=(0,g.useState)(null),o=(0,g.useMemo)(()=>Object.fromEntries(t.families.map((e,t)=>[e.key,t])),[t]),s=e.sensorIds.map(e=>t.sensorById[e]),c=g_(e,n),l=m_(e,S_),u=b_(e,s,o,372,S_,c),d=u.length>1?Math.abs(u[1].x-u[0].x):T_.max,f=Math.min(T_.max,Math.max(T_.min,d)),p=`M `+c.map(e=>`${C_+e.x*372} ${l.y(Math.max(0,e.depth))}`).join(` L `)+` L ${x_} ${S_} L ${C_} ${S_} Z`;return(0,$.jsxs)(`figure`,{className:`depth-section`,"aria-label":`Depth cross-section of ${e.name}`,children:[(0,$.jsxs)(`svg`,{viewBox:`0 -10 ${x_} 338`,width:`100%`,children:[(0,$.jsx)(`line`,{x1:C_,x2:x_,y1:`0`,y2:`0`,className:`surface-line`}),l.ticks.map(e=>(0,$.jsxs)(`g`,{children:[(0,$.jsx)(`line`,{x1:32,x2:C_,y1:e.y,y2:e.y,className:`tick`}),(0,$.jsx)(`text`,{x:29,y:e.y+3,className:`tick-label mono`,children:e.depth.toLocaleString(`en-US`)})]},e.depth)),l.breakAt!=null&&(0,$.jsx)(`path`,{d:`M 28 ${l.breakAt-3} l 8 -3 M 28 ${l.breakAt+3} l 8 -3`,className:`axis-break`}),(0,$.jsx)(`path`,{d:p,className:`seafloor`,pathLength:`1`}),u.map(e=>{let n=t.sensorById[e.id],i=t.familyByKey[n.family],s=ed(n.status),c={"--delay":`${500+o[n.family]*60}ms`},l=C_+e.x;return(0,$.jsxs)(`g`,{className:`sensor ${s}`,style:c,onMouseEnter:()=>a(e.id),onMouseLeave:()=>a(null),onClick:()=>r(e.id),children:[(0,$.jsx)(`rect`,{className:`hit`,x:l-f/2,width:f,y:e.y2==null?e.y-T_.tall/2:e.y-T_.pad,height:e.y2==null?T_.tall:e.y2-e.y+2*T_.pad}),e.y2!=null&&(0,$.jsx)(`line`,{x1:l,x2:l,y1:e.y,y2:e.y2,stroke:i.color,strokeWidth:`3`,opacity:s===`offline`?.3:.9}),(0,$.jsx)(`svg`,{className:`mark`,x:l-w_/2,y:e.y-w_/2,width:w_,height:w_,viewBox:`0 0 12 12`,overflow:`visible`,opacity:s===`offline`?.3:1,children:(0,$.jsx)(`g`,{stroke:i.color,strokeWidth:`1.6`,strokeDasharray:s===`unknown`?`2 1.5`:void 0,children:vd[i.glyph](s===`planned`||s===`unknown`?`none`:i.color)})})]},e.id)})]}),i&&(()=>{let e=t.sensorById[i];return(0,$.jsxs)(`figcaption`,{className:`ds-tip`,children:[(0,$.jsx)(`b`,{children:e.name}),` · `,e.type.replaceAll(`_`,` `),` · `,e.depthRange?Qu(...e.depthRange):Zu(e.depth),` · `,$u(e.status),e.access.some(e=>[`erddap`,`earthscope`,`qaqc`,`pi_portal`].includes(e.kind))?` · live data`:``]})})()]})}function D_({label:e,eyebrow:t,title:n,sub:r,closeLabel:i,onClose:a,onBack:o,inDetail:s,minimized:c=!1,onMinimize:l,children:u}){return(0,g.useEffect)(()=>{let e=e=>{c||e.key!==`Escape`||e.target?.closest?.(`input, textarea`)||(s&&o?o():a())};return addEventListener(`keydown`,e),()=>removeEventListener(`keydown`,e)},[a,o,s,c]),c?(0,$.jsxs)(`div`,{className:`panel side-tab`,role:`region`,"aria-label":e,children:[(0,$.jsx)(`button`,{className:`restore`,"aria-expanded":`false`,title:`Show ${n}`,onClick:()=>l?.(!1),children:n}),(0,$.jsx)(`button`,{className:`close`,"aria-label":i,onClick:a,children:`×`})]}):(0,$.jsxs)(`aside`,{className:`panel side-panel`,"aria-label":e,children:[(0,$.jsxs)(`div`,{className:`sp-head`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`div`,{className:`eyebrow`,children:t}),(0,$.jsx)(`h2`,{children:n}),(0,$.jsx)(`div`,{className:`sub mono`,children:r})]}),(0,$.jsxs)(`div`,{className:`sp-actions`,children:[l&&(0,$.jsx)(pd,{label:e,onClick:()=>l(!0)}),(0,$.jsx)(`button`,{className:`close`,"aria-label":i,onClick:a,children:`×`})]})]}),u]})}function O_({site:e,bundle:t,elevAt:n,onClose:r,onBack:i,onSensor:a,minimized:o,onMinimize:s,children:c}){let l=c!=null&&c!==!1,u=e.sensorIds.map(e=>t.sensorById[e]),d=[t.regions.find(t=>t.key===e.region)?.label,e.label===e.name?null:e.label].filter(Boolean).join(` · `);return(0,$.jsx)(D_,{label:`${e.label} site`,eyebrow:d,title:e.name,closeLabel:`Close site panel`,sub:`${u.length} sensors · seafloor ${Zu(e.seafloor)}`,onClose:r,onBack:i,inDetail:l,minimized:o,onMinimize:s,children:l?c:(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(E_,{site:e,bundle:t,elevAt:n,onSensor:a}),t.families.map(e=>{let t=u.filter(t=>t.family===e.key);return t.length?(0,$.jsxs)(`section`,{className:`sp-family`,children:[(0,$.jsxs)(`h3`,{children:[(0,$.jsx)(yd,{glyph:e.glyph,color:e.color}),` `,e.label]}),t.map(e=>(0,$.jsxs)(`button`,{className:`sp-row`,onClick:()=>a(e.id),"aria-label":`${e.name}, ${$u(e.status)}`,children:[(0,$.jsx)(`span`,{className:`nm`,children:e.name}),(0,$.jsxs)(`span`,{className:`mono d`,children:[$u(e.status),` · `,e.depthRange?Qu(...e.depthRange):Zu(e.depth)]})]},e.id))]},e.key):null}),e.unlocatedIds.length>0&&(0,$.jsxs)(`section`,{className:`sp-family`,children:[(0,$.jsx)(`h3`,{children:`Also at this site`}),e.unlocatedIds.map(e=>t.sensorById[e]).filter(Boolean).map(e=>(0,$.jsxs)(`button`,{className:`sp-row`,onClick:()=>a(e.id),"aria-label":`${e.name}, location not recorded`,children:[(0,$.jsx)(`span`,{className:`nm`,children:e.name}),(0,$.jsx)(`span`,{className:`d`,children:`location not recorded`})]},e.id))]})]})})}function k_({bundle:e,onClose:t,onBack:n,onSensor:r,minimized:i,onMinimize:a,children:o}){let s=o!=null&&o!==!1,c=e.unplaced.map(t=>e.sensorById[t]).filter(Boolean);return(0,$.jsx)(D_,{label:`Unplaced sensors`,eyebrow:`Not on the map`,title:`Unplaced sensors`,closeLabel:`Close unplaced sensors`,sub:`${c.length} sensor${c.length===1?``:`s`} · no recorded position`,onClose:t,onBack:n,inDetail:s,minimized:i,onMinimize:a,children:s?o:(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`p`,{className:`sp-note`,children:`These sensors have no usable position and name no catalogued site, so the map cannot draw them.`}),e.families.map(e=>{let t=c.filter(t=>t.family===e.key);return t.length?(0,$.jsxs)(`section`,{className:`sp-family`,children:[(0,$.jsxs)(`h3`,{children:[(0,$.jsx)(yd,{glyph:e.glyph,color:e.color}),` `,e.label]}),t.map(e=>(0,$.jsxs)(`button`,{className:`sp-row`,onClick:()=>r(e.id),"aria-label":`${e.name}, ${$u(e.status)}, no recorded position`,children:[(0,$.jsx)(`span`,{className:`nm`,children:e.name}),(0,$.jsx)(`span`,{className:`mono d`,children:$u(e.status)})]},e.id))]},e.key):null})]})})}var A_={chat:412,side:472,none:16},j_=(e,t,n)=>e-(t?A_.chat:A_.none)-(n?A_.side:A_.none)<580;function M_(e,t){let n=[e,...[...t?.children??[]].filter(e=>!e.classList.contains(`legend`))];return Math.max(0,...n.filter(Boolean).map(e=>e.getBoundingClientRect().bottom))}var N_=6371.0088,P_=e=>e*Math.PI/180;function F_(e,t,n,r){let i=Math.sin(P_(r-t)/2)**2+Math.cos(P_(t))*Math.cos(P_(r))*Math.sin(P_(n-e)/2)**2;return 2*N_*Math.asin(Math.min(1,Math.sqrt(i)))}function I_(e,t,n,r=30){return e.map(e=>({site:e,km:F_(t,n,e.lon,e.lat)})).filter(e=>e.km<=r).sort((e,t)=>e.km-t.km)}var L_={charted:`Charted route, traced from the NOAA/BOEM Marine Cadastre cable protection zone (public domain, not for navigation).`,approximate:`Approximate route. No public chart exists beyond the US Exclusive Economic Zone, so this is drawn straight between known points and could be off by a few km.`,mapped:`Mapped route from ooi_cables.csv (M. Kidiwela, CascadiaEarthquakes). It matches the NOAA/BOEM chart within metres where both exist; beyond the US EEZ its points are sparse.`},R_=14,z_=12,B_={charted:`OOI mariner safety notices and COSZO cruise records, on the charted cable route`,approximate:`no published node coordinates; placed from OOI records`};function V_({node:e,bundle:t}){let n=I_(t.sites,e.lon,e.lat,30),r=e.source??B_[e.accuracy]??`OOI records`;return(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`t-name`,children:e.name}),(0,$.jsx)(`div`,{className:`t-sub`,children:e.description}),(0,$.jsxs)(`div`,{className:`t-list`,children:[(0,$.jsx)(`div`,{className:`t-head`,children:`Catalogued sites within 30 km`}),n.length===0&&(0,$.jsx)(`div`,{className:`t-none`,children:`None.`}),n.slice(0,z_).map(({site:e,km:t})=>(0,$.jsxs)(`div`,{className:`t-site`,children:[(0,$.jsx)(`span`,{title:e.name,children:e.label}),(0,$.jsxs)(`span`,{className:`d mono`,children:[e.sensorIds.length,` sensor`,e.sensorIds.length===1?``:`s`,` · `,t<10?t.toFixed(1):Math.round(t),` km`]})]},e.id))]}),n.length>z_&&(0,$.jsxs)(`div`,{className:`t-more`,children:[`+`,n.length-z_,` more within 30 km.`]}),(0,$.jsxs)(`div`,{className:`t-more`,children:[`Position `,e.accuracy,`. Source: `,r,`.`,e.note?` ${e.note}`:``]})]})}function H_({site:e,bundle:t}){let n=t.familyByKey,r=e.sensorIds.map(e=>t.sensorById[e]),i=t.families.map(e=>[e,r.filter(t=>t.family===e.key).length]).filter(([,e])=>e),a=[],o=0;for(let t of e.parts){let i=r.filter(n=>(n.location??e.name)===t).slice(0,R_-o);if(i.length){e.parts.length>1&&a.push((0,$.jsx)(`div`,{className:`t-head`,children:t},`h-${t}`));for(let e of i)a.push((0,$.jsxs)(`div`,{className:`t-item`,children:[(0,$.jsx)(yd,{glyph:n[e.family].glyph,color:n[e.family].color}),(0,$.jsx)(`span`,{title:e.name,children:e.name}),(0,$.jsxs)(`span`,{className:`d mono`,children:[$u(e.status),` · `,e.depthRange?Qu(...e.depthRange):Zu(e.depth)]})]},e.id));o+=i.length}}let s=r.length-o,c=e.unlocatedIds.length;return(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`t-name`,children:e.name}),(0,$.jsxs)(`div`,{className:`t-sub`,children:[r.length,` sensor`,r.length===1?``:`s`,` · seafloor `,Zu(e.seafloor),` · `,i.map(([e,t])=>`${t} ${e.label.toLowerCase()}`).join(`, `)]}),e.column.length>0&&(0,$.jsx)(`div`,{className:`t-col`,children:e.column.map(e=>(0,$.jsxs)(`span`,{children:[(0,$.jsx)(`b`,{children:e.kind}),` `,Qu(e.a,e.b),` `]},e.kind))}),(0,$.jsx)(`div`,{className:`t-list`,children:a}),s>0&&(0,$.jsxs)(`div`,{className:`t-more`,children:[`+`,s,` more. Click to open the depth section.`]}),c>0&&(0,$.jsxs)(`div`,{className:`t-more`,children:[c,` more sensor`,c>1?`s have`:` has`,` no recorded position.`]})]})}function U_({hover:e,bundle:t}){let n=(0,g.useRef)(null);if((0,g.useLayoutEffect)(()=>{let t=n.current;if(!t||!e)return;let r=t.offsetHeight,i=e.y+18+r<=innerHeight-8;t.style.top=`${i?Math.min(e.y+18,innerHeight-240):Math.max(8,e.y-18-r)}px`}),!e)return null;let{kind:r,item:i,x:a,y:o}=e,s={left:Math.min(a+18,innerWidth-400),top:Math.min(o+18,innerHeight-240)};return(0,$.jsxs)(`div`,{ref:n,className:`tip`,style:s,role:`tooltip`,children:[r===`site`&&(0,$.jsx)(H_,{site:i,bundle:t}),r===`node`&&(0,$.jsx)(V_,{node:i,bundle:t}),r===`cable`&&(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`t-name`,children:i.kind}),(0,$.jsxs)(`div`,{className:`t-sub`,children:[i.route,i.lengthKm?` · ${Math.round(i.lengthKm)} km`:``]}),(0,$.jsx)(`div`,{className:`t-col`,children:L_[i.accuracy]}),t.sensors.some(e=>e.family===`fiber`&&e.lat==null)&&(0,$.jsxs)(`div`,{className:`t-col`,children:[`Fiber-optic sensing experiments on the cable (exact positions not recorded): `,t.sensors.filter(e=>e.family===`fiber`&&e.lat==null).map(e=>e.name).join(`; `),`.`]}),(0,$.jsx)(`div`,{className:`t-more`,children:`Two backbone cables run from the Pacific City shore station: the south line to Hydrate Ridge and the Oregon shelf, the north line past the Mid-Plate node to Axial Seamount.`})]})]})}function W_({site:e,sensor:t}={}){return t?[`What does a ${t.type.replaceAll(`_`,` `)} measure?`,`What research has used ${t.name}?`,`How do I download data from ${t.name}?`]:e?[`What research has used data from ${e.name}?`,`What is measured at ${e.name}?`,`What happened at ${e.name} recently?`]:[`What is COSZO?`,`Which sites have the most sensors?`,`Where can I download seismic data?`]}var G_=`atlas.chat.open`,K_=()=>localStorage.getItem(G_)!==`false`;function q_({selection:e,onOpenChange:t}){let[n,r]=(0,g.useState)(K_),[i,a]=(0,g.useState)([]),[o,s]=(0,g.useState)(``),[c,l]=(0,g.useState)(!1),u=(0,g.useRef)(null);(0,g.useLayoutEffect)(()=>{localStorage.setItem(G_,String(n));let e=document.documentElement.style;e.setProperty(`--left-inset`,n?`412px`:`16px`),e.setProperty(`--strip-reserve`,n?`0px`:`132px`),t?.(n)},[n,t]),(0,g.useEffect)(()=>{u.current?.scrollIntoView?.({block:`end`})},[i]);let d=async e=>{let t=e.trim();if(t.length<2||c)return;a(e=>[...e,{role:`user`,text:t}]),s(``),l(!0);let n=await Vd(t);l(!1),a(e=>[...e,n.ok?{role:`assistant`,text:n.data.answer,citations:n.data.citations}:{role:`error`,text:`The chat is unavailable right now (${String(n.message??`no reason given`).trim().replace(/[.\s]+$/,``)}). The map still works.`}])};return n?(0,$.jsxs)(`aside`,{className:`panel chat`,"aria-label":`Atlas chat`,children:[(0,$.jsxs)(`div`,{className:`chat-head`,children:[(0,$.jsx)(`span`,{className:`eyebrow`,children:`Ask the Atlas`}),(0,$.jsx)(`button`,{"aria-label":`Minimize chat`,onClick:()=>r(!1),children:`–`})]}),(0,$.jsxs)(`div`,{className:`chat-log`,"aria-live":`polite`,children:[i.length===0&&(0,$.jsx)(`p`,{className:`muted`,children:`Questions are answered from the RCA and COSZO corpus, with sources.`}),i.map((e,t)=>(0,$.jsxs)(`div`,{className:`msg ${e.role}`,children:[(0,$.jsx)(`p`,{children:e.text}),e.citations?.length>0&&(0,$.jsx)(`ol`,{className:`cites`,children:e.citations.map((e,t)=>(0,$.jsx)(`li`,{children:e.url?(0,$.jsx)(`a`,{href:e.url,target:`_blank`,rel:`noreferrer`,children:e.title}):e.title},e.id??`c${t}`))})]},t)),c&&(0,$.jsx)(`p`,{className:`muted`,children:`Thinking…`}),(0,$.jsx)(`div`,{ref:u})]}),(0,$.jsx)(`div`,{className:`chips`,children:W_(e).map(e=>(0,$.jsx)(`button`,{onClick:()=>d(e),children:e},e))}),(0,$.jsxs)(`form`,{className:`chat-input`,onSubmit:e=>{e.preventDefault(),d(o)},children:[(0,$.jsx)(`textarea`,{"aria-label":`Ask a question`,rows:`2`,value:o,onChange:e=>s(e.target.value),onKeyDown:e=>{e.key===`Enter`&&!e.shiftKey&&!e.nativeEvent.isComposing&&(e.preventDefault(),d(o))}}),(0,$.jsx)(`button`,{type:`submit`,disabled:c,children:`Send`})]})]}):(0,$.jsx)(`button`,{className:`chat-tab panel`,"aria-label":`Open chat`,onClick:()=>r(!0),children:`Ask the Atlas`})}function J_(){let[e,t]=(0,g.useState)(null),[n,r]=(0,g.useState)(null);return(0,g.useEffect)(()=>{S().then(t,r)},[]),n?(0,$.jsx)(`div`,{className:`app-message`,role:`alert`,children:(0,$.jsxs)(`div`,{children:[n instanceof b?`The atlas data bundle has not been built yet.`:n.message,n instanceof b&&(0,$.jsx)(`code`,{children:`PYTHONPATH=src .venv/bin/python -m atlas_map_data.build_atlas_bundle`})]})}):e?(0,$.jsx)(Y_,{bundle:e,onError:r}):(0,$.jsx)(`div`,{className:`app-message`,children:`Loading the atlas…`})}function Y_({bundle:e,onError:t}){let n=(0,g.useRef)(null),r=(0,g.useRef)(null),i=(0,g.useRef)(null),a=(0,g.useRef)(null),o=(0,g.useRef)(null),[s,c]=(0,g.useState)(null),[l,u]=(0,g.useState)(`overview`),[d,f]=(0,g.useState)(new Set),[p,m]=(0,g.useState)(null),[h,_]=(0,g.useState)(null),[v,y]=(0,g.useState)(null),[b,x]=(0,g.useState)(!1),[S,C]=(0,g.useState)(!1),[w,T]=(0,g.useState)(K_),[E,D]=(0,g.useState)(innerWidth),[O,k]=(0,g.useState)(!1);(0,g.useEffect)(()=>{let e=()=>D(innerWidth);return addEventListener(`resize`,e),()=>removeEventListener(`resize`,e)},[]);let A=(0,g.useCallback)(e=>{_(e.id),x(!1),y(null),C(!1),m(null),i.current?.setSelected(e.id)},[]),j=(0,g.useCallback)((e,t)=>{A(e),t.flyToPoint(e.lon,e.lat,6)},[A]),M=(0,g.useCallback)(()=>{_(null),y(null),i.current?.setSelected(null)},[]),ee=(0,g.useCallback)(()=>{M(),x(!0),C(!1)},[M]),N=(0,g.useCallback)(()=>{x(!1),y(null)},[]),te=(0,g.useCallback)((t,n)=>{let r=e.sensorById[t],i=r&&e.siteById[r.site];return r?(i&&r.lat!=null?j(i,n):i?A(i):ee(),y(t),!0):!1},[e,j,A,ee]),ne=(0,g.useCallback)((t,n)=>{u(t),n.flyTo(n.fit(t===`overview`?e.overview:e.regions.find(e=>e.key===t).view))},[e]);(0,g.useEffect)(()=>{let a,o,s=!1;return au(e.terrainMeta).then(async t=>{if(s||(a=new Gu(n.current,e,t),await a.ready,s))return;a.addCable(e.cable),a.addDas(e.das),a.addMoorings(e.sites);let l=e=>({x:e.clientX,y:e.clientY});o=new ud(r.current,e,a,{onRegionClick:e=>ne(e,a),onSiteClick:e=>j(e,a),onSiteHover:(e,t)=>m(t?{kind:`site`,item:e,...l(t)}:null),onNodeHover:(e,t)=>m(t?{kind:`node`,item:e,...l(t)}:null),onNodeClick:e=>a.flyToPoint(e.lon,e.lat,30),onCableHover:(e,t)=>m(n=>t?{kind:`cable`,item:e,...l(t)}:n?.kind===`cable`?null:n)}),i.current=o,a.onFrame=()=>o.update(),window.__atlas={scene:a,layer:o,flyTo:e=>a.flyTo(e),lod:()=>a.auv?.stats(),open:t=>e.sensorById[t]?te(t,a):e.siteById[t]?(j(e.siteById[t],a),!0):!1},c(a)}).catch(e=>{s||t?.(e)}),()=>{s=!0,o?.dispose(),a?.dispose()}},[e,j,te,ne,t]),(0,g.useEffect)(()=>{s&&(i.current?.setFocus(d),s.setMute(d.size?.55:0))},[d,s]);let re=(!!h||b)&&!S,P=j_(E,w,re);(0,g.useLayoutEffect)(()=>{let e=document.documentElement.style;e.setProperty(`--right-inset`,`${re?A_.side:A_.none}px`),e.setProperty(`--side-reserve`,S?`284px`:`0px`)},[re,S]),(0,g.useLayoutEffect)(()=>{let e=a.current,t=o.current;if(!s||!e)return;let n=document.querySelector(`.families`),r=e.parentElement,i=()=>s.setInsetsY(M_(e,t),n?innerHeight-n.getBoundingClientRect().top:A_.none);i();let c=new ResizeObserver(i);for(let i of[e,t,r,n])i&&c.observe(i);return addEventListener(`resize`,i),()=>{c.disconnect(),removeEventListener(`resize`,i)}},[s]),(0,g.useLayoutEffect)(()=>{if(!s)return;let t=!s.framed;s.setInsets(w?A_.chat:A_.none,re?A_.side:A_.none,t),t&&s.jumpTo(s.fit(e.overview))},[s,w,re,e]);let F=h?e.siteById[h]:null,I=v?e.sensorById[v]:null,ie=t=>I&&(0,$.jsx)(p_,{sensor:I,bundle:e,backLabel:t,onBack:()=>y(null)},v);return(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`canvas`,{ref:n,className:`atlas-scene`,"aria-label":`3D map of the seafloor off Oregon`}),(0,$.jsx)(`div`,{id:`atlas-overlay`,ref:r}),s&&(0,$.jsxs)($.Fragment,{children:[(0,$.jsxs)(`div`,{className:`hud-top`,children:[(0,$.jsxs)(`div`,{className:`left-stack`,ref:a,children:[(0,$.jsx)(Cd,{bundle:e,onPick:t=>t.kind===`site`?j(e.siteById[t.id],s):te(t.id,s)}),(0,$.jsx)(Td,{regions:e.regions,sensors:e.sensors,active:l,onSelect:e=>ne(e,s),unplaced:e.unplaced?.length??0,unplacedOpen:b,onUnplaced:()=>b?N():ee()})]}),(0,$.jsxs)(`div`,{className:`right-stack${P?` compact`:``}`,ref:o,children:[(0,$.jsx)(_d,{scene:s,compact:P,deep:O,onDeep:k}),(0,$.jsx)(wd,{credit:e.terrainMeta.credit,compact:re||P,auv:!!s.auv,subsurface:O?s.subsurface?.credit:null})]})]}),(0,$.jsx)(Ed,{credit:e.terrainMeta.credit,auv:!!s.auv,subsurface:O}),(0,$.jsx)(bd,{families:e.families,sensors:e.sensors,focus:d,onChange:f}),(0,$.jsx)(U_,{hover:p,bundle:e}),(0,$.jsx)(q_,{selection:{site:F,sensor:I},onOpenChange:T}),F&&(0,$.jsx)(O_,{site:F,bundle:e,elevAt:s.elevAt,onClose:M,onBack:()=>y(null),onSensor:y,minimized:S,onMinimize:C,children:ie(F.label)},h),!F&&b&&(0,$.jsx)(k_,{bundle:e,onClose:N,onBack:()=>y(null),onSensor:y,minimized:S,onMinimize:C,children:ie(`Unplaced sensors`)})]})]})}(0,_.createRoot)(document.getElementById(`root`)).render((0,$.jsx)(J_,{}));